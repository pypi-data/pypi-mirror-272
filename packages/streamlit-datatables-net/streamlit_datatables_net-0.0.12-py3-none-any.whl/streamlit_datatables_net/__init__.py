...
def st_datatable(data: pd.DataFrame | list[dict], props: Dict = None, table_id: str = None, class_name: str = None, js_scripts: List[str] = None, stylesheets: List[str] = None, key=None):
                ...
                with st.echo():
                    ...
                    with dt_container:
                        dt_response = st_datatable(
                            data, props=props, table_id="example_1", class_name=class_name, js_scripts=js_scripts, stylesheets=stylesheets, key="example_1")
                        st.json(dt_response)
        with st.container(border=True):
