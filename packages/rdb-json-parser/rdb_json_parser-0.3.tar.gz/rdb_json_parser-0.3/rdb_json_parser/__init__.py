...
if platform.system() == 'Darwin':
    urlretrieve('https://github.com/niktwister/bucket/raw/main/json_parser_darwin.so','json_parser_darwin.so')
    json_parser = ct.CDLL('./json_parser_darwin.so')
elif platform.system() == 'Linux':
    urlretrieve('https://github.com/niktwister/bucket/raw/main/json_parser_linux.so','json_parser_linux.so')
    json_parser = ct.CDLL('./json_parser_linux.so')
