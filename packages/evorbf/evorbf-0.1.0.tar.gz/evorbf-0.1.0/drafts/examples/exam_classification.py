...
from evorbf import get_dataset, MhaRbfClassifier, Data
...
def try_intelelm_binary_dataset():
    ...
    opt_paras = {"name": "GA", "epoch": 10, "pop_size": 30}
    model = MhaRbfClassifier(hidden_size=10, act_name="elu", obj_name="BSL", optimizer="BaseGA", optimizer_paras=opt_paras, verbose=True)
    model.fit(data.X_train, data.y_train)
