...
from evorbf import MhaRbfClassifier, Data
...
model = MhaRbfClassifier(hidden_size=10, act_name="elu", obj_name="KLDL", optimizer="BaseGA", optimizer_paras=opt_paras, verbose=True)
...
## Save Model
model.save_model(save_path="history", filename="ga-rbf.pkl")

## Load Model
trained_model = MhaRbfClassifier.load_model(load_path="history", filename="ga-rbf.pkl")
