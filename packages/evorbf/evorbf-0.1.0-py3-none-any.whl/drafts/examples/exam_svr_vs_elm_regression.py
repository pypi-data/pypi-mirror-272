...
import numpy as np
from evorbf import Data, MhaRbfRegressor

data = Data().set_train_test(X_train, y_train, X_test, y_test)
opt_paras = {"name": "GA", "epoch": 100, "pop_size": 30}
model = MhaRbfRegressor(hidden_size=10, act_name="elu", obj_name="MSE", optimizer="BaseGA", optimizer_paras=opt_paras, verbose=False)
