...
class County(GenericCRUD):
    ...
    def read_by_location_and_state(self, location_id: int, state_id: int) -> List[dict]:
        ...
        result = [LocationsUtil.extract_coordinates_and_replace_by_point(data_json=county) for county in result]
    ...
    def get_county_id_by_county_name_state_id(self, county_name: str, state_id: int = None,
        ...
        self.county_ml = self.county_ml or CountyMl()
        county_id_json = self.county_ml.select_one_dict_by_where(
