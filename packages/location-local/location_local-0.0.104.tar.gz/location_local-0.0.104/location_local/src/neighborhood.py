...
class Neighborhood(GenericCRUD):
    def __init__(self, is_test_data: bool = False):
        ...
        GenericCRUD.__init__(
            ...
            default_view_table_name=LocationLocalConstants.NEIGHBORHOOD_VIEW_NAME,
            default_id_column_name=LocationLocalConstants.NEIGHBORHOOD_ID_COLUMN_NAME,
    ...
    def get_neighborhood_id_by_neighborhood_name(
        ...
        self.neighborhood_ml = self.neighborhood_ml or NeighborhoodMl()
        neighborhood_id_json = self.neighborhood_ml.select_one_dict_by_where(
