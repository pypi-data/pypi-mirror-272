...
class Html(HtmlParentClass):
    def __init__(self, senior, title: str = 'Untitled', lang: str = None):
        ...
        css.attributes.add('crossorigin', 'anonymous')
        js = self.add_library_js_link_to_body(
            'https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js')
        js.attributes.add('integrity', 'sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz')
        js.attributes.add('crossorigin', 'anonymous')
