...
from opendapi.utils import find_files_with_suffix, read_yaml_or_json, sorted_yaml_dump
...
class BaseValidator:
    ...
    def validate_schema(self, file: str, content: Dict):
        ...
        try:
            jsonschema_validate(content, self.schema_cache[jsonschema_ref])
    ...
    def autoupdate(self):
        ...
        for file, base_content in self.base_template_for_autoupdate().items():
            ...
            with open(file, "w", encoding="utf-8") as file_handle:
                ...
                json_spec = self.schema_cache.get(jsonschema_ref, {})
                sorted_yaml_dump(
                    new_content,
                    file_handle,
                    json_spec=json_spec,
