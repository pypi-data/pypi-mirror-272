...
from nesso_cli.models.base_model import create as base_model_create
...
def create(
    ...
    snakecase_columns: Annotated[
        ...
        typer.Option(
            "--snakecase-columns",
            "-s",
            help="Whether to standardize column names to snakecase in the base model.",
            is_flag=True,
        ),
    ] = True,
    ...
    create_base_models: Annotated[
        Optional[bool],
        typer.Option(
            "--create-base-models",
            "-b",
            help="Whether to also create base models for all tables in the source.",
            is_flag=True,
        ),
    ] = False,
...
def add(
    ...
    create_base_model: Annotated[
        Optional[bool],
        typer.Option(
            "--create-base-model",
            "-b",
            help="Whether to create a base model (SQL, YAML, relation) as well.",
            is_flag=True,
        ),
    ] = False,
    project: options.project = context.get("PROJECT_NAME"),
