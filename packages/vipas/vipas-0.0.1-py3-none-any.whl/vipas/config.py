...
class Config:
    ...
    def setup_api_key(self):
        ...
        if env_type == "vipas-streamlit":
            ...
            if self.vps_auth_token is None or len(self.vps_auth_token) == 0:
                raise ClientException(500, "VPS_AUTH_TOKEN is not set in the environment variables or it is empty")
        ...
        try:
            ...
            if headers and 'Cookie' in headers:
                ...
                if 'vps-auth-token' in cookies and len(cookies['vps-auth-token']) > 0:
                    ...
                    raise ClientException(500, "vps-auth-token is not set in the WebSocket headers or it is empty")
            else:
                raise ClientException(500, "No cookies in WebSocket headers")
        except ImportError:
    ...
    def set_default(cls, default):
        """Set default instance of vipas client.

        It stores default vipas client.

        :param default: object of vipas client.
        """
