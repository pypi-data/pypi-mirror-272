...
class ZNLE14(VisaInstrument):
    ...
    def __init__(self, name: str, address: str, **kwargs):
        ...
        self.add_parameter(
            "freedom",
            get_cmd='init:cont:all?',
            get_parser=self._get_state_parser,
            set_cmd='init:cont:all {}',
            set_parser=self._set_state_parser,
            label='Sequencer Mode (Single Mode or Continuous)'
        )
    ...
    def trigger_sweep_restart(self):
        self.write('init:all')
...
class ZNLE14Display(InstrumentChannel):
    ...
    def __init__(self, parent: ZNLE14) -> None:
        """
...
class ZNLEParams(InstrumentChannel):
    ...
    Parameters:
        parent (ZNLE14Channel): Parent display.
    ...
    def __init__(self, parent: ZNLE14Channel) -> None:
        ...
        self.add_parameter(
            "freq_center",
            get_cmd=f'sens{self._parent._channel_num}:freq:cent?',
            get_parser = float,
            set_cmd=f'sens{self._parent._channel_num}:freq:cent {{}}',
            set_parser = float,
        ...
        self.add_parameter(
            "freq_span",
            get_cmd=f'sens{self._parent._channel_num}:freq:span?',
            get_parser = float,
            set_cmd=f'sens{self._parent._channel_num}:freq:span {{}}',
            set_parser = float,
        ...
        self.add_parameter(
            "freq_start",
            get_cmd=f'sens{self._parent._channel_num}:freq:star?',
            get_parser = float,
            set_cmd=f'sens{self._parent._channel_num}:freq:star {{}}',
            set_parser = float,
        ...
        self.add_parameter(
            "freq_stop",
            get_cmd=f'sens{self._parent._channel_num}:freq:stop?',
            get_parser = float,
            set_cmd=f'sens{self._parent._channel_num}:freq:stop {{}}',
            set_parser = float,
        ...
        self.add_parameter(
            "sweep_points",
            get_cmd=f'sens{self._parent._channel_num}:swe:poin?',
            get_parser = int,
            set_cmd=f'sens{self._parent._channel_num}:swe:poin {{}}',
            set_parser = int,
        ...
        self.add_parameter(
            "sweep_type",
            get_cmd=f'sens{self._parent._channel_num}:swe:type?',
            get_parser = str,
            set_cmd=f'sens{self._parent._channel_num}:swe:type {{}}',
        ...
        self.add_parameter(
            "aver_state",
            get_cmd=f'sens{self._parent._channel_num}:aver:stat?',
            get_parser = self._get_state_parser,
            set_cmd=f'sens{self._parent._channel_num}:aver:stat {{}}',
            set_parser = self._set_state_parser,
        ...
        self.add_parameter(
            "aver_count",
            get_cmd=f'sens{self._parent._channel_num}:aver:coun?',
            get_parser = int,
            set_cmd=f'sens{self._parent._channel_num}:aver:coun {{}}',
            set_parser = int,
        ...
        self.add_parameter(
            "bandwidth",
            get_cmd=f'sens{self._parent._channel_num}:band?',
            get_parser = float,
            set_cmd=f'sens{self._parent._channel_num}:band {{}}',
            set_parser = float,
        ...
        self.add_parameter(
            "power",
            get_cmd=f':sour{self._parent._channel_num}:pow?',
            get_parser = float,
            set_cmd=f':sour{self._parent._channel_num}:pow {{}}',
            set_parser = float,
            label='Source Power'
        )
        ...
        self.add_parameter(
            "sweep_time",
            get_cmd=f'sens{self._parent._channel_num}:sweep:time?',
            get_parser = float,
            label='Sweep Time'
        )
