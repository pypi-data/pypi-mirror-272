...
from rime_sdk.swagger.swagger_client import (
    ...
    ValidateFirewallInstanceIdUuidBody,
...
class FirewallInstance:
    ...
    def validate(
        ...
        body = ValidateFirewallInstanceIdUuidBody(
    ...
    def get_effective_config(self) -> dict:
        ...
        with RESTErrorHandler():
            res: GenerativefirewallGetFirewallEffectiveConfigResponse = (
                self._firewall_client.firewall_get_firewall_effective_config(
...
class FirewallClient:
    ...
    def create_firewall_instance(
        ...
        with RESTErrorHandler():
            res: ApigenerativefirewallCreateFirewallInstanceResponse = self._instance_manager_client.firewall_instance_manager_create_firewall_instance(
                req
            )
