...
class Rule_CC04(BaseRule):
    ...
    **Anti-pattern**
    ...
    If the ``allowed_strings_all`` config is set to ``user,profile,id,_`` and
    ...
    **Best practice**
    ...
    def _eval(self, context: RuleContext):
        ...
        is_column = (
            context.parent_stack[-1].is_type("column_reference")
            or context.parent_stack[-1].is_type("column_definition")
            or (
