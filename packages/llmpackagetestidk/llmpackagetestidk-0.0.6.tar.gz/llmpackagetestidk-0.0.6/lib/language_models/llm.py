...
from lib.prompts.base import PromptTemplate
from lib.prompts.template import ConversationTemplate
import uuid
...
class ConversationChain:
    ...
    def predict(self, message: str) -> None:
