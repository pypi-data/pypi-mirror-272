...
from modernqt.src.core import Loader, FileDialog, Font
...
class DropDownMenu(QComboBox):
    ...
    def __init__(
        ...
        if stylesheet is not None:
            self.setStyleSheet(
                Loader.load_file("modernqt/widgets/basic/styles/drop_down_menu.css") + "\n" 
                + stylesheet.replace("DropDownMenu", "QComboBox#drop-down-menu")
            )
        else:
            self.setStyleSheet(Loader.load_file("modernqt/widgets/basic/styles/drop_down_menu.css"))
...
class Entry(QLineEdit):
    ...
    def __init__(
        ...
        if stylesheet is not None:
            self.setStyleSheet(
                Loader.load_file("modernqt/widgets/basic/styles/entry.css") + "\n" 
                + stylesheet.replace("Entry", "QLineEdit#entry")
            )
        else:
            self.setStyleSheet(Loader.load_file("modernqt/widgets/basic/styles/entry.css"))
...
class DigitalEntry(QSpinBox):
    ...
    def __init__(
        ...
        if stylesheet is not None:
            self.setStyleSheet(
                Loader.load_file("modernqt/widgets/basic/styles/digital_entry.css") + "\n" 
                + stylesheet.replace("DigitalEntry", "QSpinBox#digital-entry")
            )
        else:
            self.setStyleSheet(Loader.load_file("modernqt/widgets/basic/styles/digital_entry.css"))
...
class CheckBox(QCheckBox):
    def __init__(
        ...
        if stylesheet is not None:
            self.setStyleSheet(
                Loader.load_file("modernqt/widgets/basic/styles/check_box.css") + "\n" 
                + stylesheet.replace("CheckBox", "QCheckBox#check-box")
            )
        else:
            self.setStyleSheet(Loader.load_file("modernqt/widgets/basic/styles/check_box.css"))
...
class RadioButton(QRadioButton):
    def __init__(
        ...
        if stylesheet is not None:
            self.setStyleSheet(
                Loader.load_file("modernqt/widgets/basic/styles/radio_button.css") + "\n" 
                + stylesheet.replace("RadioButton", "QRaidoButton#radio-button")
            )
        else:
            self.setStyleSheet(Loader.load_file("modernqt/widgets/basic/styles/radio_button.css"))
