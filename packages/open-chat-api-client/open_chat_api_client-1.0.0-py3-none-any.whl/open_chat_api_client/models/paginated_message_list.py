...
T = TypeVar("T", bound="PaginatedMessageList")
...
class PaginatedMessageList:
    ...
    Attributes:
        ...
        results (Union[Unset, List['Message']]):
    """
    ...
    results: Union[Unset, List["Message"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = Message.from_dict(results_item_data)

            results.append(results_item)

        paginated_message_list = cls(
            page_size=page_size,
        ...
        paginated_message_list.additional_properties = d
