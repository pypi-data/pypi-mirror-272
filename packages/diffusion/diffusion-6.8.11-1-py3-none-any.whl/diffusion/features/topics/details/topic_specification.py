...
class TopicSpecification(typing.Generic[T], pydantic.generics.GenericModel):
    """
    ...
    | Default when optional                                                                                                                     | [STRING][diffusion.datatypes.STRING] [JSON][diffusion.datatypes.JSON] [BINARY][diffusion.datatypes.BINARY]                                               | [DOUBLE][diffusion.datatypes.DOUBLE] [INT64][diffusion.datatypes.INT64]   | [RECORD_V2][diffusion.datatypes.RECORD_V2]   |   
    | ----------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- -------- | ------------------------------------------------------------------------- | -------------------------------------------- | 
    | [COMPRESSION][diffusion.features.topics.details.topic_specification.TopicSpecification.COMPRESSION]                                       | [CompressionPolicy.LOW][diffusion.features.topics.details.topic_specification.CompressionPolicy.LOW]                                                     | Optional                                                                  | —                                            |                                         
    | [CONFLATION][diffusion.features.topics.details.topic_specification.TopicSpecification.CONFLATION]                                         | [ConflationPolicy.CONFLATE][diffusion.features.topics.details.topic_specification.ConflationPolicy.CONFLATE]                                             | Optional                                                                  | Optional                                     |                                         
    | [DONT_RETAIN_VALUE][diffusion.features.topics.details.topic_specification.TopicSpecification.DONT_RETAIN_VALUE]                           | `False`                                                                                                                                                  | Optional                                                                  | Optional                                     |                                         
    | [OWNER][diffusion.features.topics.details.topic_specification.TopicSpecification.OWNER]                                                   | Optional                                                                                                                                                 | Optional                                                                  | Optional                                     |                                         
    | [PERSISTENT][diffusion.features.topics.details.topic_specification.TopicSpecification.PERSISTENT]                                         | `True`                                                                                                                                                   | Optional                                                                  | Optional                                     |                                         
    | [PRIORITY][diffusion.features.topics.details.topic_specification.TopicSpecification.PRIORITY]                                             | [TopicDeliveryPriority.DEFAULT][diffusion.features.topics.details.topic_specification.TopicDeliveryPriority.DEFAULT]                                     | Optional                                                                  | Optional                                     |                                         
    | [PUBLISH_VALUES_ONLY][diffusion.features.topics.details.topic_specification.TopicSpecification.PUBLISH_VALUES_ONLY]                       | `False`                                                                                                                                                  | Optional                                                                  | —                                            |                                         
    | [REMOVAL][diffusion.features.topics.details.topic_specification.TopicSpecification.REMOVAL]                                               | Optional                                                                                                                                                 | Optional                                                                  | Optional                                     |                                         
    | [SCHEMA][diffusion.features.topics.details.topic_specification.TopicSpecification.SCHEMA]                                                 | —                                                                                                                                                        | —                                                                         | Optional                                     |                                                
    | [TIDY_ON_UNSUBSCRIBE][diffusion.features.topics.details.topic_specification.TopicSpecification.TIDY_ON_UNSUBSCRIBE]                       | `False`                                                                                                                                                  | Optional                                                                  | Optional                                     |                                         
    | [VALIDATE_VALUES][diffusion.features.topics.details.topic_specification.TopicSpecification.VALIDATE_VALUES]                               | `False`                                                                                                                                                  | Optional                                                                  | Optional                                     |                                         
    ...
    [ROUTING][diffusion.datatypes.ROUTING]
    topic) will retain its
