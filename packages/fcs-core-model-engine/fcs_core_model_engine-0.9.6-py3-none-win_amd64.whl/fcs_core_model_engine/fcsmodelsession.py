...
class CloudModelCommunicatorBase(ABC):
    ...
    @abstractmethod
    def translate_vector(self, instance_id: int, vector_xyz: list) -> GEOM_Object | None:
       """
       Eltol egy vektor altal megadott iranyba es a vektor meretevel
       """
       
    @abstractmethod
    def translate_two_points(self, instance1_id: int, object2_id: int, object3_id: int):
       """
