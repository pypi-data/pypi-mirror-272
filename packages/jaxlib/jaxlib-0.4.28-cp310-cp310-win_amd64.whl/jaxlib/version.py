...
_release_version: str = '0.4.28'

# The following line is overwritten by build scripts in distributions &
# releases. Do not modify this manually, or jax/jaxlib build will fail.
_git_hash: str = '9e62994bce7c7fcbb2f6a50c9ef89526cd2c2be6'
...
def _write_version(fname: str) -> None:
  ...
  old_version_string = "_release_version: str = '0.4.28'"
  ...
  if githash:
    old_githash_string = "_git_hash: str = '9e62994bce7c7fcbb2f6a50c9ef89526cd2c2be6'"
