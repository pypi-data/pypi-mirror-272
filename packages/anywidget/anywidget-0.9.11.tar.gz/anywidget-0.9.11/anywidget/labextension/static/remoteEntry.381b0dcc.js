...
var moduleMap = {
  "./extension": function() {
return Promise.all([__webpack_require__.e("154"), __webpack_require__.e("814")]).then(function() { return function() { return __webpack_require__(/*! /Users/runner/work/anywidget/anywidget/packages/anywidget/src/plugin.js */"148"); }; });
},
};
...
// This function allow to reference chunks
        __webpack_require__.u = function (chunkId) {
          ...
          // return url for filenames based on template
          return "" + chunkId + "." + {"154": "92d46275","814": "009211f5",}[chunkId] + ".js";
        };
...
__webpack_require__.consumesLoadingData = { chunkMapping: {"814":["384"],"154":[]}, moduleIdToConsumeDataMapping: { "384": { shareScope: "default", shareKey: "@jupyter-widgets/base", import: null, requiredVersion: "^2 || ^3 || ^4 || ^5 || ^6", strictVersion: false, singleton: true, eager: false, fallback: undefined } }, initialConsumes: [] };
