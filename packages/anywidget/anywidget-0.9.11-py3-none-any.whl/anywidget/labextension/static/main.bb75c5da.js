...
"592": (function (__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {
"use strict";
__webpack_require__.d(__webpack_exports__, {
  GW: function() { return createEffect; },
  SN: function() { return createResource; },
  gQ: function() { return createSignal; },
  so: function() { return createRoot; }
});
let taskIdCounter = 1, isCallbackScheduled = false, isPerformingWork = false, taskQueue = (/* unused pure expression or super */ null && ([])), currentTask = null, shouldYieldToHost = null, yieldInterval = 5, deadline = 0, maxYieldInterval = 300, scheduleCallback = null, scheduledCallback = null;
...
"683": (function (__unused_webpack___webpack_module__, __unused_webpack___webpack_exports__, __webpack_require__) {
"use strict";
...
], _widget_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */.Z);
}),
...
/* harmony import */var solid_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! solid-js */"592");
...
class Runtime {
    ...
    /** @param {import("@jupyter-widgets/base").DOMWidgetModel} model */ constructor(model){
        this.#disposer = solid_js__WEBPACK_IMPORTED_MODULE_1__/* .createRoot */.so((dispose)=>{
            ...
            /** @type {import("solid-js").Signal<string>} */ let [esm, setEsm] = solid_js__WEBPACK_IMPORTED_MODULE_1__/* .createSignal */.gQ(model.get("_esm"));
	 ...
	 */ async create_view(view) {
        ...
        let disposer = solid_js__WEBPACK_IMPORTED_MODULE_1__/* .createRoot */.so((dispose)=>{
            /** @type {void | (() => import("vitest").Awaitable<void>)} */ let cleanup;
            let resource = solid_js__WEBPACK_IMPORTED_MODULE_1__/* .createResource */.SN(this.#widget_result, async (widget_result)=>{
                cleanup?.();
...
//# sourceMappingURL=main.bb75c5da.js.map