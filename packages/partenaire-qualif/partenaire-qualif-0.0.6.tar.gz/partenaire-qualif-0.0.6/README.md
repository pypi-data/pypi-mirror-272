...
prompt_qualification_template = "./prompt_qualification_template.txt" # qualification prompt template path
...
browsing = False
tool = CompanyQualificationTool(client=client, prompt_qualification_template_path=prompt_qualification_template,
                             model=model, temperature=0, browsing=browsing)
...
prompt_website_template = "./prompt_find_website.txt" # website searching prompt template path
tool = CompanyQualificationTool(client=client, prompt_qualification_template_path=prompt_qualification_template,
                             model=model, temperature=0, browsing=True,
                             browsing_key=browsing_key, prompt_find_website_template=prompt_website_template)
result = tool.qualify(partner_name="Your_Partner_Name")
print(result)
```
