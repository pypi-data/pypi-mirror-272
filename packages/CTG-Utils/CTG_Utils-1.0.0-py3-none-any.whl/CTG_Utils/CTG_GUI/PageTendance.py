...
def create_tendance_analysis(self, master, page_name, institute, ctg_path):
    ...
    def _launch_evolution_sorties(ctg_path):
        # Internal imports
        from CTG_Utils.CTG_Func.CTG_synthese import evolution_sorties
    ...
    def _launch_member_history_analysis(ctg_path):
        ...
        # Internal imports
        from CTG_Utils.CTG_Func.CTG_effectif import builds_excel_presence_au_club
        from CTG_Utils.CTG_Func.CTG_effectif import anciennete_au_club
