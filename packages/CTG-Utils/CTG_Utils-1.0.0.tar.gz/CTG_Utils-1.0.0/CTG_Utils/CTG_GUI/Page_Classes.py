...
class PageTitle(tk.Tk):
    ...
    def __init__(self, parent):
        ...
        # Local imports
        import CTG_Utils.CTG_GUI.GUI_Globals as gg
        import CTG_Utils.CTG_GUI.Useful_Functions as guf
...
class PageEffectif(tk.Frame):
    ...
    def __init__(self, container_frame, master, container_button, institute, ctg_path):
        # Local imports
        from CTG_Utils.CTG_GUI.PageEffectif import create_effectif_analysis
...
class PageSorties(tk.Frame):
    ...
    def __init__(self, container_frame, master, container_button, institute, ctg_path):
        # Local imports
        from CTG_Utils.CTG_GUI.PageSorties import create_sorties_analysis        
...
class PageSynthese(tk.Frame):
    ...
    def __init__(self, container_frame, master, container_button, institute, ctg_path):
        # Local imports
        from CTG_Utils.CTG_GUI.PageSynthese import create_synthese_analysis
...
class PageTendance(tk.Frame):
    ...
    def __init__(self, container_frame, master, container_button, institute, ctg_path):
        # Local imports
        from CTG_Utils.CTG_GUI.PageTendance import create_tendance_analysis
...
class SetControllerButton(tk.Tk):
    ...
    def __init__(self, master, container_button,page_name):
        ...
        import CTG_Utils.CTG_GUI.GUI_Globals as gg
        from CTG_Utils.CTG_GUI.Useful_Functions import mm_to_px
        from CTG_Utils.CTG_GUI.Useful_Functions import show_frame 
