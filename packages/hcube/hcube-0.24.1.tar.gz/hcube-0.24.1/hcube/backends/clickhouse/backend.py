...
class ClickhouseCubeBackend(CubeBackend):
    ...
    def _prepare_db_query(
        ...
        for transform in query.transforms:
            ...
            if (
                ...
                or (transform.dimension and transform.dimension.name in group_names)
                ...
                # if the query has no aggregations, or if the transform has no dimension
        ...
        for fltr in query.filters:
            ...
            if fltr.get_extra_param("prewhere"):
    ...
    def _create_materialized_view(
        ...
        summed_cols = ",".join(a.dim_or_metric.name for a in matview._aggregations)
        ...
        bt_command = (
            ...
            f"ENGINE = SummingMergeTree({summed_cols}) "
