...
class HiFTrainer(Trainer):
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            optimizer_cls, optimizer_kwargs = HiFTrainer.get_optimizer_cls_and_kwargs(self.args)
    ...
    def update_parameter_state(self):
        ...
        group_number_min = min([len(self.optimizer_states),len(optimizer_grouped_parameters)])
        for i in range(group_number_min):
            optimizer_grouped_parameters[i].update(self.optimizer_states[i])
        del optimizer_grouped_parameters[group_number_min:]
