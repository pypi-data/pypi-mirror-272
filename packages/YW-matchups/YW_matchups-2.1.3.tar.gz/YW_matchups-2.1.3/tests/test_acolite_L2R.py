...
sat_folder = '/Users/yw/Downloads/test_ACOLITE_L2R'
# sat_folder = '/Users/yw/Downloads/test_L8'
...
test = YW_matchups.run(sat_folder, is_file, AC='ACOLITE', out_file=out_file, to_log = True, ACOLITE_L2R=False)
