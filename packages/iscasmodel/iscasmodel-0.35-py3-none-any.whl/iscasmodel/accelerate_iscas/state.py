...
class PartialState:
    ...
    **Available attributes:**
        ...
        - **distributed_type** ([`~accelerate_iscas.state.DistributedType`]) -- The type of distributed environment currently
          in use.
                ...
                if self.device.type == "cuda" and not check_cuda_p2p_ib_support():
                    if "NCCL_P2P_DISABLE" not in os.environ or "NCCL_IB_DISABLE" not in os.environ:
                        raise NotImplementedError(
                            ...
                            'Please set `NCCL_P2P_DISABLE="1"` and `NCCL_IB_DISABLE="1" or use `accelerate_iscas launch` which '
    ...
    def wait_for_everyone(self):
        ...
        >>> import time
        >>> from accelerate_iscas.state import PartialState
        ...
        if self.distributed_type in (
            ...
            xm.rendezvous("accelerate_iscas.utils.wait_for_everyone")
    ...
    def split_between_processes(self, inputs: list | tuple | dict | torch.Tensor, apply_padding: bool = False):
        ...
        from accelerate_iscas import PartialState
...
class AcceleratorState:
    ...
    **Available attributes:**
        ...
        if not self.initialized:
            ...
            if not _from_accelerator:
                raise ValueError(
                    ...
                    "before using any functionality from the `accelerate_iscas` library."
                )
    ...
    def split_between_processes(self, inputs: list | tuple | dict | torch.Tensor, apply_padding: bool = False):
        ...
        ```python
        # Assume there are two processes
        from accelerate_iscas.state import AcceleratorState
