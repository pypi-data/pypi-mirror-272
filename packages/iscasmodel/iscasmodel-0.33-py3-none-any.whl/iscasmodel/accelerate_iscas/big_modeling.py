...
def init_empty_weights(include_buffers: bool = None):
    ...
    ```python
    import torch.nn as nn
    from accelerate_iscas import init_empty_weights
...
def init_on_device(device: torch.device, include_buffers: bool = None):
    ...
    ```python
    import torch.nn as nn
    from accelerate_iscas import init_on_device
...
def load_checkpoint_and_dispatch(
    ...
    ```python
    >>> from accelerate_iscas import init_empty_weights, load_checkpoint_and_dispatch
