    ...
    <div class="container">
        ...
        <div class="subscribe">
            <div class="subscribe-ft">
                ...
                <a class="optional" id="ft-link">no</a>
            </div>
    ...
    <script>
        ...
        async function setParameters() {{
            if (Object.keys(uinfo).length > 0) {{
                ...
                if (argument === 'ucomment') {{
                    let invoiceInput = parseInt(document.getElementById('invoice-input').value)
                    document.getElementById('ft-send').textContent = `{12} ${{uinfo['cnt']}} ${{comments}}`
                }}
            }}
        }}
        ...
        if (argument === 'ucomment') {{
            document.getElementById('invoice-input').addEventListener('input', async () => {{
                let invoiceInput = parseInt(document.getElementById('invoice-input').value)
                document.getElementById('ft-send').textContent = `{12} ${{invoiceInput}} ${{comments}}`
            }})
        }}
        ...
        document.getElementById('ft-send').addEventListener('click', async () => {{
            try {{
                ...
                if (argument === 'ucomment') {{
                    let invoiceInput = parseFloat(document.getElementById('invoice-input').value)
                    amt = (invoiceInput * parseFloat(amount)).toString()
                    console.log(invoiceInput, amt)
