""" 
    ### Usage:
        ...
        # Prompt Optimization
            python query.py prompt_find_best --dirout ztmp/exp/


        # Generating synthetic queries
            python query.py generator_syntheticquery  --dirdata ztmp/bench --dataset ag_news --nfile 10 --nquery 5 --prompt_id "20240505-514"
...
def prompt_find_best(dirdata: str = "ztmp", dataset: str = "ag_news",
                     dirout: str = "ztmp/exp",
    ...
    """ Optimize  Prompt using DPSY
        ...
        Args:
            dirdata (str):  directory containing  data.
            dataset (str):  dataset to be used for finding  best prompt.
            dirout (str):  output directory for storing results.
    ...
    log("#######  Load Data ")
    dirdata2 = f"{dirdata}/bench/norm/{dataset}/*/df*.parquet"
...
class PromptStorage:
    ...
    def append(self, prompt_template, model_id, prompt_args, prompt_examples="", task_name="", info_json=""):
        ...
        Args:
            ...
            prompt_examples (Optional[str]):  examples for  prompt. Defaults to None.
            task_name (Optional[str]):  name of  task. Defaults to None.
            info_json (Optional[str]): Additional information in JSON format. Defaults to None.
        """
...
def generator_syntheticquery(dirdata: str = "ztmp/bench", dataset: str = "ag_news",
    ...
    """Generate synthetic queries via LLM
      ...
      python query.py generator_syntheticquery --dataset "ag_news" --nfile 1 --nquery 1
    ...
    dirout2 = f"{dirout}/{dataset}/query/df_synthetic_queries_{dt}.csv"
    ...
    log("###### Generate Synthetic queries from answer ")
    queries = []
