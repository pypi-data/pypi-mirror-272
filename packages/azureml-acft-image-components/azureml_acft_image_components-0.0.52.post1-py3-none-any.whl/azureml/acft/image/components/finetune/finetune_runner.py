...
def finetune_runner(component_args: Namespace) -> None:
    ...
    # from scratch.
    if os.path.exists(component_args.output_dir) and master_process:
        shutil.rmtree(component_args.output_dir)
    os.makedirs(component_args.output_dir, exist_ok=True)
