...
from .admin_helpers import prettify_json
from .models import CRUDEvent
from .models import LoginEvent
from .models import RequestEvent
from .settings import CRUD_EVENT_LIST_FILTER
from .settings import CRUD_EVENT_SEARCH_FIELDS
from .settings import LOGIN_EVENT_LIST_FILTER
from .settings import LOGIN_EVENT_SEARCH_FIELDS
from .settings import REQUEST_EVENT_LIST_FILTER
from .settings import REQUEST_EVENT_SEARCH_FIELDS
...
class CRUDEventAdmin(EasyAuditModelAdmin):
    list_display = ['get_event_type_display', 'get_content_type', 'object_id', 'object_repr_link', 'user_link',
                    'datetime']
    ...
    def get_changelist_instance(self, *args, **kwargs):
        ...
        self.content_types_by_id = {content_type.id: content_type for content_type in
                                    ContentType.objects.filter(id__in=content_type_ids)}
