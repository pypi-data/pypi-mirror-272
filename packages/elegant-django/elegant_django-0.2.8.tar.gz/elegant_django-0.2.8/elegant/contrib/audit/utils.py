...
def model_delta(old_model, new_model):
    ...
    :param old_model: The old state of the model instance.
    :type old_model: Model
    :param new_model: The new state of the model instance.
    ...
    delta = {}
    fields = new_model._meta.fields  # noqa
...
def get_m2m_field_name(model, instance):
    ...
    :rtype: str
    """
    for x in model._meta.related_objects:  # noqa
