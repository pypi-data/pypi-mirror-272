...
class BinanceWebSocketApiManager(threading.Thread):
    ...
    def __init__(self, process_stream_data: Optional[Callable] = ..., process_stream_data_async: Optional[Callable] = ..., process_asyncio_queue: Optional[Callable] = ..., exchange: str = ..., warn_on_update: bool = ..., restart_timeout: int = ..., show_secrets_in_logs: bool = ..., output_default: Optional[Literal['dict', 'raw_data', 'UnicornFy']] = ..., enable_stream_signal_buffer: bool = ..., disable_colorama: bool = ..., stream_buffer_maxlen: Optional[int] = ..., process_stream_signals: Incomplete | None = ..., close_timeout_default: int = ..., ping_interval_default: int = ..., ping_timeout_default: int = ..., high_performance: bool = ..., debug: bool = ..., restful_base_uri: str = ..., websocket_base_uri: str = ..., websocket_api_base_uri: str = ..., max_subscriptions_per_stream: Optional[int] = ..., exchange_type: Literal['cex', 'dex', None] = ..., socks5_proxy_server: str = ..., socks5_proxy_user: str = ..., socks5_proxy_pass: str = ..., socks5_proxy_ssl_verification: bool = ..., auto_data_cleanup_stopped_streams: bool = ..., lucit_api_secret: str = ..., lucit_license_ini: str = ..., lucit_license_profile: str = ..., lucit_license_token: str = ..., ubra_manager: BinanceRestApiManager = ...) -> None: ...
    def __enter__(self): ...
    ...
    def create_stream(self, channels: Union[str, List[str], Set[str], None] = ..., markets: Union[str, List[str], Set[str], None] = ..., stream_label: str = ..., stream_buffer_name: Union[bool, str] = ..., api_key: str = ..., api_secret: str = ..., symbols: Union[str, List[str], Set[str], None] = ..., output: Optional[Literal['dict', 'raw_data', 'UnicornFy']] = ..., ping_interval: int = ..., ping_timeout: int = ..., close_timeout: int = ..., listen_key: str = ..., keep_listen_key_alive: bool = ..., stream_buffer_maxlen: int = ..., api: bool = ..., process_stream_data: Optional[Callable] = ..., process_stream_data_async: Optional[Callable] = ..., process_asyncio_queue: Optional[Callable] = ...): ...
    ...
    def is_exchange_type(self, exchange_type: str = ...): ...
