...
class BinanceWebSocketApiManager(threading.Thread):
    ...
    def __init__(self, process_stream_data: Callable | None = None, process_stream_data_async: Callable | None = None, process_asyncio_queue: Callable | None = None, exchange: str | None = 'binance.com', warn_on_update: bool | None = True, restart_timeout: int = 6, show_secrets_in_logs: bool | None = False, output_default: Literal['dict', 'raw_data', 'UnicornFy'] | None = 'raw_data', enable_stream_signal_buffer: bool | None = False, disable_colorama: bool | None = False, stream_buffer_maxlen: int | None = None, process_stream_signals: Incomplete | None = None, close_timeout_default: int = 1, ping_interval_default: int = 5, ping_timeout_default: int = 10, high_performance: bool | None = False, debug: bool | None = False, restful_base_uri: str | None = None, websocket_base_uri: str | None = None, websocket_api_base_uri: str | None = None, max_subscriptions_per_stream: int | None = None, exchange_type: Literal['cex', 'dex'] | None = None, socks5_proxy_server: str | None = None, socks5_proxy_user: str | None = None, socks5_proxy_pass: str | None = None, socks5_proxy_ssl_verification: bool | None = True, auto_data_cleanup_stopped_streams: bool = False, lucit_api_secret: str = None, lucit_license_ini: str = None, lucit_license_profile: str = None, lucit_license_token: str = None, ubra_manager: BinanceRestApiManager | None = None) -> None: ...
    def __enter__(self): ...
    ...
    def add_to_stream_buffer(self, stream_data, stream_buffer_name: bool = False): ...
    ...
    def clear_stream_buffer(self, stream_buffer_name: bool = False): ...
    def create_payload(self, stream_id, method, channels: Incomplete | None = None, markets: Incomplete | None = None): ...
    def create_stream(self, channels=[], markets=[], stream_label: Incomplete | None = None, stream_buffer_name: bool = False, api_key: Incomplete | None = None, api_secret: Incomplete | None = None, symbols: Incomplete | None = None, output: bool = False, ping_interval: Incomplete | None = None, ping_timeout: Incomplete | None = None, close_timeout: Incomplete | None = None, listen_key: str = None, keep_listen_key_alive: bool = True, stream_buffer_maxlen: Incomplete | None = None, api: bool = False, process_stream_data: Callable | None = None, process_stream_data_async: Callable | None = None, process_asyncio_queue: Callable | None = None): ...
    ...
    def get_stream_buffer_length(self, stream_buffer_name: bool = False): ...
    def get_stream_id_by_label(self, stream_label: bool = False) -> str | None: ...
    ...
    def get_stream_buffer_maxlen(self, stream_buffer_name: bool = False): ...
    ...
    def is_exchange_type(self, exchange_type: bool = False): ...
    ...
    def is_update_availabe_check_command(self, check_command_version: bool = False): ...
    def pop_stream_data_from_stream_buffer(self, stream_buffer_name: Incomplete | None = None, mode: str = 'FIFO'): ...
    def pop_stream_signal_from_stream_signal_buffer(self): ...
    def print_stream_info(self, stream_id, add_string: Incomplete | None = None, title: Incomplete | None = None): ...
    def print_summary(self, add_string: Incomplete | None = None, disable_print: bool = False, title: Incomplete | None = None): ...
    def print_summary_to_png(self, print_summary_export_path, hight_per_row: float = 12.5, add_string: Incomplete | None = None, title: Incomplete | None = None): ...
    @staticmethod
    def remove_ansi_escape_codes(text): ...
    def replace_stream(self, stream_id, new_channels, new_markets, new_stream_label: Incomplete | None = None, new_stream_buffer_name: bool = False, new_api_key: Incomplete | None = None, new_api_secret: Incomplete | None = None, new_symbols: Incomplete | None = None, new_output: str = 'raw_data', new_ping_interval: int = 20, new_ping_timeout: int = 20, new_close_timeout: int = 10, new_stream_buffer_maxlen: Incomplete | None = None): ...
    def run(self) -> None: ...
