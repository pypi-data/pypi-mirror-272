...
import asyncio
import threading
from .api import BinanceWebSocketApiApi as BinanceWebSocketApiApi
...
class BinanceWebSocketApiManager(threading.Thread):
    ...
    def __init__(self, process_stream_data: Optional[Callable] = ..., process_stream_data_async: Optional[Callable] = ..., process_asyncio_queue: Optional[Callable] = ..., exchange: Optional[str] = ..., warn_on_update: Optional[bool] = ..., restart_timeout: int = ..., show_secrets_in_logs: Optional[bool] = ..., output_default: Optional[Literal['dict', 'raw_data', 'UnicornFy']] = ..., enable_stream_signal_buffer: Optional[bool] = ..., disable_colorama: Optional[bool] = ..., stream_buffer_maxlen: Optional[int] = ..., process_stream_signals: Incomplete | None = ..., close_timeout_default: int = ..., ping_interval_default: int = ..., ping_timeout_default: int = ..., high_performance: Optional[bool] = ..., debug: Optional[bool] = ..., restful_base_uri: Optional[str] = ..., websocket_base_uri: Optional[str] = ..., websocket_api_base_uri: Optional[str] = ..., max_subscriptions_per_stream: Optional[int] = ..., exchange_type: Optional[Literal['cex', 'dex']] = ..., socks5_proxy_server: Optional[str] = ..., socks5_proxy_user: Optional[str] = ..., socks5_proxy_pass: Optional[str] = ..., socks5_proxy_ssl_verification: Optional[bool] = ..., auto_data_cleanup_stopped_streams: bool = ..., lucit_api_secret: str = ..., lucit_license_ini: str = ..., lucit_license_profile: str = ..., lucit_license_token: str = ..., ubra_manager: Optional[BinanceRestApiManager] = ...) -> None: ...
    def __enter__(self): ...
    ...
    def add_to_stream_buffer(self, stream_data, stream_buffer_name: bool = ...): ...
    ...
    def clear_stream_buffer(self, stream_buffer_name: bool = ...): ...
    def create_payload(self, stream_id, method, channels: Incomplete | None = ..., markets: Incomplete | None = ...): ...
    def create_stream(self, channels=..., markets=..., stream_label: Incomplete | None = ..., stream_buffer_name: bool = ..., api_key: Incomplete | None = ..., api_secret: Incomplete | None = ..., symbols: Incomplete | None = ..., output: bool = ..., ping_interval: Incomplete | None = ..., ping_timeout: Incomplete | None = ..., close_timeout: Incomplete | None = ..., listen_key: str = ..., keep_listen_key_alive: bool = ..., stream_buffer_maxlen: Incomplete | None = ..., api: bool = ..., process_stream_data: Optional[Callable] = ..., process_stream_data_async: Optional[Callable] = ..., process_asyncio_queue: Optional[Callable] = ...): ...
    def create_websocket_uri(self, channels, markets, stream_id: Incomplete | None = ..., symbols: Incomplete | None = ..., api: bool = ...): ...
    ...
    def get_monitoring_status_icinga(self, check_command_version: bool = ..., warn_on_update: bool = ...): ...
    def get_monitoring_status_plain(self, check_command_version: bool = ..., warn_on_update: bool = ...): ...
    @staticmethod
    ...
    def get_stream_buffer_length(self, stream_buffer_name: bool = ...): ...
    def get_stream_id_by_label(self, stream_label: bool = ...) -> Optional[str]: ...
    ...
    def get_stream_buffer_maxlen(self, stream_buffer_name: bool = ...): ...
    ...
    def is_exchange_type(self, exchange_type: bool = ...): ...
    ...
    def is_update_availabe_check_command(self, check_command_version: bool = ...): ...
    def pop_stream_data_from_stream_buffer(self, stream_buffer_name: Incomplete | None = ..., mode: str = ...): ...
    def pop_stream_signal_from_stream_signal_buffer(self): ...
    def print_stream_info(self, stream_id, add_string: Incomplete | None = ..., title: Incomplete | None = ...): ...
    def print_summary(self, add_string: Incomplete | None = ..., disable_print: bool = ..., title: Incomplete | None = ...): ...
    def print_summary_to_png(self, print_summary_export_path, hight_per_row: float = ..., add_string: Incomplete | None = ..., title: Incomplete | None = ...): ...
    @staticmethod
    def remove_ansi_escape_codes(text): ...
    def replace_stream(self, stream_id, new_channels, new_markets, new_stream_label: Incomplete | None = ..., new_stream_buffer_name: bool = ..., new_api_key: Incomplete | None = ..., new_api_secret: Incomplete | None = ..., new_symbols: Incomplete | None = ..., new_output: str = ..., new_ping_interval: int = ..., new_ping_timeout: int = ..., new_close_timeout: int = ..., new_stream_buffer_maxlen: Incomplete | None = ...): ...
    def run(self) -> None: ...
    ...
    def start_monitoring_api(self, host: str = ..., port: int = ..., warn_on_update: bool = ...): ...
    ...
    def wait_till_stream_has_stopped(self, stream_id, timeout: float = ...) -> bool: ...
