...
class FreeProxyList1(ProxyProvider):
    def __init__(self, time_validity_period: int):
        ...
        self.proxy = httpx.URL("http://127.0.0.1:8889")
    ...
    def _extract_ip_port(self, raw_html: str) -> List[Dict[str, str]]:
        ip_port_list = []
    ...
    async def get_proxies(self, num: int) -> List[IpInfoModel]:
        ...
        async with httpx.AsyncClient(proxies=self.proxy) as client:
            ...
            res_dict: Dict = self._extract_ip_port(res_text)
            if bool(res_dict):
