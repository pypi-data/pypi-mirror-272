> *forked from [media clawer](https://github.com/NanmiCoder/MediaCrawler)*

## for my own learning only, plz fork from the source repo rather than the repo to escape my crashed changes.
...
### create and activate virtualenv
   ```shell   
   virtualenv -p /path/to/your/python/bin ./bin_12
   source ./bin_12/bin/activate
   ```
