...
class FileScraper:
    def __init__(self, path_to_local_file: str, args, things_to_extract: dict, ptjsonlib: object):
    ...
    def process_file(self, path_to_local_file: str, args, things_to_extract: dict, ptjsonlib: object) -> dict:
        ...
        result = self._scrape_file(path_to_local_file, is_readable, ptjsonlib, args, things_to_extract)
        return result


    def _scrape_file(self, path_to_local_file: str, is_readable, ptjsonlib, args, extract_types: dict) -> dict:
