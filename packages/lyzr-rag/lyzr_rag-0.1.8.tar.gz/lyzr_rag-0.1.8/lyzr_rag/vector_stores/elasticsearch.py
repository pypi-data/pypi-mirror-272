...
from lyzr_rag.bridge.pydantic import PrivateAttr
from lyzr_rag.schema import BaseNode, MetadataMode, TextNode
...
from lyzr_rag.vector_stores.utils import metadata_dict_to_node, node_to_metadata_dict
...
class ElasticsearchStore(BasePydanticVectorStore):
    ...
    def get_user_agent() -> str:
        ...
        return f"lyzr_rag-py-vs/{lyzr_rag.__version__}"
