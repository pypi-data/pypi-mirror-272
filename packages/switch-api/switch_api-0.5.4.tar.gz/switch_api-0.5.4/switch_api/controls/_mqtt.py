...
class SwitchMQTT:
    ...
    def _on_connect(self, client: mqtt.Client, userdata: any | None, flags: dict, rc: int):
    ...
    def _on_message(self, client: mqtt.Client, userdata: any | None, message: MQTTMessage):
