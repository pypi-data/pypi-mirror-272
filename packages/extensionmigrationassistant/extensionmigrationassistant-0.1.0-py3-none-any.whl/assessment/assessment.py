...
def load_template():
    try:
        env = Environment(loader=FileSystemLoader(r'F:\akash\python_package\extensionmigrationassistant\assessment'))
...
def read_data_from_csv():
    try:
        data = pd.read_csv(r"F:\akash\python_package\extensionmigrationassistant\assessment\sct_input.csv")
        aws_df = pd.read_csv(r"F:\akash\python_package\extensionmigrationassistant\assessment\awssctcomplexitymatrix.csv")
        return data,aws_df
    except Exception as e:
        print(e)
