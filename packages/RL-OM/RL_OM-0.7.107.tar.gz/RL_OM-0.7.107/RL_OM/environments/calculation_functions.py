...
def ds_calculations_di_action(self, action):
    ...
    total_inventory_position = self.inventory + np.sum(self.order_pipeline)
    expedited_inventory_position = np.sum(self.inventory) + np.sum(self.order_pipeline[-self.lead_time_expedited[0]:])
