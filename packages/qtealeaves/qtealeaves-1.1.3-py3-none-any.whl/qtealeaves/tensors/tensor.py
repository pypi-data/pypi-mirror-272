    ...
    **Arguments**
    ...
    def eig_api(
        ...
        **Returns**
        ...
        eig_api_qtea_dim2 = self.is_dtype_complex() and (np.product(self.shape) == 2)
    ...
    def fuse_links_update(self, fuse_low, fuse_high, is_link_outgoing=True):
        ...
        shape += [np.product(self.shape[fuse_low : fuse_high + 1])]
    ...
    def mpi_recv(cls, from_, comm, tn_mpi_types, tensor_backend):
        ...
        **Arguments**
        ...
        obj = cls(shape, ctrl="N", dtype=dtype)
    ...
    def vector_with_dim_like(self, dim, dtype=None):
        ...
        return xp.ndarray(dim, dtype=self.dtype)
