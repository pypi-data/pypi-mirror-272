...
def pipeline(accelerator: str = "T4",
    ...
    transform_env["PF_JOB_QUEUE_NAME"] = "qr200"
    transform_env["PF_JOB_FLAVOUR"] = "c4m16xpu1"
    transform_env["ACCELERATOR"] = "R200"
...
def transform_eval_step(algorithm: str,
    ...
    transform_eval = ContainerStep(name="transform-eval",
                                   ...
                                   command=f'sleep 10000 && python3 -m gaea_operator.components.transform_eval.transform_eval '
