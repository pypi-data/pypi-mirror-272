...
def get_eagle_badges(merit_badges):
    eagle_badges = {}
    for badge in sorted( filter(itemgetter("Eagle Required"), merit_badges.values()), key=itemgetter("Date")):
...
def get_life_badges(merit_badges):
    eagle_badges = sorted(
        filter(itemgetter("Eagle Required"), merit_badges.values()), key=itemgetter("Date")
    )
    life_badges = {}
