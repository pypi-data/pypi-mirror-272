...
class Parser:
    def __init__(self, infile=None, filestream=None, config=Config, outfile=None, file_format=None):
        self.config = Config
        if infile:
        ...
        self.raw_scouts = []
        self.scouts = parse_file(infile=self.input_file, filestream=filestream)
