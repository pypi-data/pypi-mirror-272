...
class FalconLogger:
    ...
    ## constructor
    #
    # @param path        full path to the logger file
    ...
    def __init__(self, path, max_entries=10, loop_delay=0.250):
    ...
    # --------------------
    ## terminate
    # stop the thread, save any remaing line in the internal queue
    #
    # @return None
    def term(self):
        self._finished = True
