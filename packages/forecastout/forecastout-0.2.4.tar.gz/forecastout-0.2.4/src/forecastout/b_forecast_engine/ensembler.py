...
class Ensembler:
    """
    This class ensembles c_forecast_models' forecasts to provide a unique
    forecast
    """
    ...
    def average_top_models(
        ...
        """
        Average top c_forecast_models
        """
        # -- Get top c_forecast_models for each id
        df_models_ranked = (
            df_models_ranked
            .loc[df_models_ranked["ranking"] <= n_tops]
        )
        # -- Filter unwanted c_forecast_models
