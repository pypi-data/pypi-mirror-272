...
class Command(BaseCommand):
    ...
    BASE_PATH = Path("fastoche/static/fastoche/dist")

    def handle(self, *args, **options):
        files = [
            {
                "path": "fastoche/fastoche.module.min.js",
                "constant": "INTEGRITY_JS_MODULE",
            },
            {
                "path": "fastoche/fastoche.nomodule.min.js",
                "constant": "INTEGRITY_JS_NOMODULE",
            },
            {"path": "fastoche/fastoche.min.css", "constant": "INTEGRITY_CSS"},
...
# python manage.py integrity_checksums\n\n"""
        ...
        with open("fastoche/checksums.py", "w") as output_file:
