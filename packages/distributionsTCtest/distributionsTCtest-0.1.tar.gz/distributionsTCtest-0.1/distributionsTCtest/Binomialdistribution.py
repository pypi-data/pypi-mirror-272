...
class Binomial(Distribution):
    """Binomial Distribution class from calculating and visualising a Binomial distribution.
    

    Attributes:
        mean (float):   representing the mean value of the distribution
        stdev (float):  representing the standard deviation of the distribution
        data_list (list of floats): aq list of floats to be extracted from the data file
