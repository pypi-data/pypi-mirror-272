...
from .types.create_entity import CreateEntity
from .types.paginated_entities import PaginatedEntities
from .types.update_entity import UpdateEntity
...
class EntitiesClient:
    ...
    def get_entity(self, entity_id: str, *, request_options: typing.Optional[RequestOptions] = None) -> Entity:
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            url=urllib.parse.urljoin(
                f"{self._client_wrapper.get_base_url()}/", f"v1/entities/{jsonable_encoder(entity_id)}"
            ),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic_v1.parse_obj_as(Entity, _response_json)  # type: ignore
    ...
    def list_entities(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            method="GET",
            url=urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/entities"),
            params=jsonable_encoder(
                remove_none_from_dict(
                    {
                        "limit": limit,
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        if 200 <= _response.status_code < 300:
            return pydantic_v1.parse_obj_as(PaginatedEntities, _response_json)  # type: ignore
        if "error" in _response_json:
    ...
    def create_entity(
        self, *, request: CreateEntity, request_options: typing.Optional[RequestOptions] = None
    ) -> typing.List[Entity]:
        """
        Parameters
        ----------
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        if 200 <= _response.status_code < 300:
            return pydantic_v1.parse_obj_as(typing.List[Entity], _response_json)  # type: ignore
        raise ApiError(status_code=_response.status_code, body=_response_json)

    def update_entity(
        self, entity_id: str, *, request: UpdateEntity, request_options: typing.Optional[RequestOptions] = None
    ) -> Entity:
        """
        Parameters
        ----------
        ...
        Examples
        --------
        from sphinxbio import UpdateEntity
        from sphinxbio.client import Sphinxbio
        ...
        client.entities.update_entity(
            entity_id="ent_12345",
            request=UpdateEntity(
                name="BRCA1 High Expression Updated",
            ),
        )
        """
        _response = self._client_wrapper.httpx_client.request(
