...
class PaginatedDatasets(PaginatedResponse):
    """
    Examples
    --------
    import datetime

    from sphinxbio import Dataset, PaginatedDatasets
    ...
    PaginatedDatasets(
        ...
        next_token="bmV4dF90b2tlbl9mb3JfZGF0YXNldHM=",
        url="https://api.sphinxbio.com/v1/datasets",
    )
    """
