# python build stubs for package greeter
...
add_checked_function(mod, 'greeter_Greet', None, [param('char*', 'name'), param('bool', 'goRun')])
add_checked_function(mod, 'greeter_Greet2', None, [param('char*', 'name'), param('bool', 'goRun')])

mod.generate(open('greeter.c', 'w'))
