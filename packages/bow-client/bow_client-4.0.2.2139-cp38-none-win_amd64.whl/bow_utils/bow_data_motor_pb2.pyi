...
class MotorSample(_message.Message):
    __slots__ = ["ControlMode", "Locomotion", "Objectives", "Obstacles", "RawJoints", "WorkspaceReceived", "IKSettings", "GazeTarget"]
...
class IKOptimiser(_message.Message):
    __slots__ = ["Preset", "CustomSettings"]
    ...
    def __init__(self, Preset: _Optional[_Union[IKOptimiser.OptimiserPreset, str]] = ..., CustomSettings: _Optional[_Union[CustomOptimiser, _Mapping]] = ...) -> None: ...
...
class PoseTarget(_message.Message):
    __slots__ = ["Action", "TargetType", "Transform", "Object", "MovementDurationMs", "TargetAccuracy", "OptimiserSettings"]
    class TargetTypeEnum(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
    ...
    OPTIMISERSETTINGS_FIELD_NUMBER: _ClassVar[int]
    Action: ActionEnum
    ...
    def __init__(self, Action: _Optional[_Union[ActionEnum, str]] = ..., TargetType: _Optional[_Union[PoseTarget.TargetTypeEnum, str]] = ..., Transform: _Optional[_Union[_bow_data_common_pb2.Transform, _Mapping]] = ..., Object: _Optional[_Union[Object, _Mapping]] = ..., MovementDurationMs: _Optional[float] = ..., TargetAccuracy: _Optional[float] = ..., OptimiserSettings: _Optional[_Union[IKOptimiser, _Mapping]] = ...) -> None: ...

class Joint(_message.Message):
    __slots__ = ["Name", "Type", "Position", "Velocity", "Acceleration", "Torque", "Min", "Max", "Default", "Temperature", "Healthy"]
    ...
    Temperature: float
    Healthy: bool
    def __init__(self, Name: _Optional[str] = ..., Type: _Optional[_Union[Joint.JointTypeEnum, str]] = ..., Position: _Optional[float] = ..., Velocity: _Optional[float] = ..., Acceleration: _Optional[float] = ..., Torque: _Optional[float] = ..., Min: _Optional[float] = ..., Max: _Optional[float] = ..., Default: _Optional[float] = ..., Temperature: _Optional[float] = ..., Healthy: bool = ...) -> None: ...
...
class BodyPart(_message.Message):
    __slots__ = ["Name", "Type", "RootLink", "Effectors"]
    class BodyPartTypeEnum(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = []
        ROOT: _ClassVar[BodyPart.BodyPartTypeEnum]
        LIMB: _ClassVar[BodyPart.BodyPartTypeEnum]
        GRIPPER: _ClassVar[BodyPart.BodyPartTypeEnum]
    ROOT: BodyPart.BodyPartTypeEnum
    LIMB: BodyPart.BodyPartTypeEnum
    GRIPPER: BodyPart.BodyPartTypeEnum
    NAME_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    ROOTLINK_FIELD_NUMBER: _ClassVar[int]
    EFFECTORS_FIELD_NUMBER: _ClassVar[int]
    Name: str
    Type: BodyPart.BodyPartTypeEnum
    RootLink: str
    Effectors: _containers.RepeatedCompositeFieldContainer[Effector]
    def __init__(self, Name: _Optional[str] = ..., Type: _Optional[_Union[BodyPart.BodyPartTypeEnum, str]] = ..., RootLink: _Optional[str] = ..., Effectors: _Optional[_Iterable[_Union[Effector, _Mapping]]] = ...) -> None: ...

class Effector(_message.Message):
    __slots__ = ["EffectorLinkName", "EndTransform", "RootTransform", "Reach", "JointArray", "AvailableActions", "Workspace", "Objectives", "IsControllable"]
