import cv2
from models_img.test_crack_measure.crack_type import infertype
import string
from models_img.test_crack_measure.pixel import (incircle, foreground_contour_length, each_crack_areas,
                                                 SearchOutline, BinaryImg, count_nonzero, drawOutline)
...
def DetectCrack(mask):
    ...
    if cracktype == 'Mesh':
        ...
        each_area, Bboxing, mask_with_bbox = each_crack_areas(result, thresh)
        ...
        drawOutline(mask_with_bbox, contours_arr)
        return mask_with_bbox, crack_info, each_info
