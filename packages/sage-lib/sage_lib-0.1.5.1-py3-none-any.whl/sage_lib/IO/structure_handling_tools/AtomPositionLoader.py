...
try:
    from sage_lib.IO.structure_handling_tools.structural_file_readers.CIF import CIF
except ImportError as e:
    import sys
...
try:
    from sage_lib.IO.structure_handling_tools.structural_file_readers.PDB import PDB
except ImportError as e:
    import sys
...
try:
    from sage_lib.IO.structure_handling_tools.structural_file_readers.POSCAR import POSCAR
except ImportError as e:
    import sys
...
try:
    from sage_lib.IO.structure_handling_tools.structural_file_readers.XYZ import XYZ
except ImportError as e:
    import sys
...
try:
    from sage_lib.IO.structure_handling_tools.structural_file_readers.SI import SI
except ImportError as e:
    import sys
...
try:
    from sage_lib.IO.structure_handling_tools.structural_file_readers.ASE import ASE
except ImportError as e:
    import sys
...
try:
    from sage_lib.IO.structure_handling_tools.structural_file_readers.AIMS import AIMS
except ImportError as e:
    import sys
