...
class voxel:
    ...
    def WatchVoxel_RGB(self,edges=True,dp=1):
        ...
        for i in tqdm(range(len(self.points_local_un)),desc='赋值有值体素的特征',unit='个体素'):
            self.points_local_un_rgb[i,:] = [self.voxel_values_r[int(self.points_local_un[i, 0]), int(self.points_local_un[i, 1]), int(self.points_local_un[i, 2])],self.voxel_values_g[int(self.points_local_un[i, 0]), int(self.points_local_un[i, 1]), int(self.points_local_un[i, 2])],self.voxel_values_b[int(self.points_local_un[i, 0]), int(self.points_local_un[i, 1]), int(self.points_local_un[i, 2])]]
    ...
    def WatchVoxel_bright(self,num_L=1,L_un=None):
        '显示笛卡尔坐标系体素(单体化显示)'
        # 颜色赋值
    ...
    def WatchVoxel_Highsingleclass(self,HLT=256):
        ...
        plotter = pv.Plotter()  # 创建绘图窗口
        plotter.background_color = 'white'  # 设置背景颜色为白色
        plotter.add_mesh(grid, color='r', show_edges=True)  # 添加体素网格，并设置颜色映射
        # 然后建立普通灰度体素显示
        ...
        plotter.add_mesh(grid, scalars=points_local_un_value_other, show_edges=True,cmap='gray',show_scalar_bar=False)  # 添加体素网格，并设置颜色映射
        plotter.show()  # 显示绘图
...
def Nei_124(x,y,z):
    '124邻域数组函数'
    neighbour = np.array([[x,y+1,z],[x,y+2,z],[x,y-1,z],[x,y-2,z],[x+1,y+1,z],[x+1,y+2,z],[x+1,y-1,z],[x+1,y-2,z],[x+1,y,z],[x+2,y+1,z],[x+2,y+2,z],[x+2,y-1,z],[x+2,y-2,z],[x+2,y,z],[x-1,y+1,z],[x-1,y+2,z],[x-1,y-1,z],[x-1,y-2,z],[x-1,y,z],[x-2,y+1,z],[x-2,y+2,z],[x-2,y-1,z],[x-2,y-2,z],[x-2,y,z],[
                                                        x,y+1,z+1],[x,y+2,z+1],[x,y-1,z+1],[x,y-2,z+1],[x+1,y+1,z+1],[x+1,y+2,z+1],[x+1,y-1,z+1],[x+1,y-2,z+1],[x+1,y,z+1],[x+2,y+1,z+1],[x+2,y+2,z+1],[x+2,y-1,z+1],[x+2,y-2,z+1],[x+2,y,z+1],[x-1,y+1,z+1],[x-1,y+2,z+1],[x-1,y-1,z+1],[x-1,y-2,z+1],[x-1,y,z+1],[x-2,y+1,z+1],[x-2,y+2,z+1],[x-2,y-1,z+1],[x-2,y-2,z+1],[x-2,y,z+1],[
                                                        x,y+1,z+2],[x,y+2,z+2],[x,y-1,z+2],[x,y-2,z+2],[x+1,y+1,z+2],[x+1,y+2,z+2],[x+1,y-1,z+2],[x+1,y-2,z+2],[x+1,y,z+2],[x+2,y+1,z+2],[x+2,y+2,z+2],[x+2,y-1,z+2],[x+2,y-2,z+2],[x+2,y,z+2],[x-1,y+1,z+2],[x-1,y+2,z+2],[x-1,y-1,z+2],[x-1,y-2,z+2],[x-1,y,z+2],[x-2,y+1,z+2],[x-2,y+2,z+2],[x-2,y-1,z+2],[x-2,y-2,z+2],[x-2,y,z+2],[
                                                        x,y+1,z-1],[x,y+2,z-1],[x,y-1,z-1],[x,y-2,z-1],[x+1,y+1,z-1],[x+1,y+2,z-1],[x+1,y-1,z-1],[x+1,y-2,z-1],[x+1,y,z-1],[x+2,y+1,z-1],[x+2,y+2,z-1],[x+2,y-1,z-1],[x+2,y-2,z-1],[x+2,y,z-1],[x-1,y+1,z-1],[x-1,y+2,z-1],[x-1,y-1,z-1],[x-1,y-2,z-1],[x-1,y,z-1],[x-2,y+1,z-1],[x-2,y+2,z-1],[x-2,y-1,z-1],[x-2,y-2,z-1],[x-2,y,z-1],[
                                                        x,y+1,z-2],[x,y+2,z-2],[x,y-1,z-2],[x,y-2,z-2],[x+1,y+1,z-2],[x+1,y+2,z-2],[x+1,y-1,z-2],[x+1,y-2,z-2],[x+1,y,z-2],[x+2,y+1,z-2],[x+2,y+2,z-2],[x+2,y-1,z-2],[x+2,y-2,z-2],[x+2,y,z-2],[x-1,y+1,z-2],[x-1,y+2,z-2],[x-1,y-1,z-2],[x-1,y-2,z-2],[x-1,y,z-2],[x-2,y+1,z-2],[x-2,y+2,z-2],[x-2,y-1,z-2],[x-2,y-2,z-2],[x-2,y,z-2],[
...
class voxel_ρθY:
    ...
    def watch_voxel(self, r=2.75, n=0, color=0, cmap='gray'):
        '体素显示函数'
        '''
