...
class CvaOptParametersProto(_message.Message):
    __slots__ = ("func_eval_worker_url", "objectives", "variables", "parameters")
    ...
    def __init__(self, func_eval_worker_url: _Optional[str] = ..., objectives: _Optional[_Iterable[_Union[CvaOptObjectiveProto, _Mapping]]] = ..., variables: _Optional[_Iterable[_Union[CvaOptVariableProto, _Mapping]]] = ..., parameters: _Optional[_Union[CvaOptParameterProto, _Mapping]] = ...) -> None: ...
