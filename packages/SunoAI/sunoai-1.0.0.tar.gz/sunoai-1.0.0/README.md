...
<a href='https://suno-ai.sdev.lk'>
<img src='https://img.shields.io/badge/FastAPI-Docs-009688?logo=fastapi&style=flat'> 
</a>
</div>
...
Set `SUNO_COOKIE` as an Environmental variable before deploy. -  [Instructions](https://github.com/Malith-Rukshan/Suno-API/tree/main?tab=readme-ov-file#-prerequisites)
...
If you want to try without deploy 👇

✅ Demo with Documentation : [suno-api.sdev.lk](https://suno-api.sdev.lk)
...
Join our Telegram channel, [Single Developers](https://t.me/SingleDevelopers), for more amazing projects and updates!
