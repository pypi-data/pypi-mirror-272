...
from ..touch.discrete_one_touch_as import DiscreteOneTouch


class FixedAccFusing(OneAssetOptionBase):
    ...
    def __calculate_present_value__(self) -> float:
        ...
        for obs in self.param.obs_date:
            ...
            param['obs_freq'] = self.param.obs_freq
            touch3 = DiscreteOneTouch(param)

            rst = rst + self.param.base_quantity * (-self.param.leverage * barrier1.present_value() + binary2.present_value() + touch3.present_value())
