...
test = {
    'id': ObjectId('660f4d1a2d5f00dee0238f3d'),
    'name': 'test',
    'email': 'sarraj@marksmen.nl',
    'ids': [ObjectId('660f4d172d5f00dee0238f3c'), ObjectId('660f4d202d5f00dee0238f3f')],
}
pprint(Helper.standardize_dict(test))
