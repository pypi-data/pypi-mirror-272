...
print("=== build dist ===")
os.system("python3 setup.py sdist --format=zip")
os.system("cp dist/colimit-" + VERSION + "*.zip ../colimit_backend/staging")
os.system("python3 setup.py bdist_wheel")
os.system("cp dist/colimit-" + VERSION + "*.whl ../colimit_backend/staging")
