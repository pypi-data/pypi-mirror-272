...
class DFEClient(BaseClient):
    ...
    def request_register(self, user, password, fullname,
                         email, apikey, phone=None,
                         addr=""):
        body = {
            "user": user,
            "passwd": password,
...
class LLClient(BaseClient):
    ...
    def create_user_levels(self, username: str, hashed_uuid: str, other_fields: dict = None):
        body = {
            "username": username,
            "hashed_uuid": hashed_uuid,
        }
    ...
    def get_user_levels(self, username: str, hashed_uuid: str, other_fields: dict = None):
        body = {
            "username": username,
            "hashed_uuid": hashed_uuid,
        }
