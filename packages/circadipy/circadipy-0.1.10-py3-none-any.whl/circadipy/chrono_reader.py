...
class read_protocol():
    ...
    def make_info_text(self):
        # Create info.txt file about the protocol
        text = 'Protocol name: ' + self.name + '\n'
        text += 'File: ' + self.file + '\n'
        text += 'ZT 0 time: ' + str(self.zt_0_time) + '\n'
        text += 'Cycle types: ' + str(self.cycle_types) + '\n'
        text += 'Cycle days: ' + str(self.cycle_days) + '\n'
        text += 'Test labels: ' + str(self.test_labels) + '\n'
        text += 'Consider first day: ' + str(self.consider_first_day) + '\n'
        text += 'Set NaNs: ' + str(self.set_nans) + '\n'
        text += 'Start date: ' + str(self.start_date) + '\n'
        text += 'End date: ' + str(self.end_date) + '\n'
        text += 'Sampling interval: ' + str(self.sampling_interval) + '\n'
        text += 'Sampling frequency: ' + str(self.sampling_frequency) + '\n'
        text += '------------------------------------------------------------\n'
        text += 'Normalized: ' + self.normalized + '\n'
        text += 'Resampled: ' + self.resampled + '\n'
        text += 'Filtered: ' + self.filtered + '\n'
        text += '------------------------------------------------------------\n'
    ...
    def resample(self, new_sampling_interval, method = 'sum'):
        ...
        self.resampled = "True (new sampling interval: " + new_sampling_interval + ", method: " + method + ")"
        self.info_text = self.make_info_text()
    ...
    def normalize_data(self, type = 'minmax', per_day = False):
        ...
        self.normalized = "True (type: " + type + ", per_day: " + str(per_day) + ")"
        self.info_text = self.make_info_text()
