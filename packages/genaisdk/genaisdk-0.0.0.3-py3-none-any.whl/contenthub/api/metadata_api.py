...
from contenthub.api_client import ApiClient, RequestSerialized
from contenthub.api_response import ApiResponse
from contenthub.rest import RESTResponseType
...
class MetadataApi:
    ...
    def _get_tags_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/metadata/tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
