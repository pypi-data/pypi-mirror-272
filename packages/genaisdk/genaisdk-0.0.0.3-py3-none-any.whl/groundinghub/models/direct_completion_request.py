...
class DirectCompletionRequest(BaseModel):
    """
    DirectCompletionRequest
    """ # noqa: E501
    prompt: StrictStr = Field(description="The query from the client app")
    model_settings: Optional[ModelSettings] = None
    __properties: ClassVar[List[str]] = ["prompt", "model_settings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DirectCompletionRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DirectCompletionRequest from a dict"""
        if obj is None:
            return None
