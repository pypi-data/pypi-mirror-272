...
#$ -o /unix/cedar/jmb/Work/Regression_Rebuild/myscan00/13TeV/0004/contur.log # Output file path
...
cd /unix/cedar/jmb/Work/Regression_Rebuild/myscan00/13TeV/0004
Herwig read herwig.in -I /unix/cedar/jmb/Work/Regression_Rebuild/RunInfo -L /unix/cedar/jmb/Work/Regression_Rebuild/RunInfo;
Herwig run herwig.run --seed=101  --tag=runpoint_0004  --numevents=30000 ;
