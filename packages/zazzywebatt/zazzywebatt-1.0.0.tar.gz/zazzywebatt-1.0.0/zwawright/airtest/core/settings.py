# -*- coding: utf-8 -*-
from package.airtest.utils.resolution import cocos_min_strategy
import os
import cv2
...
class Settings(object):
    ...
    SNAPSHOT_QUALITY = 99  # 1-100 https://pillow.readthedocs.io/en/5.1.x/handbook/image-file-formats.html#jpeg
