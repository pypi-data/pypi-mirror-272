...
from package.airtest import aircv
from package.airtest.core.device import Device
from package.airtest.core.android.ime import YosemiteIme
from package.airtest.core.android.constant import CAP_METHOD, TOUCH_METHOD, IME_METHOD, ORI_METHOD, \
    SDK_VERISON_ANDROID10
from package.airtest.core.android.adb import ADB

from package.airtest.core.android.rotation import RotationWatcher, XYTransformer
from package.airtest.core.android.recorder import Recorder
from package.airtest.core.android.touch_methods.touch_proxy import TouchProxy
from package.airtest.core.error import AdbError, AdbShellError
from package.airtest.core.android.cap_methods.screen_proxy import ScreenProxy

# Compatible with old code
from package.airtest.core.android.cap_methods.minicap import Minicap  # noqa
from package.airtest.core.android.cap_methods.javacap import Javacap  # noqa
from package.airtest.core.android.touch_methods.minitouch import Minitouch  # noqa
from package.airtest.core.android.touch_methods.maxtouch import Maxtouch  # noqa

from package.airtest.core.settings import Settings as ST
from package.airtest.aircv.screen_recorder import ScreenRecorder, resize_by_max, get_max_size
from package.airtest.utils.logger import get_logger
...
class Android(Device):
    ...
    def touch_proxy(self):
        ...
        Module: :py:mod:`package.airtest.core.android.touch_methods.touch_proxy.TouchProxy`
    ...
    def cap_method(self, name):
        ...
        """
        warnings.warn("No need to manually specify cap_method, package.airtest will automatically specify a suitable screenshot method, when package.airtest>=1.1.2")
    ...
    def screen_proxy(self, cap_method):
        ...
        Args:
            cap_method: "MINICAP" or :py:mod:`package.airtest.core.android.cap_methods.minicap.Minicap` object
        ...
        Examples:
            ...
            >>> from package.airtest.core.android.cap_methods.minicap import Minicap
    ...
    def get_deprecated_var(self, old_name, new_name):
        ...
        When the package.airtest version number>=1.1.2, the call device.minicap/device.javacap is removed, and relevant compatibility is made here, and DeprecationWarning is printed
    ...
    def start_recording(self, max_time=1800, output=None, fps=10, mode="yosemite",
        ...
        Examples:
            ...
            >>> from package.airtest.core.api import connect_device, sleep
