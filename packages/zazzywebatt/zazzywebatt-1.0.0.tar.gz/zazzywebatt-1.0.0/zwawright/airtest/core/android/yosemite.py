...
from package.airtest.utils.snippet import on_method_ready
from package.airtest.utils.apkparser import APK
    ...
    def _install_apk_upgrade(self, apk_path, package):
        ...
        if installed_version is None or apk_version > int(installed_version):
            ...
            try:
                ...
                warnings.warn("Yosemite.apk update failed, please try to reinstall manually(package.airtest/core/android/static/apks/Yosemite.apk).")
