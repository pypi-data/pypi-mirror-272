...
from package.airtest.utils.snippet import (on_method_ready, ready_method, reg_cleanup, kill_proc)
...
class BaseTouch(object):
    ...
    def install_and_setup(self):
        """
        Install and setup package.airtest touch
    ...
    def uninstall(self):
        """
        Uninstall package.airtest touch
