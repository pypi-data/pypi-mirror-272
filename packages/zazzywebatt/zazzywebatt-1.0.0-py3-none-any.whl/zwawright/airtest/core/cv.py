...
from package.airtest.aircv import cv2
from package.airtest.core.helper import G, logwrap
from package.airtest.core.settings import Settings as ST  # noqa
from package.airtest.core.error import TargetNotFoundError, InvalidMatchingMethodError
from package.airtest.utils.transform import TargetPos

from package.airtest.aircv.template_matching import TemplateMatching
from package.airtest.aircv.multiscale_template_matching import MultiScaleTemplateMatching,MultiScaleTemplateMatchingPre
from package.airtest.aircv.keypoint_matching import KAZEMatching, BRISKMatching, AKAZEMatching, ORBMatching
from package.airtest.aircv.keypoint_matching_contrib import SIFTMatching, SURFMatching, BRIEFMatching
...
class Template(object):
    ...
    def filepath(self):
        ...
        for dirname in G.BASEDIR:
            filepath = os.path.join(base_dir, dirname, self.filename)
            if os.path.isfile(filepath):
                self._filepath = filepath
                return self._filepath
