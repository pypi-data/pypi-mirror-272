...
from package.airtest.core.android.constant import STFLIB
from package.airtest.utils.logger import get_logger
from package.airtest.utils.nbsp import NonBlockingStreamReader
from package.airtest.utils.safesocket import SafeSocket
from package.airtest.utils.snippet import reg_cleanup, on_method_ready, ready_method, kill_proc
from package.airtest.utils.threadsafe import threadsafe_generator
    ...
    def _get_stream(self, lazy=True):
        ...
        while not stopping:
            ...
            if self.RECVTIMEOUT is not None:
                ...
                # Set the timeout to 3s(package.airtest>=1.2.7)
