...
from package.airtest.core.error import AdbError, ScreenError
from package.airtest.core.android.cap_methods.base_cap import BaseCap
...
class ScreenProxy(object):
    ...
    def check_frame(cls, cap_method):
        ...
        Args:
            cap_method: :py:mod:`package.airtest.core.android.cap_methods.base_cap.BaseCap`
    ...
    def auto_setup(cls, adb, default_method=None, *args, **kwargs):
        ...
        Args:
            adb: :py:mod:`package.airtest.core.android.adb.ADB`
            default_method: String such as "MINICAP", or :py:mod:`package.airtest.core.android.cap_methods.minicap.Minicap` object
...
def register_screen():
    ...
    from package.airtest.core.android.cap_methods.javacap import Javacap
    from package.airtest.core.android.cap_methods.adbcap import AdbCap
