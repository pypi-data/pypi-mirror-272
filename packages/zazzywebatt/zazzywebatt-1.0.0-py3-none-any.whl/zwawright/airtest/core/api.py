...
from package.airtest.core.cv import Template, loop_find, try_log_screen
from package.airtest.core.error import TargetNotFoundError
from package.airtest.core.settings import Settings as ST
from package.airtest.utils.compat import script_log_dir
from package.airtest.core.helper import (G, delay_after_operation, import_device_cls,
                                 logwrap, set_logdir, using, log)
# Assertions
from package.airtest.core.assertions import (assert_exists, assert_not_exists, assert_equal, assert_not_equal,  # noqa
    ...
    :Example:
        ...
        * ``Android``: it is equivalent to executing ``adb shell input keyevent KEYNAME`` ::
        ...
        .. seealso::
           ...
           Module :py:mod:`package.airtest.core.android.adb.ADB.keyevent`
        ...
        * ``Windows``: Use ``pywinauto.keyboard`` module for key input::
        ...
        .. seealso::
            ...
            Module :py:mod:`package.airtest.core.win.win.Windows.keyevent`
...
def text(text, enter=True, **kwargs):
    ...
    :Example:
        ...
        .. seealso::
            ...
            Module :py:mod:`package.airtest.core.android.ime.YosemiteIme.code`
...
"""
Assertions: see package.airtest/core/assertions.py
"""
