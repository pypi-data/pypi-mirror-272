...
from package.airtest.aircv import imread, get_resolution
from package.airtest.aircv.error import FileNotExistError
from package.airtest.core.settings import Settings as ST
from package.airtest.aircv.utils import compress_image
from package.airtest.utils.compat import decode_path, script_dir_name
...
class LogToHtml(object):
    ...
    def _analyse(self):
        ...
        print(translated_steps)
        print("这是translated_steps222222222222222222222222222222222222")
    ...
    def _translate_step(self, step):
        ...
        print(self)
        print("这是self")
        image_path = self._translate_image_path(step)
    ...
    def _translate_image_path(self, step):
        if "image_path" in step["data"]:
            # 普通文本log内容，仅显示
            image_path = step["data"]["image_path"]
            return image_path
