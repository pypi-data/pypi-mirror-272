...
def test_validate_tillage_values_valid():
    ...
    with open(f"{fixtures_path}/practice/tillage-values/valid.json") as f:
        cycle = json.load(f)
    assert validate_tillage_values(cycle.get('practices')) is True


def test_validate_tillage_values_invalid():
    with open(f"{fixtures_path}/practice/tillage-values/invalid-noTillage.json") as f:
        cycle = json.load(f)
    ...
    with open(f"{fixtures_path}/practice/tillage-values/invalid-fullTillage.json") as f:
        cycle = json.load(f)
    assert validate_tillage_values(cycle.get('practices')) == {
        'level': 'error',
        'dataPath': '.practices[0]',
    ...
    with open(f"{fixtures_path}/practice/tillage-values/invalid-minimumTillage.json") as f:
        cycle = json.load(f)
    assert validate_tillage_values(cycle.get('practices')) == {
        'level': 'error',
        'dataPath': '.practices[0]',
...
def test_validate_pastureGrass_key_termType_valid():
    ...
    with open(f"{fixtures_path}/practice/pastureGrass/key-termType/valid.json") as f:
...
def test_validate_pastureGrass_key_termType_invalid():
    with open(f"{fixtures_path}/practice/pastureGrass/key-termType/invalid.json") as f:
        practice = json.load(f)
