...
_STORAGE_LOCAL_MOUNT_PREFIX = '/storage/'
...
class Artifact:
    ...
    def _get_path(self) -> Optional[str]:
        ...
        elif self.uri.startswith('storage://'):
            return _STORAGE_LOCAL_MOUNT_PREFIX + self.uri[len('storage://'):]
        return None
...
def convert_local_path_to_remote_path(path: str) -> str:
    ...
    elif path.startswith(_STORAGE_LOCAL_MOUNT_PREFIX):
        return 'storage://' + path[len(_STORAGE_LOCAL_MOUNT_PREFIX):]
    return path
