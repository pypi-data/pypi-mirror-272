...
DESCRIPTION = "A Python package to provide easy to use tools to learn and teach digital signal processing with Python."
PACKAGE_NAME = "dsptools"
AUTHOR = "Alejandro Alcaine, PhD"
EMAIL = "lalcaine@usj.es"
GITHUB_URL = "https://github.com/aalcaineo/dsptools"
...
setup(
    ...
    install_requires=["matplotlib>=3.7.0","numpy>=1.23.5","bokeh>=3.3.4"],
