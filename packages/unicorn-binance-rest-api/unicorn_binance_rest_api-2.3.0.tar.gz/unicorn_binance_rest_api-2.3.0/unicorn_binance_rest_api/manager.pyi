...
class BinanceRestApiManager:
    ...
    def aggregate_trade_iter(self, symbol, start_str: Incomplete | None = None, last_id: Incomplete | None = None) -> Generator[Incomplete, None, None]: ...
    def get_klines(self, **params): ...
    def get_historical_klines(self, symbol, interval, start_str, end_str: Incomplete | None = None, limit: int = 500): ...
    def get_historical_klines_generator(self, symbol, interval, start_str, end_str: Incomplete | None = None) -> Generator[Incomplete, None, None]: ...
    ...
    def get_used_weight(self, make_new_request: bool = False): ...
