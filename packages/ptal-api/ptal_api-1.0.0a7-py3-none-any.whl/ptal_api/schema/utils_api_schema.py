...
class Query(sgqlc.types.Type):
    ...
    pagination_concept_without_elastic = sgqlc.types.Field(sgqlc.types.non_null(ConceptPaginationResult), graphql_name='paginationConceptWithoutElastic', args=sgqlc.types.ArgDict((
