...
class TestAnalysisSTEAM(unittest.TestCase):
    ...
    def test_AnalysisSTEAM_FiQuS_CWS(self):
        ...
        output_file = Path(os.path.join(absolute_local_FiQuS_folder,
                                        'CWS_1',
                                        f'Geometry_{g_n}',
                                        f'Mesh_{m_n}',
                                        f'Solution_{s_n}',
    ...
    def test_AnalysisSTEAM_LEDET_magnet_conductor(self):
        ...
        absolute_path_settings_folder = str(Path(os.path.join(os.path.dirname(absolute_path_analysis_file), data_analysis.GeneralParameters.relative_path_settings)).resolve())
        settings = read_settings_file(absolute_path_settings_folder=absolute_path_settings_folder)
        absolute_local_PSPICE_folder = str(Path(os.path.join(os.path.dirname(absolute_path_analysis_file), settings.local_LEDET_folder)).resolve())
        expected_default_file_LEDET = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Input', 'MBRB' + '_1' + '.xlsx')
        expected_mod1_file_LEDET = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Input', 'MBRB' + '_10' + '.xlsx')
        expected_mod1bis_file_LEDET = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Input', 'MBRB' + '_11' + '.xlsx')
        expected_mod2_file_LEDET = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Input', 'MBRB' + '_12' + '.xlsx')
        expected_default_file_LEDET_json = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Input', 'MBRB' + '_1' + '.json')
        expected_mod1_file_LEDET_json = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Input', 'MBRB' + '_10' + '.json')
        expected_mod1bis_file_LEDET_json = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Input', 'MBRB' + '_11' + '.json')
        expected_mod2_file_LEDET_json = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Input', 'MBRB' + '_12' + '.json')
        ...
        expected_output_file_LEDET_mat1 = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Output', 'Mat Files', 'SimulationResults_LEDET_10.mat')
        expected_output_file_LEDET_mat2 = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Output', 'Mat Files', 'SimulationResults_LEDET_1.mat')
        expected_output_file_LEDET_mat3 = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Output', 'Mat Files', 'SimulationResults_LEDET_12.mat')
        expected_output_file_LEDET_txt1 = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Output', 'Txt Files', 'MBRB_VariableHistory_12.txt')
        expected_output_file_LEDET_txt2 = os.path.join(absolute_local_PSPICE_folder, 'MBRB', 'Output', 'Txt Files', 'MBRB_VariableStatus_12.txt')
    ...
    def test_AnalysisSTEAM_CopyFileRelative(self):
        ...
        for attr_name, attr_value in settings.dict().items():
