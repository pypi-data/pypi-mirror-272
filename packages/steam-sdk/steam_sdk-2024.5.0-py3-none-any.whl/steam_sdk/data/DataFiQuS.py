...
class RunFiQuS(BaseModel):
    ...
    geometry: Optional[Union[str, int, float]] = None
    mesh: Optional[Union[str, int, float]] = None
    solution: Optional[Union[str, int, float]] = None
    launch_gui: Optional[bool] = None
