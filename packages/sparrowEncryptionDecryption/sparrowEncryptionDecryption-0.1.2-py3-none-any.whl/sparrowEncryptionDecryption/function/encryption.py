...
class SparrowEncryption:
    ...
    def order_encryption(self, string: str, key: str, effective_duration: int =-1, is_compression: int = 2, mode: int = 0):
        ...
        if mode == 0:
            ...
            if is_compression == 2:
                compression = order_compression_and_decompression2(True, order_compression_and_decompression(True, binary.replace("一", ''), self._keys1_), self._keys2_) + "二三"
        elif mode == 1:
            ...
            if is_compression == 2:
                compression = order_compression_and_decompression2(True, order_compression_and_decompression(True, quaternary.replace("一", ''), self._keys1_), self._keys2_) + "二四"
        return compression
