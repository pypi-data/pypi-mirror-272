        ...
        if "三" in decompression:
            try:
                if "零" in decompression:
                    ...
                    if "一" in decompression:
                        decompression = order_compression_and_decompression(False, decompression.replace("一", '').replace("三", ""), self._keys1_)
                    elif "二" in decompression:
                        decompression = order_compression_and_decompression(False, order_compression_and_decompression2(False, decompression.replace("二", "").replace( "三", ""), self._keys2_) + "", self._keys1_)
                    else:
            ...
            try:
                if "零" in decompression:
                    ...
                    if "一" in decompression:
                        decompression = order_compression_and_decompression(False, decompression.replace("一", '').replace("四", ""), self._keys1_)
                    elif "二" in decompression:
                        decompression = order_compression_and_decompression(False, order_compression_and_decompression2(False, decompression.replace("二", "").replace("四", ""), self._keys2_), self._keys1_)
                    else:
                        raise SparrowBeDecryptionContentError
