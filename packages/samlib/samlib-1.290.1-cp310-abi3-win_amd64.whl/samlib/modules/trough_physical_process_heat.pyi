...
class Data(ssc.DataDict):
    ...
    disp_csu_cost_rel: float = INPUT(label='Heat sink startup cost', units='$/MWe-cycle/start', type='NUMBER', group='tou', required='is_dispatch=1')
    disp_pen_ramping: float = INPUT(label='Dispatch heat production change penalty', units='$/MWt-change', type='NUMBER', group='tou', required='is_dispatch=1')
    ...
    dispatch_factors_ts: Array = INPUT(label='Dispatch payment factor array', type='ARRAY', group='tou')
    dispatch_tod_factors: Array = INPUT(label='TOD factors for periods 1 through 9', type='ARRAY', group='Time of Delivery Factors', required='is_dispatch=1&sim_type=1', meta='We added this array input after SAM 2022.12.21 to replace the functionality of former single value inputs dispatch_factor1 through dispatch_factor9')
    ...
    solar_multiple_actual: Final[float] = OUTPUT(label='Actual solar multiple of system', units='-', type='NUMBER', group='Post-process', required='*')
