...
class Data(ssc.DataDict):
    ...
    use_net_cycle_output_as_capacity: float = INPUT(label='False: default, use net calculation including system parasitics, True: for UDPC only, set as cycle output less cooling power', type='NUMBER', group='User Defined Power Cycle', required='?=0')
    ...
    annual_q_rec_htf: Final[float] = OUTPUT(label='Annual receiver power delivered to HTF', units='MWt-hr', type='NUMBER', group='Tower and Receiver', required='sim_type=1')
    annual_q_rec_inc: Final[float] = OUTPUT(label='Annual receiver incident thermal power after reflective and defocus losses', units='MWt-hr', type='NUMBER', group='Tower and Receiver', required='sim_type=1')
    ...
    annual_q_piping_loss: Final[float] = OUTPUT(label='Annual tower piping losses', units='MWt-hr', type='NUMBER', group='Tower and Receiver', required='sim_type=1')
    annual_q_rec_startup: Final[float] = OUTPUT(label='Annual receiver startup energy', units='MWt-hr', type='NUMBER', group='Tower and Receiver', required='sim_type=1')
    annual_E_tower_pump: Final[float] = OUTPUT(label='Annual tower pumping power', units='MWe-hr', type='NUMBER', group='Tower and Receiver', required='sim_type=1')
    ...
    annual_q_defocus_est: Final[float] = OUTPUT(label='Annual defocus loss estimate', units='MWt-hr', type='NUMBER', group='Tower and Receiver', required='sim_type=1')
