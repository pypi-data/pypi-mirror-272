...
class Data(ssc.DataDict):
    ...
    cf_energy_net_jan: Final[Array] = OUTPUT(label='Energy produced by year in January', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_feb: Final[Array] = OUTPUT(label='Energy produced by year in February', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_mar: Final[Array] = OUTPUT(label='Energy produced by year in March', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_apr: Final[Array] = OUTPUT(label='Energy produced by year in April', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_may: Final[Array] = OUTPUT(label='Energy produced by year in May', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_jun: Final[Array] = OUTPUT(label='Energy produced by year in June', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_jul: Final[Array] = OUTPUT(label='Energy produced by year in July', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_aug: Final[Array] = OUTPUT(label='Energy produced by year in August', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_sep: Final[Array] = OUTPUT(label='Energy produced by year in September', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_oct: Final[Array] = OUTPUT(label='Energy produced by year in October', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_nov: Final[Array] = OUTPUT(label='Energy produced by year in November', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_net_dec: Final[Array] = OUTPUT(label='Energy produced by year in December', units='kWh', type='ARRAY', group='Sale Leaseback', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cost_financing: Final[float] = OUTPUT(label='Financing cost', units='$', type='NUMBER', group='Sale Leaseback', required='*')
