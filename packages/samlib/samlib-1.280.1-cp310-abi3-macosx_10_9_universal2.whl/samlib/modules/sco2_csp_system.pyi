...
DataDict = TypedDict('DataDict', {
    ...
    'od_T_mc_in_sweep': Array,
    'od_max_htf_m_dot': Matrix,
    ...
    'W_dot_net_od': Array,
    'Q_dot_od': Array,
    'W_dot_net_less_cooling_od': Array,
    'eta_thermal_net_less_cooling_od': Array,
    'mc_T_out_od': Array,
    'mc_W_dot_od': Array,
    'mc_m_dot_od': Array,
    'mc_rho_in_od': Array,
    ...
    'mc_cooler_T_in_od': Array,
    'mc_cooler_rho_in_od': Array,
    'mc_cooler_in_isen_deltah_to_P_mc_out_od': Array,
    'mc_cooler_co2_deltaP_od': Array,
    'mc_cooler_W_dot_fan_od': Array,
    'pc_cooler_W_dot_fan_od': Array,
...
class Data(ssc.DataDict):
    ...
    LTR_n_sub_hx: float = INPUT(label='LTR number of model subsections', units='-', type='NUMBER', group='Heat Exchanger Design', required='?=10', meta='Low temperature recuperator')
    LTR_od_model: float = INPUT(label='0: mass flow scale, 1: conductance ratio model', units='-', type='NUMBER', group='Heat Exchanger Design', required='?=1', meta='Low temperature recuperator')
    ...
    HTR_n_sub_hx: float = INPUT(label='HTR number of model subsections', units='-', type='NUMBER', group='Heat Exchanger Design', required='?=10', meta='High temperature recuperator')
    HTR_od_model: float = INPUT(label='0: mass flow scale, 1: conductance ratio model', units='-', type='NUMBER', group='Heat Exchanger Design', required='?=1', meta='High temperature recuperator')
    ...
    mc_comp_type: float = INPUT(label='Main compressor compressor type 1: SNL 2: CompA', units='-', type='NUMBER', required='?=1')
    ...
    PHX_co2_deltaP_des_in: float = INPUT(label='PHX co2 side pressure drop as fraction of inlet pressure', units='-', type='NUMBER')
    ...
    PHX_n_sub_hx: float = INPUT(label='Number of subsections in PHX model', units='-', type='NUMBER', group='PHX Design', required='?=10')
    PHX_od_model: float = INPUT(label='0: mass flow scale, 1: conductance ratio model', units='-', type='NUMBER', group='PHX Design', required='?=1')
    ...
    eta_air_cooler_fan: float = INPUT(label='Air cooler fan isentropic efficiency', type='NUMBER', group='Air Cooler Design', required='?=0.5')
    N_nodes_air_cooler_pass: float = INPUT(label='Number of nodes in single air cooler pass', type='NUMBER', group='Air Cooler Design', required='?=10')
    ...
    cycle_cost: Final[float] = OUTPUT(label='Cycle cost bare erected', units='M$', type='NUMBER', required='*', meta='System Design Solution')
    cycle_spec_cost: Final[float] = OUTPUT(label='Cycle specific cost bare erected', units='$/kWe', type='NUMBER', required='*', meta='System Design Solution')
    cycle_spec_cost_thermal: Final[float] = OUTPUT(label='Cycle specific (thermal) cost bare erected', units='$/kWt', type='NUMBER', required='*', meta='System Design Solution')
    W_dot_net_less_cooling: Final[float] = OUTPUT(label='System power output subtracting cooling parastics', units='MWe,System Design Solution', type='NUMBER', group='*')
    eta_thermal_net_less_cooling_des: Final[float] = OUTPUT(label='Calculated cycle thermal efficiency using W_dot_net_less_cooling', units='-', type='NUMBER', required='*', meta='System Design Solution')
    ...
    mc_cost_equipment: Final[float] = OUTPUT(label='Compressor cost equipment', units='M$', type='NUMBER', required='*', meta='Compressor')
    mc_cost_bare_erected: Final[float] = OUTPUT(label='Compressor cost equipment plus install', units='M$', type='NUMBER', required='*', meta='Compressor')
    ...
    rc_cost_equipment: Final[float] = OUTPUT(label='Recompressor cost equipment', units='M$', type='NUMBER', required='*', meta='Recompressor')
    rc_cost_bare_erected: Final[float] = OUTPUT(label='Recompressor cost equipment plus install', units='M$', type='NUMBER', required='*', meta='Recompressor')
    ...
    pc_cost_equipment: Final[float] = OUTPUT(label='Precompressor cost equipment', units='M$', type='NUMBER', required='*', meta='Precompressor')
    pc_cost_bare_erected: Final[float] = OUTPUT(label='Precompressor cost equipment plus install', units='M$', type='NUMBER', required='*', meta='Precompressor')
    c_tot_cost_equip: Final[float] = OUTPUT(label='Compressor total cost', units='M$', type='NUMBER', required='*', meta='Compressor Totals')
    ...
    t_delta_h_isen_des: Final[float] = OUTPUT(label='Turbine isentropic specific work', units='kJ/kg', type='NUMBER', required='*', meta='Turbine')
    t_rho_in_des: Final[float] = OUTPUT(label='Turbine inlet density', units='kg/m3', type='NUMBER', required='*', meta='Turbine')
    ...
    t_cost_equipment: Final[float] = OUTPUT(label='Tubine cost - equipment', units='M$', type='NUMBER', required='*', meta='Turbine')
    t_cost_bare_erected: Final[float] = OUTPUT(label='Tubine cost - equipment plus install', units='M$', type='NUMBER', required='*', meta='Turbine')
    ...
    recup_total_cost_equipment: Final[float] = OUTPUT(label='Total recuperator cost equipment', units='M$', type='NUMBER', required='*', meta='Recuperators')
    recup_total_cost_bare_erected: Final[float] = OUTPUT(label='Total recuperator cost bare erected', units='M$', type='NUMBER', required='*', meta='Recuperators')
    ...
    LTR_cost_equipment: Final[float] = OUTPUT(label='Low temp recuperator cost equipment', units='M$', type='NUMBER', required='*', meta='Recuperators')
    LTR_cost_bare_erected: Final[float] = OUTPUT(label='Low temp recuperator cost equipment and install', units='M$', type='NUMBER', required='*', meta='Recuperators')
    ...
    HTR_cost_equipment: Final[float] = OUTPUT(label='High temp recuperator cost equipment', units='M$', type='NUMBER', required='*', meta='Recuperators')
    HTR_cost_bare_erected: Final[float] = OUTPUT(label='High temp recuperator cost equipment and install', units='M$', type='NUMBER', required='*', meta='Recuperators')
    ...
    PHX_cost_equipment: Final[float] = OUTPUT(label='PHX cost equipment', units='M$', type='NUMBER', required='*', meta='PHX Design Solution')
    PHX_cost_bare_erected: Final[float] = OUTPUT(label='PHX cost equipment and install', units='M$', type='NUMBER', required='*', meta='PHX Design Solution')
    mc_cooler_T_in: Final[float] = OUTPUT(label='Low pressure cross flow cooler inlet temperature', units='C', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_P_in: Final[float] = OUTPUT(label='Low pressure cross flow cooler inlet pressure', units='MPa', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_rho_in: Final[float] = OUTPUT(label='Low pressure cross flow cooler inlet density', units='kg/m3', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_in_isen_deltah_to_P_mc_out: Final[float] = OUTPUT(label='Low pressure cross flow cooler inlet isen enthalpy rise to mc outlet pressure', units='kJ/kg', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_m_dot_co2: Final[float] = OUTPUT(label='Low pressure cross flow cooler CO2 mass flow rate', units='kg/s', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_UA: Final[float] = OUTPUT(label='Low pressure cross flow cooler conductance', units='MW/K', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_q_dot: Final[float] = OUTPUT(label='Low pressure cooler heat transfer', units='MWt', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_co2_deltaP_des: Final[float] = OUTPUT(label='Low pressure cooler co2 side design pressure drop', units='-', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_W_dot_fan: Final[float] = OUTPUT(label='Low pressure cooler fan power', units='MWe', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_cost_equipment: Final[float] = OUTPUT(label='Low pressure cooler cost equipment', units='M$', type='NUMBER', required='*', meta='Low Pressure Cooler')
    mc_cooler_cost_bare_erected: Final[float] = OUTPUT(label='Low pressure cooler cost equipment and install', units='M$', type='NUMBER', required='*', meta='Low Pressure Cooler')
    pc_cooler_T_in: Final[float] = OUTPUT(label='Intermediate pressure cross flow cooler inlet temperature', units='C', type='NUMBER', required='*', meta='Intermediate Pressure Cooler')
    pc_cooler_P_in: Final[float] = OUTPUT(label='Intermediate pressure cross flow cooler inlet pressure', units='MPa', type='NUMBER', required='*', meta='Intermediate Pressure Cooler')
    pc_cooler_m_dot_co2: Final[float] = OUTPUT(label='Intermediate pressure cross flow cooler CO2 mass flow rate', units='kg/s', type='NUMBER', required='*', meta='Intermediate Pressure Cooler')
    pc_cooler_UA: Final[float] = OUTPUT(label='Intermediate pressure cross flow cooler conductance', units='MW/K', type='NUMBER', required='*', meta='Intermediate Pressure Cooler')
    pc_cooler_q_dot: Final[float] = OUTPUT(label='Intermediate pressure cooler heat transfer', units='MWt', type='NUMBER', required='*', meta='Intermediate Pressure Cooler')
    pc_cooler_W_dot_fan: Final[float] = OUTPUT(label='Intermediate pressure cooler fan power', units='MWe', type='NUMBER', required='*', meta='Intermediate Pressure Cooler')
    pc_cooler_cost_equipment: Final[float] = OUTPUT(label='Intermediate pressure cooler cost equipment', units='M$', type='NUMBER', required='*', meta='Intermediate Pressure Cooler')
    pc_cooler_cost_bare_erected: Final[float] = OUTPUT(label='Intermediate pressure cooler cost equipment and install', units='M$', type='NUMBER', required='*', meta='Intermediate Pressure Cooler')
    piping_inventory_etc_cost: Final[float] = OUTPUT(label='Cost of remaining cycle equipment on BEC basis', units='M$', type='NUMBER', required='*', meta='Intermediate Pressure Cooler')
    cooler_tot_cost_equipment: Final[float] = OUTPUT(label='Total cooler cost equipment', units='M$', type='NUMBER', required='*', meta='Cooler Totals')
    cooler_tot_cost_bare_erected: Final[float] = OUTPUT(label='Total cooler cost equipment and install', units='M$', type='NUMBER', required='*', meta='Cooler Totals')
    ...
    od_rel_tol: float = INPUT(label='Baseline off-design relative convergence tolerance exponent (10^-od_rel_tol)', units='-', type='NUMBER', group='Heat Exchanger Design', required='?=3', meta='High temperature recuperator')
    ...
    od_opt_objective: float = INPUT(label='0: find P_LP_in to achieve target power, optimize efficiency 1: find P_LP_in to achieve T_HTF_cold, optimize efficiency', type='NUMBER', required='?=0')
    od_cases: Matrix = INPUT(label='Columns: 0) T_htf_C, 1) m_dot_htf_ND, 2) T_amb_C, 3) f_N_rc (=1 use design, =0 optimize, <0, frac_des = abs(input)), 4) f_N_mc (=1 use design, =0 optimize, <0, frac_des = abs(input)), 5) f_N_pc (=1 use design, =0 optimize, <0, frac_des = abs(input)), 6) PHX_f_dP (=1 use design, <0 = abs(input), Rows: cases', type='MATRIX')
    od_P_mc_in_sweep: Array = INPUT(label='Columns: 0) T_htf_C, 1) m_dot_htf_ND, 2) T_amb_C, 3) T_mc_in_C, 4) T_pc_in_C, 5) f_N_rc (=1 use design, <0, frac_des = abs(input), 6) f_N_mc (=1 use design, <0, frac_des = abs(input), 7) f_N_pc (=1 use design, =0 optimize, <0, frac_des = abs(input)), 8) PHX_f_dP (=1 use design, <0 = abs(input)', type='ARRAY')
    od_T_mc_in_sweep: Array = INPUT(label='Columns: 0) T_htf_C, 1) m_dot_htf_ND, 2) T_amb_C,3) f_N_rc (=1 use design, <0, frac_des = abs(input),4) f_N_mc (=1 use design, <0, frac_des = abs(input),5) f_N_pc (=1 use design, <0, frac_des = abs(input),6) PHX_f_dP (=1 use design, <0 = abs(input)', type='ARRAY')
    od_max_htf_m_dot: Matrix = INPUT(label='Columns: T_htf_C, T_amb_C, f_N_rc (=1 use design, <0, frac_des = abs(input), f_N_mc (=1 use design, <0, frac_des = abs(input), PHX_f_dP (=1 use design, <0 = abs(input), Rows: cases', type='MATRIX')
    od_set_control: Matrix = INPUT(label='Columns: 0) T_htf_C, 1) m_dot_htf_ND, 2) T_amb_C, 3) P_LP_in_MPa, 4) T_mc_in_C, 5) T_pc_in_C, 6) f_N_rc (=1 use design, <0, frac_des = abs(input), 7) f_N_mc (=1 use design, <0, frac_des = abs(input), 8) f_N_pc (=1 use design, =0 optimize, <0, frac_des = abs(input)), 9) PHX_f_dP (=1 use design, <0 = abs(input), Rows: cases', type='MATRIX')
    ...
    W_dot_net_less_cooling_od: Final[Array] = OUTPUT(label='Off-design system output subtracting cooling parastics', units='MWe', type='ARRAY', meta='Off-Design System Solution')
    eta_thermal_net_less_cooling_od: Final[Array] = OUTPUT(label='Calculated cycle thermal efficiency using W_dot_net_less_cooling', units='-', type='ARRAY', meta='Off-Design System Solution')
    ...
    mc_N_od_perc: Final[Array] = OUTPUT(label='Off-design main compressor speed relative to design', units='%', type='ARRAY')
    ...
    rc_N_od_perc: Final[Array] = OUTPUT(label='Off-design recompressor shaft speed relative to design', units='%', type='ARRAY')
    ...
    t_delta_h_isen_od: Final[Array] = OUTPUT(label='Off-design turbine isentropic specific work', units='kg/s', type='ARRAY')
    t_rho_in_od: Final[Array] = OUTPUT(label='Off-design turbine inlet density', units='kg/m3', type='ARRAY')
    ...
    mc_cooler_T_in_od: Final[Array] = OUTPUT(label='Off-design Low pressure cooler inlet temperature', units='C', type='ARRAY')
    mc_cooler_rho_in_od: Final[Array] = OUTPUT(label='Off-design Low pressure cooler inlet density', units='kg/m3', type='ARRAY')
    mc_cooler_in_isen_deltah_to_P_mc_out_od: Final[Array] = OUTPUT(label='Off-design Low pressure cooler inlet isen enthalpy rise to mc outlet pressure', units='kJ/kg', type='ARRAY')
    mc_cooler_co2_deltaP_od: Final[Array] = OUTPUT(label='Off-design Off-design low pressure cooler co2 side pressure drop', units='-', type='ARRAY')
    mc_cooler_W_dot_fan_od: Final[Array] = OUTPUT(label='Off-design Low pressure cooler fan power', units='MWe', type='ARRAY')
    pc_cooler_W_dot_fan_od: Final[Array] = OUTPUT(label='Off-design Intermediate pressure cooler fan power', units='MWe', type='ARRAY')
