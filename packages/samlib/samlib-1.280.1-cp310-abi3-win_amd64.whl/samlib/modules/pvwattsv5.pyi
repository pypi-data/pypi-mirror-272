...
class Data(ssc.DataDict):
    ...
    tamb: Final[Array] = OUTPUT(label='Ambient temperature (dry bulb temperature)', units='C', type='ARRAY', group='Time Series', required='*')
    ...
    gen: Final[Array] = OUTPUT(label='AC system power (lifetime)', units='kWh', type='ARRAY', group='Time Series', required='*')
