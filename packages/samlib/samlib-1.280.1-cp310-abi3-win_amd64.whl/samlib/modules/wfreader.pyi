...
class Data(ssc.DataDict):
    ...
    glob: Final[Array] = OUTPUT(label='Global Horizontal Irradiance', units='W/m2', type='ARRAY', group='Weather Reader', required='header_only=0', constraints='LENGTH_EQUAL=year')
    ...
    diff: Final[Array] = OUTPUT(label='Diffuse Horizontal Irradiance', units='W/m2', type='ARRAY', group='Weather Reader', required='header_only=0', constraints='LENGTH_EQUAL=year')
    ...
    annual_glob: Final[float] = OUTPUT(label='Average daily global horizontal', units='kWh/m2/day', type='NUMBER', group='Weather Reader', required='header_only=0')
    ...
    annual_diff: Final[float] = OUTPUT(label='Average daily diffuse', units='kWh/m2/day', type='NUMBER', group='Weather Reader', required='header_only=0')
