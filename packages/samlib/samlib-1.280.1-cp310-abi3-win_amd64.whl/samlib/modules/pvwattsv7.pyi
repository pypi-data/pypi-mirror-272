...
class Data(ssc.DataDict):
    ...
    dc_monthly: Final[Array] = OUTPUT(label='DC output', units='kWh', type='ARRAY', group='Monthly', constraints='LENGTH=12')
    ac_monthly: Final[Array] = OUTPUT(label='AC output', units='kWh', type='ARRAY', group='Monthly', constraints='LENGTH=12')
    monthly_energy: Final[Array] = OUTPUT(label='Monthly energy gross', units='kWh', type='ARRAY', group='Monthly', constraints='LENGTH=12')
    ...
    annual_energy: Final[float] = OUTPUT(label='Annual energy', units='kWh', type='NUMBER', group='Annual')
    capacity_factor: Final[float] = OUTPUT(label='Capacity factor', units='%', type='NUMBER', group='Annual')
