...
DataDict = TypedDict('DataDict', {
    ...
    'mp_energy_market_consumed_cost': Array,
    'mp_ancillary_services1_consumed_cost': Array,
    'mp_ancillary_services2_consumed_cost': Array,
    'mp_ancillary_services3_consumed_cost': Array,
    'mp_ancillary_services4_consumed_cost': Array,
...
class Data(ssc.DataDict):
    ...
    revenue_gen: Final[Array] = OUTPUT(label='Electricity used to calculate PPA revenue', units='kW', type='ARRAY', group='System Output')
    ...
    batt_salvage_percentage: float = INPUT(label='Net pre-tax cash battery salvage value', units='%', type='NUMBER', group='Financial Parameters', required='?=0', constraints='MIN=0,MAX=100')
    ...
    mp_energy_market_revenue_single: Matrix = INPUT(label='Energy market revenue input', type='MATRIX', group='Revenue', required='mp_enable_market_percent_gen=1', meta='Lifetime x 1 [Price($/MWh)]')
    mp_ancserv1_revenue_single: Matrix = INPUT(label='Ancillary services 1 revenue input', type='MATRIX', group='Revenue', required='mp_enable_ancserv1_percent_gen=1', meta='Lifetime x 1[Price($/MWh)]')
    mp_ancserv2_revenue_single: Matrix = INPUT(label='Ancillary services 2 revenue input', type='MATRIX', group='Revenue', required='mp_enable_ancserv2_percent_gen=1', meta='Lifetime x 1[Price($/MWh)]')
    mp_ancserv3_revenue_single: Matrix = INPUT(label='Ancillary services 3 revenue input', type='MATRIX', group='Revenue', required='mp_enable_ancserv3_percent_gen=1', meta='Lifetime x 1[Price($/MWh)]')
    mp_ancserv4_revenue_single: Matrix = INPUT(label='Ancillary services 4 revenue input', type='MATRIX', group='Revenue', required='mp_enable_ancserv4_percent_gen=1', meta='Lifetime x 1[Price($/MWh)]')
    mp_enable_market_percent_gen: float = INPUT(label='Enable percent demand cleared capacity option for market revenue', units='0/1', type='NUMBER', group='Revenue', required='*', constraints='INTEGER,MIN=0,MAX=1')
    mp_enable_ancserv1_percent_gen: float = INPUT(label='Enable percent demand cleared capacity option for ancillary service 1', units='0/1', type='NUMBER', group='Revenue', required='*', constraints='INTEGER,MIN=0,MAX=1')
    mp_enable_ancserv2_percent_gen: float = INPUT(label='Enable percent demand cleared capacity option for ancillary service 2', units='0/1', type='NUMBER', group='Revenue', required='*', constraints='INTEGER,MIN=0,MAX=1')
    mp_enable_ancserv3_percent_gen: float = INPUT(label='Enable percent demand cleared capacity option for ancillary service 3', units='0/1', type='NUMBER', group='Revenue', required='*', constraints='INTEGER,MIN=0,MAX=1')
    mp_enable_ancserv4_percent_gen: float = INPUT(label='Enable percent demand cleared capacity option for ancillary service 4', units='0/1', type='NUMBER', group='Revenue', required='*', constraints='INTEGER,MIN=0,MAX=1')
    mp_market_percent_gen: float = INPUT(label='Percent of demand to copy to cleared capacity array', units='%', type='NUMBER', group='Revenue', required='mp_enable_market_percent_gen=1', constraints='MIN=0,MAX=100')
    mp_ancserv1_percent_gen: float = INPUT(label='Percent of demand to copy to cleared capacity array', units='%', type='NUMBER', group='Revenue', required='mp_enable_ancserv1_percent_gen=1', constraints='MIN=0,MAX=100')
    mp_ancserv2_percent_gen: float = INPUT(label='Percent of demand to copy to cleared capacity array', units='%', type='NUMBER', group='Revenue', required='mp_enable_ancserv2_percent_gen=1', constraints='MIN=0,MAX=100')
    mp_ancserv3_percent_gen: float = INPUT(label='Percent of demand to copy to cleared capacity array', units='%', type='NUMBER', group='Revenue', required='mp_enable_ancserv3_percent_gen=1', constraints='MIN=0,MAX=100')
    mp_ancserv4_percent_gen: float = INPUT(label='Percent of demand to copy to cleared capacity array', units='%', type='NUMBER', group='Revenue', required='mp_enable_ancserv4_percent_gen=1', constraints='MIN=0,MAX=100')
    ...
    mp_energy_market_consumed_cost: Final[Array] = OUTPUT(label='Energy market electricity purchases', units='$', type='ARRAY', required='*')
    mp_ancillary_services1_consumed_cost: Final[Array] = OUTPUT(label='Ancillary services 1 electricity purchases', units='$', type='ARRAY', required='*')
    mp_ancillary_services2_consumed_cost: Final[Array] = OUTPUT(label='Ancillary services 2 electricity purchases', units='$', type='ARRAY', required='*')
    mp_ancillary_services3_consumed_cost: Final[Array] = OUTPUT(label='Ancillary services 3 electricity purchases', units='$', type='ARRAY', required='*')
    mp_ancillary_services4_consumed_cost: Final[Array] = OUTPUT(label='Ancillary services 4 electricity purchases', units='$', type='ARRAY', required='*')
