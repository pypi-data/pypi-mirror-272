...
"""communitysolar - Comunity Solar Financial Model_"""
...
DataDict = TypedDict('DataDict', {
    ...
    'subscriber1_share': Array,
    'subscriber1_growth': float,
    'subscriber2_share': Array,
    'subscriber2_growth': float,
    'subscriber3_share': Array,
    'subscriber3_growth': float,
    'subscriber4_share': Array,
    'subscriber4_growth': float,
    'subscriber1_bill_credit_rate': Array,
    'subscriber1_bill_credit_rate_escal': float,
    'subscriber2_bill_credit_rate': Array,
    'subscriber2_bill_credit_rate_escal': float,
    'subscriber3_bill_credit_rate': Array,
    'subscriber3_bill_credit_rate_escal': float,
    'subscriber4_bill_credit_rate': Array,
    ...
    'cf_subscriber1_share_fraction': Array,
    'cf_subscriber2_share_fraction': Array,
    'cf_subscriber3_share_fraction': Array,
    'cf_subscriber4_share_fraction': Array,
    'cf_unsubscribed_share_fraction': Array,
    'cf_subscriber1_bill_credit_rate': Array,
    'cf_subscriber2_bill_credit_rate': Array,
    'cf_subscriber3_bill_credit_rate': Array,
    'cf_subscriber4_bill_credit_rate': Array,
    'cf_subscriber1_generation_payment': Array,
    'cf_subscriber2_generation_payment': Array,
    'cf_subscriber3_generation_payment': Array,
    'cf_subscriber4_generation_payment': Array,
    'cf_subscriber1_share_of_generation': Array,
    'cf_subscriber2_share_of_generation': Array,
    'cf_subscriber3_share_of_generation': Array,
    'cf_subscriber4_share_of_generation': Array,
    'cf_unsubscribed_share_of_generation': Array,
    'cf_subscriber1_revenue_generation': Array,
    'cf_subscriber2_revenue_generation': Array,
    'cf_subscriber3_revenue_generation': Array,
    'cf_subscriber4_revenue_generation': Array,
    'cf_subscriber1_revenue_upfront': Array,
    'cf_subscriber2_revenue_upfront': Array,
    'cf_subscriber3_revenue_upfront': Array,
    'cf_subscriber4_revenue_upfront': Array,
    'cf_subscriber1_revenue_annual_payment': Array,
    'cf_subscriber2_revenue_annual_payment': Array,
    'cf_subscriber3_revenue_annual_payment': Array,
    'cf_subscriber4_revenue_annual_payment': Array,
    'cf_subscriber1_bill_credit_amount': Array,
    'cf_subscriber2_bill_credit_amount': Array,
    'cf_subscriber3_bill_credit_amount': Array,
    'cf_subscriber4_bill_credit_amount': Array,
    'cf_community_solar_subscriber1_revenue': Array,
    'cf_community_solar_subscriber2_revenue': Array,
    'cf_community_solar_subscriber3_revenue': Array,
    'cf_community_solar_subscriber4_revenue': Array,
    'cf_community_solar_unsubscribed_revenue': Array,
    'cf_subscriber1_cost_of_participation': Array,
    'cf_subscriber2_cost_of_participation': Array,
    'cf_subscriber3_cost_of_participation': Array,
    'cf_subscriber4_cost_of_participation': Array,
    'cf_subscriber1_net_benefit': Array,
    'cf_subscriber2_net_benefit': Array,
    'cf_subscriber3_net_benefit': Array,
    'cf_subscriber4_net_benefit': Array,
    'cf_subscriber1_net_benefit_cumulative': Array,
    'cf_subscriber2_net_benefit_cumulative': Array,
    'cf_subscriber3_net_benefit_cumulative': Array,
    'cf_subscriber4_net_benefit_cumulative': Array,
    'cf_community_solar_upfront': Array,
    'cf_community_solar_upfront_per_capacity': Array,
    'cf_community_solar_recurring_fixed': Array,
    'cf_community_solar_recurring_capacity': Array,
    'cf_community_solar_recurring_generation': Array,
...
class Data(ssc.DataDict):
    ...
    om_fuelcell_replacement_cost: Array = INPUT(label='Replacement cost 2', units='$/kW', type='ARRAY', group='System Costs', required='?=0.0')
    ...
    om_batt_nameplate: float = INPUT(label='Battery capacity for System Costs values', units='kW', type='NUMBER', group='System Costs', required='?=0')
    ...
    om_batt_fixed_cost: Array = INPUT(label='Battery fixed System Costs annual amount', units='$/year', type='ARRAY', group='System Costs', required='?=0.0')
    ...
    om_batt_capacity_cost: Array = INPUT(label='Battery capacity-based System Costs amount', units='$/kWcap', type='ARRAY', group='System Costs', required='?=0.0')
    om_fuelcell_nameplate: float = INPUT(label='Fuel cell capacity for System Costs values', units='kW', type='NUMBER', group='System Costs', required='?=0')
    ...
    om_fuelcell_fixed_cost: Array = INPUT(label='Fuel cell fixed System Costs annual amount', units='$/year', type='ARRAY', group='System Costs', required='?=0.0')
    om_fuelcell_variable_cost: Array = INPUT(label='Fuel cell production-based System Costs amount', units='$/MWh', type='ARRAY', group='System Costs', required='?=0.0')
    om_fuelcell_capacity_cost: Array = INPUT(label='Fuel cell capacity-based System Costs amount', units='$/kWcap', type='ARRAY', group='System Costs', required='?=0.0')
    fuelcell_annual_energy_discharged: Array = INPUT(label='Fuel cell annual energy discharged', units='kWh', type='ARRAY', group='System Costs', required='?=0')
    ...
    cf_ptc_total: Final[Array] = OUTPUT(label='Total PTC income', units='$', type='ARRAY', group='Cash Flow Incentives', constraints='LENGTH_EQUAL=cf_length')
    ...
    dscr_limit_debt_fraction: float = INPUT(label='Limit debt fraction', units='0/1', type='NUMBER', group='Financial Parameters', required='?=0', constraints='BOOLEAN')
    dscr_maximum_debt_fraction: float = INPUT(label='Maximum debt fraction', units='%', type='NUMBER', group='Financial Parameters', required='?=100', constraints='MIN=0')
    ...
    revenue_gen: Final[Array] = OUTPUT(label='Electricity to grid', units='kW', type='ARRAY', group='System Output')
    gen: Array = INPUT(label='Net power to or from the grid', units='kW', type='ARRAY', group='System Output', required='*')
    gen_without_battery: Array = INPUT(label='Electricity to or from the renewable system, without the battery', units='kW', type='ARRAY', group='System Output')
    ...
    subscriber1_share: Array = INPUT(label='Subscriber 1 share', units='%', type='ARRAY', group='Community Solar', required='?=0')
    subscriber1_growth: float = INPUT(label='Subscriber 1 growth', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber2_share: Array = INPUT(label='Subscriber 2 share', units='%', type='ARRAY', group='Community Solar', required='?=0')
    subscriber2_growth: float = INPUT(label='Subscriber 2 growth', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber3_share: Array = INPUT(label='Subscriber 3 share', units='%', type='ARRAY', group='Community Solar', required='?=0')
    subscriber3_growth: float = INPUT(label='Subscriber 3 growth', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber4_share: Array = INPUT(label='Subscriber 4 share', units='%', type='ARRAY', group='Community Solar', required='?=0')
    subscriber4_growth: float = INPUT(label='Subscriber 4 growth', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber1_bill_credit_rate: Array = INPUT(label='Subscriber 1 bill credit rate', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    subscriber1_bill_credit_rate_escal: float = INPUT(label='Subscriber 1 bill credit rate escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber2_bill_credit_rate: Array = INPUT(label='Subscriber 2 bill credit rate', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    subscriber2_bill_credit_rate_escal: float = INPUT(label='Subscriber 2 bill credit rate escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber3_bill_credit_rate: Array = INPUT(label='Subscriber 3 bill credit rate', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    subscriber3_bill_credit_rate_escal: float = INPUT(label='Subscriber 3 bill credit rate escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber4_bill_credit_rate: Array = INPUT(label='Subscriber 4 bill credit rate', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    subscriber4_bill_credit_rate_escal: float = INPUT(label='Subscriber 4 bill credit rate escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber1_payment_upfront: float = INPUT(label='Subscriber 1 payment up-front', units='$', type='NUMBER', group='Community Solar', required='?=0')
    subscriber2_payment_upfront: float = INPUT(label='Subscriber 2 payment up-front', units='$', type='NUMBER', group='Community Solar', required='?=0')
    subscriber3_payment_upfront: float = INPUT(label='Subscriber 3 payment up-front', units='$', type='NUMBER', group='Community Solar', required='?=0')
    subscriber4_payment_upfront: float = INPUT(label='Subscriber 4 payment up-front', units='$', type='NUMBER', group='Community Solar', required='?=0')
    subscriber1_payment_generation: Array = INPUT(label='Subscriber 1 payment generation', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    subscriber1_payment_generation_escal: float = INPUT(label='Subscriber 1 payment generation escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber2_payment_generation: Array = INPUT(label='Subscriber 2 payment generation', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    subscriber2_payment_generation_escal: float = INPUT(label='Subscriber 1 payment generation escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber3_payment_generation: Array = INPUT(label='Subscriber 3 payment generation', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    subscriber3_payment_generation_escal: float = INPUT(label='Subscriber 1 payment generation escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber4_payment_generation: Array = INPUT(label='Subscriber 4 payment generation', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    subscriber4_payment_generation_escal: float = INPUT(label='Subscriber 1 payment generation escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    unsubscribed_payment_generation: Array = INPUT(label='Unsubscribed generation rate', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    unsubscribed_payment_generation_escal: float = INPUT(label='Unsubscribed generation escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber1_payment_annual: Array = INPUT(label='Subscriber 1 payment annual', units='$/yr', type='ARRAY', group='Community Solar', required='?=0')
    subscriber1_payment_annual_escal: float = INPUT(label='Subscriber 1 payment annual escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber2_payment_annual: Array = INPUT(label='Subscriber 2 payment annual', units='$/yr', type='ARRAY', group='Community Solar', required='?=0')
    subscriber2_payment_annual_escal: float = INPUT(label='Subscriber 2 payment annual escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber3_payment_annual: Array = INPUT(label='Subscriber 3 payment annual', units='$/yr', type='ARRAY', group='Community Solar', required='?=0')
    subscriber3_payment_annual_escal: float = INPUT(label='Subscriber 3 payment annual escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    subscriber4_payment_annual: Array = INPUT(label='Subscriber 4 payment annual', units='$/yr', type='ARRAY', group='Community Solar', required='?=0')
    subscriber4_payment_annual_escal: float = INPUT(label='Subscriber 4 payment annual escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    cs_cost_upfront: float = INPUT(label='Up-front fixed cost', units='$', type='NUMBER', group='Community Solar', required='?=0')
    cs_cost_upfront_per_capacity: float = INPUT(label='Up-front cost by capacity', units='$/kW', type='NUMBER', group='Community Solar', required='?=0')
    cs_cost_recurring_fixed: Array = INPUT(label='Recurring annual fixed cost', units='$/yr', type='ARRAY', group='Community Solar', required='?=0')
    cs_cost_recurring_fixed_escal: float = INPUT(label='Recurring annual fixed cost escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    cs_cost_recurring_capacity: Array = INPUT(label='Recurring annual cost by capacity', units='$/kW-yr', type='ARRAY', group='Community Solar', required='?=0')
    cs_cost_recurring_capacity_escal: float = INPUT(label='Recurring annual cost by capacity escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    cs_cost_recurring_generation: Array = INPUT(label='Recurring annual cost by generation', units='$/kWh', type='ARRAY', group='Community Solar', required='?=0')
    cs_cost_recurring_generation_escal: float = INPUT(label='Recurring annual cost by generation escalation', units='%/yr', type='NUMBER', group='Community Solar', required='?=0')
    ...
    cf_energy_without_battery: Final[Array] = OUTPUT(label='Electricity produced without the battery or curtailment', units='kWh', type='ARRAY', group='Cash Flow Electricity', constraints='LENGTH_EQUAL=cf_length')
    ...
    issuance_of_equity: Final[float] = OUTPUT(label='Issuance of equity', units='$', type='NUMBER', group='Cash Flow Total and Returns', required='*')
    ...
    project_return_aftertax_irr: Final[float] = OUTPUT(label='IRR Internal rate of return', units='%', type='NUMBER', group='Metrics', required='*')
    project_return_aftertax_npv: Final[float] = OUTPUT(label='NPV Net present value', units='$', type='NUMBER', group='Metrics', required='*')
    ...
    cf_energy_curtailed: Final[Array] = OUTPUT(label='Electricity curtailed', units='kWh', type='ARRAY', group='Cash Flow Electricity', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_curtailment_value: Final[Array] = OUTPUT(label='Curtailment payment revenue', units='$', type='ARRAY', group='Cash Flow Revenues', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_capacity_payment: Final[Array] = OUTPUT(label='Capacity payment revenue', units='$', type='ARRAY', group='Cash Flow Revenues', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_subscriber1_share_fraction: Final[Array] = OUTPUT(label='Subscriber 1 Share of system capacity', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_share_fraction: Final[Array] = OUTPUT(label='Subscriber 2 Share of system capacity', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_share_fraction: Final[Array] = OUTPUT(label='Subscriber 3 Share of system capacity', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_share_fraction: Final[Array] = OUTPUT(label='Subscriber 4 Share of system capacity', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_unsubscribed_share_fraction: Final[Array] = OUTPUT(label='Unsubscribed share of system capacity', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_bill_credit_rate: Final[Array] = OUTPUT(label='Subscriber 1 Bill credit rate', units='$/kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_bill_credit_rate: Final[Array] = OUTPUT(label='Subscriber 2 Bill credit rate', units='$/kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_bill_credit_rate: Final[Array] = OUTPUT(label='Subscriber 3 Bill credit rate', units='$/kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_bill_credit_rate: Final[Array] = OUTPUT(label='Subscriber 4 Bill credit rate', units='$/kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_generation_payment: Final[Array] = OUTPUT(label='Subscriber 1 Generation rate', units='$/kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_generation_payment: Final[Array] = OUTPUT(label='Subscriber 2 Generation rate', units='$/kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_generation_payment: Final[Array] = OUTPUT(label='Subscriber 3 Generation rate', units='$/kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_generation_payment: Final[Array] = OUTPUT(label='Subscriber 4 Generation rate', units='$/kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_share_of_generation: Final[Array] = OUTPUT(label='Subscriber 1 Share of generation', units='kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_share_of_generation: Final[Array] = OUTPUT(label='Subscriber 2 Share of generation', units='kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_share_of_generation: Final[Array] = OUTPUT(label='Subscriber 3 Share of generation', units='kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_share_of_generation: Final[Array] = OUTPUT(label='Subscriber 4 Share of generation', units='kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_unsubscribed_share_of_generation: Final[Array] = OUTPUT(label='Unsubscribed share of generation', units='kWh', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_revenue_generation: Final[Array] = OUTPUT(label='Revenue from Subscriber 1 generation payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_revenue_generation: Final[Array] = OUTPUT(label='Revenue from Subscriber 2 generation payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_revenue_generation: Final[Array] = OUTPUT(label='Revenue from Subscriber 3 generation payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_revenue_generation: Final[Array] = OUTPUT(label='Revenue from Subscriber 4 generation', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_revenue_upfront: Final[Array] = OUTPUT(label='Revenue from Subscriber 1 up-front payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_revenue_upfront: Final[Array] = OUTPUT(label='Revenue from Subscriber 2 up-front payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_revenue_upfront: Final[Array] = OUTPUT(label='Revenue from Subscriber 3 up-front payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_revenue_upfront: Final[Array] = OUTPUT(label='Revenue from Subscriber 4 up-front payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_revenue_annual_payment: Final[Array] = OUTPUT(label='Revenue from Subscriber 1 annual payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_revenue_annual_payment: Final[Array] = OUTPUT(label='Revenue from Subscriber 2 annual payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_revenue_annual_payment: Final[Array] = OUTPUT(label='Revenue from Subscriber 3 annual payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_revenue_annual_payment: Final[Array] = OUTPUT(label='Revenue from Subscriber 4 annual payments', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_bill_credit_amount: Final[Array] = OUTPUT(label='Bill credit for Subscriber 1 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_bill_credit_amount: Final[Array] = OUTPUT(label='Bill credit for Subscriber 2 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_bill_credit_amount: Final[Array] = OUTPUT(label='Bill credit for Subscriber 3 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_bill_credit_amount: Final[Array] = OUTPUT(label='Bill credit for Subscriber 4 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_subscriber1_revenue: Final[Array] = OUTPUT(label='Revenue from Subscriber 1 total', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_subscriber2_revenue: Final[Array] = OUTPUT(label='Revenue from Subscriber 2 total', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_subscriber3_revenue: Final[Array] = OUTPUT(label='Revenue from Subscriber 3 total', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_subscriber4_revenue: Final[Array] = OUTPUT(label='Revenue from Subscriber 4 total', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_unsubscribed_revenue: Final[Array] = OUTPUT(label='Revenue from unsubscribed generation', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_cost_of_participation: Final[Array] = OUTPUT(label='Cost of participation for Subscriber 1 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_cost_of_participation: Final[Array] = OUTPUT(label='Cost of participation for Subscriber 2 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_cost_of_participation: Final[Array] = OUTPUT(label='Cost of participation for Subscriber 3 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_cost_of_participation: Final[Array] = OUTPUT(label='Cost of participation for Subscriber 4 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_net_benefit: Final[Array] = OUTPUT(label='Net benefit for Subscriber 1 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_net_benefit: Final[Array] = OUTPUT(label='Net benefit for Subscriber 2 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_net_benefit: Final[Array] = OUTPUT(label='Net benefit for Subscriber 3 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_net_benefit: Final[Array] = OUTPUT(label='Net benefit for Subscriber 4 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber1_net_benefit_cumulative: Final[Array] = OUTPUT(label='Cumulative net benefit for Subscriber 1 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber2_net_benefit_cumulative: Final[Array] = OUTPUT(label='Cumulative net benefit for Subscriber 2 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber3_net_benefit_cumulative: Final[Array] = OUTPUT(label='Cumulative net benefit for Subscriber 3 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_subscriber4_net_benefit_cumulative: Final[Array] = OUTPUT(label='Cumulative net benefit for Subscriber 4 class', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_upfront: Final[Array] = OUTPUT(label='Community solar total up-front fixed cost', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_upfront_per_capacity: Final[Array] = OUTPUT(label='Community solar total up-front cost by capacity', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_recurring_fixed: Final[Array] = OUTPUT(label='Community solar recurring total fixed cost', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_recurring_capacity: Final[Array] = OUTPUT(label='Community solar total recurring cost by capacity', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    cf_community_solar_recurring_generation: Final[Array] = OUTPUT(label='Community solar total recurring cost by generation', units='$', type='ARRAY', required='*', constraints='LENGTH_EQUAL=cf_length')
    community_solar_upfront_cost: Final[float] = OUTPUT(label='Community solar total up-front cost', units='$', type='NUMBER', group='Metrics', required='*')
    community_solar_upfront_revenue: Final[float] = OUTPUT(label='Revenue from total up-front payments', units='$', type='NUMBER', group='Metrics', required='*')
    subscriber1_npv: Final[float] = OUTPUT(label='Subscriber 1 NPV Net present value', units='$', type='NUMBER', group='Metrics', required='*')
    subscriber2_npv: Final[float] = OUTPUT(label='Subscriber 2 NPV Net present value', units='$', type='NUMBER', group='Metrics', required='*')
    subscriber3_npv: Final[float] = OUTPUT(label='Subscriber 3 NPV Net present value', units='$', type='NUMBER', group='Metrics', required='*')
    subscriber4_npv: Final[float] = OUTPUT(label='Subscriber 4 NPV Net present value', units='$', type='NUMBER', group='Metrics', required='*')
    ...
    gen_purchases: Array = INOUT(label='Electricity from grid', units='kW', type='ARRAY', group='System Output')
    ...
    def __init__(self, *args: Mapping[str, Any],
                 ...
                 monthly_batt_to_grid: Array = ...,
                 monthly_grid_to_load: Array = ...,
                 monthly_system_to_grid: Array = ...) -> None: ...
