...
class Data(ssc.DataDict):
    ...
    cf_energy_sales_jan: Final[Array] = OUTPUT(label='Energy produced by year in January', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_feb: Final[Array] = OUTPUT(label='Energy produced by year in February', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_mar: Final[Array] = OUTPUT(label='Energy produced by year in March', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_apr: Final[Array] = OUTPUT(label='Energy produced by year in April', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_may: Final[Array] = OUTPUT(label='Energy produced by year in May', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_jun: Final[Array] = OUTPUT(label='Energy produced by year in June', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_jul: Final[Array] = OUTPUT(label='Energy produced by year in July', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_aug: Final[Array] = OUTPUT(label='Energy produced by year in August', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_sep: Final[Array] = OUTPUT(label='Energy produced by year in September', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_oct: Final[Array] = OUTPUT(label='Energy produced by year in October', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_nov: Final[Array] = OUTPUT(label='Energy produced by year in November', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dec: Final[Array] = OUTPUT(label='Energy produced by year in December', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='*', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_monthly_firstyear_TOD1: Final[Array] = OUTPUT(label='Energy produced in Year 1 by month for TOD period 1', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='ppa_multiplier_model=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD2: Final[Array] = OUTPUT(label='Energy produced in Year 1 by month for TOD period 2', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='ppa_multiplier_model=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD3: Final[Array] = OUTPUT(label='Energy produced in Year 1 by month for TOD period 3', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='ppa_multiplier_model=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD4: Final[Array] = OUTPUT(label='Energy produced in Year 1 by month for TOD period 4', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='ppa_multiplier_model=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD5: Final[Array] = OUTPUT(label='Energy produced in Year 1 by month for TOD period 5', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='ppa_multiplier_model=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD6: Final[Array] = OUTPUT(label='Energy produced in Year 1 by month for TOD period 6', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='ppa_multiplier_model=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD7: Final[Array] = OUTPUT(label='Energy produced in Year 1 by month for TOD period 7', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='ppa_multiplier_model=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD8: Final[Array] = OUTPUT(label='Energy produced in Year 1 by month for TOD period 8', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='ppa_multiplier_model=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD9: Final[Array] = OUTPUT(label='Energy produced in Year 1 by month for TOD period 9', units='kWh', type='ARRAY', group='Cash Flow Revenue', required='ppa_multiplier_model=0')
