...
class Data(ssc.DataDict):
    ...
    cf_energy_sales_jan: Final[Array] = OUTPUT(label='Energy produced by the system in January', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_feb: Final[Array] = OUTPUT(label='Energy produced by the system in February', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_mar: Final[Array] = OUTPUT(label='Energy produced by the system in March', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_apr: Final[Array] = OUTPUT(label='Energy produced by the system in April', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_may: Final[Array] = OUTPUT(label='Energy produced by the system in May', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_jun: Final[Array] = OUTPUT(label='Energy produced by the system in June', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_jul: Final[Array] = OUTPUT(label='Energy produced by the system in July', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_aug: Final[Array] = OUTPUT(label='Energy produced by the system in August', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_sep: Final[Array] = OUTPUT(label='Energy produced by the system in September', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_oct: Final[Array] = OUTPUT(label='Energy produced by the system in October', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_nov: Final[Array] = OUTPUT(label='Energy produced by the system in November', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dec: Final[Array] = OUTPUT(label='Energy produced by the system in December', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dispatch1: Final[Array] = OUTPUT(label='Energy produced by the system in dispatch period 1', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dispatch2: Final[Array] = OUTPUT(label='Energy produced by the system in dispatch period 2', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dispatch3: Final[Array] = OUTPUT(label='Energy produced by the system in dispatch period 3', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dispatch4: Final[Array] = OUTPUT(label='Energy produced by the system in dispatch period 4', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dispatch5: Final[Array] = OUTPUT(label='Energy produced by the system in dispatch period 5', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dispatch6: Final[Array] = OUTPUT(label='Energy produced by the system in dispatch period 6', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dispatch7: Final[Array] = OUTPUT(label='Energy produced by the system in dispatch period 7', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dispatch8: Final[Array] = OUTPUT(label='Energy produced by the system in dispatch period 8', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_dispatch9: Final[Array] = OUTPUT(label='Energy produced by the system in dispatch period 9', type='ARRAY', group='ippppa', required='market=0', constraints='LENGTH_EQUAL=cf_length')
    ...
    cf_energy_sales_monthly_firstyear_TOD1: Final[Array] = OUTPUT(label='First year energy from the system by month for TOD1', type='ARRAY', group='ippppa', required='market=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD2: Final[Array] = OUTPUT(label='First year energy from the system by month for TOD2', type='ARRAY', group='ippppa', required='market=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD3: Final[Array] = OUTPUT(label='First year energy from the system by month for TOD3', type='ARRAY', group='ippppa', required='market=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD4: Final[Array] = OUTPUT(label='First year energy from the system by month for TOD4', type='ARRAY', group='ippppa', required='market=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD5: Final[Array] = OUTPUT(label='First year energy from the system by month for TOD5', type='ARRAY', group='ippppa', required='market=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD6: Final[Array] = OUTPUT(label='First year energy from the system by month for TOD6', type='ARRAY', group='ippppa', required='market=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD7: Final[Array] = OUTPUT(label='First year energy from the system by month for TOD7', type='ARRAY', group='ippppa', required='market=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD8: Final[Array] = OUTPUT(label='First year energy from the system by month for TOD8', type='ARRAY', group='ippppa', required='market=0')
    ...
    cf_energy_sales_monthly_firstyear_TOD9: Final[Array] = OUTPUT(label='First year energy from the system by month for TOD9', type='ARRAY', group='ippppa', required='market=0')
