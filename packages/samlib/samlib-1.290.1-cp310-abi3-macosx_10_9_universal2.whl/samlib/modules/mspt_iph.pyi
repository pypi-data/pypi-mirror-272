...
class Data(ssc.DataDict):
    ...
    gen: Final[Array] = OUTPUT(label='Total thermal power to heat sink with available derate', units='kWt', type='ARRAY', required='sim_type=1')
    annual_energy: Final[float] = OUTPUT(label='Annual Thermal Energy to Heat Sink w/ avail derate', units='kWt-hr', type='NUMBER', group='Post-process', required='sim_type=1')
