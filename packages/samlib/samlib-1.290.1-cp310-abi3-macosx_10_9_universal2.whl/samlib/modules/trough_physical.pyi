...
class Data(ssc.DataDict):
    ...
    is_wlim_series: Final[float] = OUTPUT(label='Use time-series net electricity generation limits', type='NUMBER', group='System Control', required='?=0')
    disp_wlim_max: Final[float] = OUTPUT(label='Max. net power to the grid (incl. availability)', units='MWe', type='NUMBER', group='System Control', required='*')
    wlim_series: Final[Array] = OUTPUT(label='Time series net electicity generation limits', units='kWe', type='ARRAY', group='System Control', required='is_dispatch=1')
    ...
    P_out_net: Final[Array] = OUTPUT(label='Total electric power to grid', units='MWe', type='ARRAY', group='system', required='sim_type=1')
    gen: Final[Array] = OUTPUT(label='Total electric power to grid w/ avail. derate', units='kWe', type='ARRAY', group='system', required='sim_type=1')
