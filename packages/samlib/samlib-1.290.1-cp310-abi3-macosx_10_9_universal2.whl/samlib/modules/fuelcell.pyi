...
DataDict = TypedDict('DataDict', {
    ...
    'dispatch_manual_fuelcell_sched': Matrix,
    'dispatch_manual_fuelcell_sched_weekend': Matrix,
...
class Data(ssc.DataDict):
    ...
    dispatch_manual_fuelcell_sched: Matrix = INPUT(label='Dispatch schedule for weekday', type='MATRIX', group='Fuel Cell')
    dispatch_manual_fuelcell_sched_weekend: Matrix = INPUT(label='Dispatch schedule for weekend', type='MATRIX', group='Fuel Cell')
    ...
    fuelcell_fuel_consumption_mcf: Final[Array] = OUTPUT(label='Fuel cell fuel consumption', units='MCf', type='ARRAY', group='Fuel Cell')
    ...
    fuelcell_annual_energy_discharged: Final[Array] = OUTPUT(label='Fuel cell annual energy discharged', units='kWh', type='ARRAY', group='Fuel Cell')
    fuelcell_monthly_energy_discharged: Final[Array] = OUTPUT(label='Fuel cell monthly energy discharged Year 1', units='kWh', type='ARRAY', group='Fuel Cell')
    annual_energy_discharged: Final[float] = OUTPUT(label='Annual energy discharged', units='kWh', type='NUMBER', group='Fuel Cell', required='*')
    ...
    annual_energy_distribution_time_fc: Final[Matrix] = OUTPUT(label='Annual energy production (PV + battery + fuel cell) as function of Time', type='MATRIX', group='Heatmaps')
