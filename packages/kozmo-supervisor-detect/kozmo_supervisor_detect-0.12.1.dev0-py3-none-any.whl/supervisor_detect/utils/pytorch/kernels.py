...
class GaussianRBF(nn.Module):
    def __init__(
        ...
        init_sigma_fn
            ...
            The function's signature should match :py:func:`~supervisor_detect.utils.pytorch.kernels.sigma_median`,
            meaning that it should take in the tensors `x`, `y` and `dist` and return `sigma`. If `None`, it is set to
            :func:`~supervisor_detect.utils.pytorch.kernels.sigma_median`.
        trainable
