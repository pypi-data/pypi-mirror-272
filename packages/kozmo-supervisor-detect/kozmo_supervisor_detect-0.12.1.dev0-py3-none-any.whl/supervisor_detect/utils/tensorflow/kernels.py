...
class GaussianRBF(tf.keras.Model):
    def __init__(
        ...
        init_sigma_fn
            ...
            The function's signature should match :py:func:`~supervisor_detect.utils.tensorflow.kernels.sigma_median`,
    ...
    def get_config(self) -> dict:
        """
        Returns a serializable config dict (excluding the input_sigma_fn, which is serialized in supervisor_detect.saving).
        """
