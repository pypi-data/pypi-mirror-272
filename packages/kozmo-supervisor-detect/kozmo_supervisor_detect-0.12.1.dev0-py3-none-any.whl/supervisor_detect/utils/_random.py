...
https://github.com/kozmoai/supervisor-detect/issues/250.
"""
...
def get_seed() -> int:
    ...
    Example
    -------
    >>> from supervisor_detect.utils._random import set_seed, get_seed
    >>> set_seed(42)
    >>> get_seed()
    42
    """
    if _SUPERVISOR_SEED is not None:
        return _SUPERVISOR_SEED
    else:
