# This submodule provides a link for the legacy supervisor_detect.utils.saving location of load_detector and save_detector.
# TODO: Remove in future
from supervisor_detect.saving import load_detector as _load_detector, save_detector as _save_detector
from supervisor_detect.base import ConfigurableDetector, Detector
...
def save_detector(
    ...
    """
    warnings.warn("This function has been moved to supervisor_detect.saving.save_detector()."
...
def load_detector(filepath: Union[str, os.PathLike], **kwargs) -> Union[Detector, ConfigurableDetector]:
    ...
    """
    warnings.warn("This function has been moved to supervisor_detect.saving.load_detector()."
                  "This legacy link will be removed in a future version", DeprecationWarning)
