"""This module defines the Supervisor Detect exception hierarchy and common exceptions used across the library."""
...
class SupervisorDetectException(Exception, ABC):
    def __init__(self, message: str) -> None:
        """Abstract base class of all supervisor detect errors.
...
class NotFittedError(SupervisorDetectException):
...
class ThresholdNotInferredError(SupervisorDetectException):
    def __init__(self, object_name: str) -> None:
