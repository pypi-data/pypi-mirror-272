...
from supervisor_detect.base import outlier_prediction_dict
from supervisor_detect.exceptions import _catch_error as catch_error
from supervisor_detect.od.base import TransformProtocol, TransformProtocolType
from supervisor_detect.base import BaseDetector, FitMixin, ThresholdMixin
from supervisor_detect.od.pytorch import LOFTorch, Ensembler
from supervisor_detect.od.base import get_aggregator, get_normalizer, NormalizerLiterals, AggregatorLiterals
from supervisor_detect.utils.frameworks import BackendValidator
from supervisor_detect.version import __version__
from supervisor_detect.utils._types import TorchDeviceType
...
class LOF(BaseDetector, FitMixin, ThresholdMixin):
    def __init__(
        ...
        normalizer
            ...
            For a list of available normalizers, see :mod:`supervisor_detect.od.pytorch.ensemble`.
        aggregator
            Aggregator to use for outlier detection. Can be set to ``None`` if `k` is a single
            value. For a list of available aggregators, see :mod:`supervisor_detect.od.pytorch.ensemble`.
        backend
