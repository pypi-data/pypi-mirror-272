...
from supervisor_detect.cd.base import BaseMMDDrift
from supervisor_detect.utils.pytorch import get_device
from supervisor_detect.utils.pytorch.distance import mmd2_from_kernel_matrix
...
class MMDDriftTorch(BaseMMDDrift):
    ...
    def score(self, x: Union[np.ndarray, list]) -> Tuple[float, float, float]:
        ...
        # TODO: (See https://github.com/kozmoai/supervisor-detect/issues/540)
        n = x.shape[0]
