...
from supervisor_detect.cd.base import BaseContextMMDDrift
from supervisor_detect.utils.pytorch import get_device
from supervisor_detect.utils.pytorch.kernels import GaussianRBF
from supervisor_detect.utils.warnings import deprecated_alias
from supervisor_detect.utils.frameworks import Framework
from supervisor_detect.cd._domain_clf import _SVCDomainClf
...
def _sigma_median_diag(x: torch.Tensor, y: torch.Tensor, dist: torch.Tensor) -> torch.Tensor:
    """
    Private version of the bandwidth estimation function :py:func:`~supervisor_detect.utils.pytorch.kernels.sigma_median`,
