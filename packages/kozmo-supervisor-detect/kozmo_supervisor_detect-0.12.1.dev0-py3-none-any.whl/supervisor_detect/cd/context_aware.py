...
from supervisor_detect.utils.frameworks import has_pytorch, has_tensorflow, BackendValidator, Framework
...
if has_pytorch:
    from supervisor_detect.cd.pytorch.context_aware import ContextMMDDriftTorch

if has_tensorflow:
    from supervisor_detect.cd.tensorflow.context_aware import ContextMMDDriftTF
    ...
    def __init__(
        ...
        if x_kernel is None or c_kernel is None:
            if backend == Framework.TENSORFLOW:
                ...
                from supervisor_detect.utils.pytorch.kernels import GaussianRBF  # type: ignore[assignment]
            if x_kernel is None:
