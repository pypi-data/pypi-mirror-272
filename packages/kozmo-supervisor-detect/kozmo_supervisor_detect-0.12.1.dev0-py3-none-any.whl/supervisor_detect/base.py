...
class DriftConfigMixin:
    ...
    def from_config(cls, config: dict):
        ...
        ----------
        config
            A config dictionary matching the schema's in :class:`~supervisor_detect.saving.schemas`.
        """
...
class Detector(Protocol):
    ...
    Used for typing legacy save and load functionality in `supervisor_detect.saving._tensorflow.saving.py`.
...
class ConfigurableDetector(Detector, Protocol):
    ...
    Used for typing save and load functionality in `supervisor_detect.saving.saving`.
    """
