...
class TransformProtocol(Protocol):
    ...
    The :py:obj:`~supervisor_detect.od.pytorch.ensemble.BaseTransformTorch` object provides abstract methods for
...
class FittedTransformProtocol(TransformProtocol, Protocol):
    ...
    This protocol models the joint interface of the :py:obj:`~supervisor_detect.od.pytorch.ensemble.BaseTransformTorch`
    class and the :py:obj:`~supervisor_detect.od.pytorch.ensemble.FitMixinTorch` class. These objects are transforms that
    require to be fit."""
    def fit(self, x_ref):
        pass
...
PValNormalizer, ShiftAndScaleNormalizer, TopKAggregator, AverageAggregator, \
    MaxAggregator, MinAggregator = import_optional(
        'supervisor_detect.od.pytorch.ensemble',
