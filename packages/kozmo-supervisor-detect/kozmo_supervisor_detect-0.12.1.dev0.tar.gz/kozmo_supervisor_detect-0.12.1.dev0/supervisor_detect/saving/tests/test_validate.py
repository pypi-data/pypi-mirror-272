import numpy as np
import pytest
from supervisor_detect.utils.pydantic_v1 import ValidationError

from supervisor_detect.saving import validate_config
from supervisor_detect.saving.schemas import KernelConfig
from supervisor_detect.saving.saving import X_REF_FILENAME
