...
from supervisor_detect.cd.pytorch import UAE as UAE_pt
from supervisor_detect.cd.pytorch import preprocess_drift as preprocess_drift_pt
from supervisor_detect.cd.tensorflow import UAE as UAE_tf
from supervisor_detect.cd.tensorflow import preprocess_drift as preprocess_drift_tf
from supervisor_detect.utils.pytorch.kernels import GaussianRBF as GaussianRBF_pt
from supervisor_detect.utils.pytorch.kernels import DeepKernel as DeepKernel_pt
from supervisor_detect.utils.tensorflow.kernels import GaussianRBF as GaussianRBF_tf
...
from supervisor_detect.cd.pytorch import HiddenOutput as HiddenOutput_pt
from supervisor_detect.cd.tensorflow import HiddenOutput as HiddenOutput_tf
from supervisor_detect.utils.frameworks import has_keops
if has_keops:  # pykeops only installed in Linux CI
    from supervisor_detect.utils.keops.kernels import GaussianRBF as GaussianRBF_ke
...
def encoder_model(backend, current_cases):
    """
    An untrained encoder of given input dimension and backend (this is a "custom" model, NOT an Supervisor Detect UAE).
    """
