...
from supervisor_detect.saving.loading import _replace, validate_config, STATE_PATH
from supervisor_detect.saving.registry import registry
from supervisor_detect.utils._types import supported_models_all, supported_models_tf, supported_models_torch, \
    supported_models_sklearn
from supervisor_detect.base import Detector, ConfigurableDetector, StatefulDetectorOnline
from supervisor_detect.saving._tensorflow import save_detector_legacy, save_model_config_tf, save_optimizer_config_tf
from supervisor_detect.saving._pytorch import save_model_config_pt, save_device_pt
from supervisor_detect.saving._sklearn import save_model_config_sk
...
def _serialize_object(obj: Callable, base_path: Path,
    ...
    if registry_str is not None:  # supervisor-detect registered object
        src = '@' + registry_str
