...
from supervisor_detect.cd.pytorch import UAE, HiddenOutput
from supervisor_detect.cd.pytorch.preprocess import _Encoder
from supervisor_detect.models.pytorch import TransformerEmbedding
from supervisor_detect.utils.pytorch.kernels import DeepKernel
...
def load_model(filepath: Union[str, os.PathLike],
    ...
    layer
        ...
        :py:class:`~supervisor_detect.cd.pytorch.HiddenOutput` model is returned.
...
def load_embedding(src: str, embedding_type, layers) -> TransformerEmbedding:
    ...
    See the `:py:class:~supervisor_detect.models.pytorch.TransformerEmbedding` documentation for a
