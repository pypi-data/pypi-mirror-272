...
from supervisor_detect.ad import AdversarialAE, ModelDistillation
from supervisor_detect.ad.adversarialae import DenseHidden
from supervisor_detect.cd import (ChiSquareDrift, ClassifierDrift, KSDrift, MMDDrift, TabularDrift)
from supervisor_detect.cd.tensorflow import UAE, HiddenOutput
from supervisor_detect.cd.tensorflow.preprocess import _Encoder
from supervisor_detect.models.tensorflow import PixelCNN, TransformerEmbedding
from supervisor_detect.models.tensorflow.autoencoder import (AE, AEGMM, VAE, VAEGMM,
                                                        DecoderLSTM,
                                                        EncoderLSTM, Seq2Seq)
from supervisor_detect.od import (LLR, IForest, Mahalanobis, OutlierAE,
                             OutlierAEGMM, OutlierProphet, OutlierSeq2Seq,
                             OutlierVAE, OutlierVAEGMM, SpectralResidual)
from supervisor_detect.od.llr import build_model
from supervisor_detect.utils.tensorflow.kernels import DeepKernel
...
from supervisor_detect.version import __version__
from supervisor_detect.base import Detector
from supervisor_detect.saving._typing import VALID_DETECTORS
...
def load_model(filepath: Union[str, os.PathLike],
    ...
    layer
        ...
        :py:class:`~supervisor_detect.cd.tensorflow.HiddenOutput` model is returned.
...
def load_embedding(src: str, embedding_type, layers) -> TransformerEmbedding:
    ...
    See the `:py:class:~supervisor_detect.models.tensorflow.TransformerEmbedding` documentation for a
...
def load_detector_legacy(filepath: Union[str, os.PathLike], suffix: str, **kwargs) -> Detector:
    ...
    # Update the drift detector preprocess kwargs if state_dict is from an old supervisor-detect version (<v0.10).
    # See https://github.com/kozmoai/supervisor-detect/pull/732
