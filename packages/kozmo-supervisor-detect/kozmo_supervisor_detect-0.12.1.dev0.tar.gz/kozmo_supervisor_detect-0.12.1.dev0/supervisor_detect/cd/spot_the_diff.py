...
if has_pytorch:
    from supervisor_detect.cd.pytorch.spot_the_diff import SpotTheDiffDriftTorch
    from supervisor_detect.utils.pytorch.data import TorchDataset
    from torch.utils.data import DataLoader

if has_tensorflow:
    from supervisor_detect.cd.tensorflow.spot_the_diff import SpotTheDiffDriftTF
