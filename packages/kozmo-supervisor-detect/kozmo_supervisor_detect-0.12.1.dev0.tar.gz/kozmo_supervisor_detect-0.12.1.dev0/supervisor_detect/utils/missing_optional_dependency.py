...
supervisor-detect that is not usable due to missing optional dependencies this code is used to allow the import but replace
...
err_msg_template = Template((
    ...
    + "the correct optional dependencies, run `pip install supervisor-detect[$missing_dependency]` "
    + "from the command line. For more information, check the Installation documentation "
    + "at https://docs.kozmoai.io/projects/supervisor-detect/en/stable/overview/getting_started.html."
))
