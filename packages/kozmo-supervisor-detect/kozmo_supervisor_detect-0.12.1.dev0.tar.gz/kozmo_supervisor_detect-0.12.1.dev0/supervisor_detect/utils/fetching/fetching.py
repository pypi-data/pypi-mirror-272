...
from supervisor_detect.models.tensorflow import PixelCNN
...
if TYPE_CHECKING:
    ...
    from supervisor_detect.ad.adversarialae import AdversarialAE  # noqa
    from supervisor_detect.ad.model_distillation import ModelDistillation  # noqa
    from supervisor_detect.base import BaseDetector  # noqa
    from supervisor_detect.od.llr import LLR  # noqa
    from supervisor_detect.od.isolationforest import IForest  # noqa
    from supervisor_detect.od.mahalanobis import Mahalanobis  # noqa
    from supervisor_detect.od.aegmm import OutlierAEGMM  # noqa
    from supervisor_detect.od.ae import OutlierAE  # noqa
    from supervisor_detect.od.prophet import OutlierProphet  # noqa
    from supervisor_detect.od.seq2seq import OutlierSeq2Seq  # noqa
    from supervisor_detect.od.vae import OutlierVAE  # noqa
    from supervisor_detect.od.vaegmm import OutlierVAEGMM  # noqa
    from supervisor_detect.od.sr import SpectralResidual  # noqa

from supervisor_detect.utils.url import _join_url
...
def fetch_tf_model(dataset: str, model: str) -> tf.keras.Model:
    ...
    """
    url = 'https://storage.googleapis.com/kozmo-models/supervisor-detect/classifier/'
...
def fetch_detector(filepath: Union[str, os.PathLike],
    ...
    url = 'https://storage.googleapis.com/kozmo-models/supervisor-detect/'
