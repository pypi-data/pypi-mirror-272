...
class InputOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, *, do_preprocess=None, pixel_format=None, channel_format=None, resize_dims=None, keep_aspect_ratio=None, keep_ratio_mode=None, pad_value=None, pad_type=None, scale=None, mean=None, customization_format=None, aligned=None, white_level=None, black_level=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if aligned is not None: attributes["aligned"] = (aligned if (
        ...
        not _ods_ir.AttrBuilder.contains('BoolAttr')) else
          _ods_ir.AttrBuilder.get('BoolAttr')(aligned, context=_ods_context))
    if white_level is not None: attributes["white_level"] = (white_level if (
        issubclass(type(white_level), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('F64Attr')) else
          _ods_ir.AttrBuilder.get('F64Attr')(white_level, context=_ods_context))
    if black_level is not None: attributes["black_level"] = (black_level if (
        issubclass(type(black_level), _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('F64Attr')) else
          _ods_ir.AttrBuilder.get('F64Attr')(black_level, context=_ods_context))
    results.append(output)
  ...
  @builtins.property
  def white_level(self):
    if "white_level" not in self.operation.attributes:
      return None
    return self.operation.attributes["white_level"]
  ...
  def white_level(self, value):
    if value is not None:
      self.operation.attributes["white_level"] = value
    elif "white_level" in self.operation.attributes:
      del self.operation.attributes["white_level"]
  ...
  @builtins.property
  def black_level(self):
    if "black_level" not in self.operation.attributes:
      return None
    return self.operation.attributes["black_level"]
  ...
  def black_level(self, value):
    if value is not None:
      self.operation.attributes["black_level"] = value
    elif "black_level" in self.operation.attributes:
      del self.operation.attributes["black_level"]
...
class RequantFpOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, scale, offset, quant_mode, *, round_mode=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class RequantIntOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, multiplier, rshift, quant_mode, *, round_mode=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class WeightOp(_ods_ir.OpView):
  ...
  def __init__(self, output, *, scale=None, store_mode=None, allow_split=None, do_compress=None, bias0=None, bias1=None, is_signed=None, zero_guard=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
