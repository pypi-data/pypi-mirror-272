...
class Report:
    ...
    def __init__(self, classifier: MIMLClassifier, dataset_test: MIMLDataset, metrics: list[str] = None,
        ...
        all_metrics = ["precision-score-macro", "precision-score-micro", "average-precision-score-macro",
                       ...
                       "f1-score-micro", "fbeta-score-macro", "fbeta-score-micro", "roc-auc-score-macro",
                       "roc-auc-score-micro","subset-accuracy-score", "hamming-loss", "jaccard-score-macro",
                       "jaccard-score-micro", "log-loss"]
        if per_label:
