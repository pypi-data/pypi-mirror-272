...
class EnvironmentNotFound(KozmoMLError):
...
class WorkerError(KozmoMLError):
    """
    ...
    returned. This is to avoid issues with custom exceptions, like:
        ...
        https://github.com/kozmoai/kozmoml/issues/881
    """
    ...
    def __init__(self, exc: BaseException):
        ...
        if isinstance(exc, KozmoMLError):
