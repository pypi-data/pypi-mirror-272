...
from kozmoml.batching.requests import BatchedRequests
from kozmoml.types import InferenceRequest, InferenceResponse, Parameters
from kozmoml.codecs import NumpyCodec
from kozmoml.logging import get_logger


from kozmoml.utils import generate_uuid
from kozmoml.batching.requests import _merge_parameters
...
# Monkey patching is required for error responses coming from KozmoML.
# KozmoML will contain `detail` field instead of `error` one like Triton.
...
async def process_batch(
    ...
    Currently, this is meant to be an entrypoint for the `kozmoml infer ...` CLI.
