...
class ModelNotFound(KozmoMLError):
...
class ModelNotReady(KozmoMLError):
    def __init__(self, name: str, version: Optional[str] = None):
...
class InferenceError(KozmoMLError):
    def __init__(self, msg: str):
        super().__init__(msg, status.HTTP_400_BAD_REQUEST)


class ModelParametersMissing(KozmoMLError):
