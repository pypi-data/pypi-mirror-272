...
class ModelMetadataResponse(google.protobuf.message.Message):
    ...
    class TensorMetadata(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["datatype",b"datatype","name",b"name","parameters",b"parameters","shape",b"shape"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["inputs",b"inputs","name",b"name","outputs",b"outputs","parameters",b"parameters","platform",b"platform","versions",b"versions"]) -> None: ...
...
class InferParameter(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["parameter_choice",b"parameter_choice"]) -> typing.Optional[typing_extensions.Literal["bool_param","int64_param","string_param"]]: ...
...
class ModelRepositoryParameter(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["parameter_choice",b"parameter_choice"]) -> typing.Optional[typing_extensions.Literal["bool_param","int64_param","string_param","bytes_param"]]: ...
...
class RepositoryModelLoadRequest(google.protobuf.message.Message):
    ...
    @property
    def parameters(self) -> google.protobuf.internal.containers.MessageMap[typing.Text, global___ModelRepositoryParameter]:
    ...
    def __init__(self,
        *,
        repository_name : typing.Text = ...,
        model_name : typing.Text = ...,
        parameters : typing.Optional[typing.Mapping[typing.Text, global___ModelRepositoryParameter]] = ...,
        ) -> None: ...
