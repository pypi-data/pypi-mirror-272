...
class SingleDatasetOutput(BaseModel):
    """
    SingleDatasetOutput
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SingleDatasetOutput from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SingleDatasetOutput from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "microscopy": (
                    MicroscopyCreateRead.from_dict(obj["microscopy"]) if obj.get("microscopy") is not None else None
                ),
                "notes": obj.get("notes"),
            }
        )
