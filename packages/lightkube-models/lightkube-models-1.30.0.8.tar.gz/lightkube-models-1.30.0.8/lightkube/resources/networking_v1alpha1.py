...
class ServiceCIDRStatus(res.GlobalSubResource, m_networking_v1alpha1.ServiceCIDR):
    """* **Extends**: ``models.networking_v1alpha1.ServiceCIDR``
       * **Type**: Global Resource
       * **Accepted client methods**: `get`, `patch`, `replace`
    """
    _api_info = res.ApiInfo(
        resource=res.ResourceDef('networking.k8s.io', 'v1alpha1', 'ServiceCIDR'),
        parent=res.ResourceDef('networking.k8s.io', 'v1alpha1', 'ServiceCIDR'),
        plural='servicecidrs',
        verbs=['get', 'patch', 'put'],
        action='status',
    )
...
class ServiceCIDR(res.GlobalResource, m_networking_v1alpha1.ServiceCIDR):
    """* **Extends**: ``models.networking_v1alpha1.ServiceCIDR``
       * **Type**: Global Resource
       * **Accepted client methods**: `delete`, `deletecollection`, `get`, `list`, `patch`, `create`, `replace`, `watch`
