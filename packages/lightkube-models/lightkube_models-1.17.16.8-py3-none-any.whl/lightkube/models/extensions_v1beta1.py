...
class DaemonSet(DictMixin):
    r"""DEPRECATED - This group version of DaemonSet is deprecated by
...
class IDRange(DictMixin):
    r"""IDRange provides a min/max of an allowed range of IDs. Deprecated: use IDRange
...
class IPBlock(DictMixin):
    r"""DEPRECATED 1.9 - This group version of IPBlock is deprecated by
...
class NetworkPolicy(DictMixin):
    r"""DEPRECATED 1.9 - This group version of NetworkPolicy is deprecated by
...
class NetworkPolicyEgressRule(DictMixin):
    r"""DEPRECATED 1.9 - This group version of NetworkPolicyEgressRule is deprecated
...
class NetworkPolicyIngressRule(DictMixin):
    r"""DEPRECATED 1.9 - This group version of NetworkPolicyIngressRule is deprecated
...
class NetworkPolicyList(DictMixin):
    r"""DEPRECATED 1.9 - This group version of NetworkPolicyList is deprecated by
...
class NetworkPolicyPeer(DictMixin):
    r"""DEPRECATED 1.9 - This group version of NetworkPolicyPeer is deprecated by
...
class NetworkPolicyPort(DictMixin):
    r"""DEPRECATED 1.9 - This group version of NetworkPolicyPort is deprecated by
...
class NetworkPolicySpec(DictMixin):
    r"""DEPRECATED 1.9 - This group version of NetworkPolicySpec is deprecated by
...
class PodSecurityPolicyList(DictMixin):
    r"""PodSecurityPolicyList is a list of PodSecurityPolicy objects. Deprecated: use
...
class PodSecurityPolicySpec(DictMixin):
    r"""PodSecurityPolicySpec defines the policy enforced. Deprecated: use
...
class ReplicaSet(DictMixin):
    r"""DEPRECATED - This group version of ReplicaSet is deprecated by
...
class Scale(DictMixin):
    r"""represents a scaling request for a resource.
...
class ScaleSpec(DictMixin):
    r"""describes the attributes of a scale subresource
...
class ScaleStatus(DictMixin):
    r"""represents the current status of a scale subresource.
