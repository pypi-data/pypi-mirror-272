...
class PodEphemeralcontainers(res.NamespacedSubResource, m_core_v1.EphemeralContainers):
    """* **Extends**: ``models.core_v1.EphemeralContainers``
       * **Type**: Namespaced Resource
       * **Accepted client methods**: `get`, `patch`, `replace`
    """
    _api_info = res.ApiInfo(
        resource=res.ResourceDef('', 'v1', 'EphemeralContainers'),
        parent=res.ResourceDef('', 'v1', 'Pod'),
        plural='pods',
        verbs=['get', 'patch', 'put'],
