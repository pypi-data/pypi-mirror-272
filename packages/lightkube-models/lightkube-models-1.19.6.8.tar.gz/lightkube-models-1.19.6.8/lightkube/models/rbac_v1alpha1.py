...
class ClusterRoleBindingList(DictMixin):
    r"""ClusterRoleBindingList is a collection of ClusterRoleBindings. Deprecated in
...
class ClusterRoleList(DictMixin):
    r"""ClusterRoleList is a collection of ClusterRoles. Deprecated in v1.17 in favor
...
class RoleBindingList(DictMixin):
    r"""RoleBindingList is a collection of RoleBindings Deprecated in v1.17 in favor
...
class RoleList(DictMixin):
    r"""RoleList is a collection of Roles. Deprecated in v1.17 in favor of
