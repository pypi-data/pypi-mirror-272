...
from zibuyu_LLM.types import AiAnswer
from zibuyu_LLM.errors import NeedLoginError
...
class DeepSeekWeb(LLMBase):
    ...
    def ask_code(self, question: str, callback_func=None):
        """
        代码助手
        :param question:
        :param callback_func:
        ...
        return self.__single_answer

    def ask(self, question: str, callback_func=None):
        """
        通用助手
        :param question:
        :param callback_func:
