...
class ImageCollection:
    ...
    conserve_memory : bool, optional
        If True, :class:`pysarpro.io.ImageCollection` does not keep more than one in
    ...
    **load_func_kwargs : dict
    ...
    returns a new :class:`pysarpro.io.ImageCollection`, *not* a view into the data.
    ...
    sequence, an :class:`pysarpro.io.ImageCollection` of corresponding length will
    ...
    files (or strings at all). For example, to create an :class:`pysarpro.io.ImageCollection`
    ...
    def __getitem__(self, n):
        ...
        Returns
        -------
        img : ndarray or :class:`pysarpro.io.ImageCollection`
    ...
    def concatenate(self):
        ...
        See Also
        --------
        pysarpro.io.concatenate_images

        Raises
        ------
        ValueError
            If images in the :class:`pysarpro.io.ImageCollection` do not have identical
            shapes.
        """
...
def imread_collection_wrapper(imread):
    def imread_collection(load_pattern, conserve_memory=True):
        ...
        See `pysarpro.io.ImageCollection` for details.
