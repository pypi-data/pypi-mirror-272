...
_error_on_warnings = os.environ.get('pysarpro_TEST_STRICT_WARNINGS_GLOBAL', '0')
...
def setup_test():
    """Default package level setup routine for pysarpro tests.
...
def teardown_test():
    """Default package level teardown routine for pysarpro tests.
