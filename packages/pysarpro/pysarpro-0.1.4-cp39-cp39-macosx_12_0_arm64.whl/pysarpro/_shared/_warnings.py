...
def all_warnings():
    ...
    # pass).  Then, we search for all submodules of pysarpro and clear theirs
    # as well (necessary for the pysarpro test suite to pass).
...
def expected_warnings(matching):
    ...
    strict_warnings = os.environ.get('pysarpro_TEST_STRICT_WARNINGS', '1')
