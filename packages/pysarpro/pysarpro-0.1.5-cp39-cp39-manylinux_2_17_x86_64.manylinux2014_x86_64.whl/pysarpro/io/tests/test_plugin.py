...
from pysarpro._shared._dependency_checks import has_mpl
from pysarpro.io import manage_plugins
...
def test_load_preferred_plugins_all():
    from pysarpro.io._plugins import matplotlib_plugin, pil_plugin
