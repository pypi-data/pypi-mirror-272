...
======================================================
Making your own copy (fork) of pysarpro
======================================================
...
the specifics for the `pysarpro`_ project, and to suggest some default names.
...
Create your own forked copy of `pysarpro`_
======================================================

#. Log into your github account.
#. Go to the `pysarpro`_ github home at `pysarpro github`_.
#. Click on the *fork* button:

   .. image:: forking_button.png

   Now, after a short pause and some 'Hardcore forking action', you
   should find yourself at the home page for your own forked copy of `pysarpro`_.
