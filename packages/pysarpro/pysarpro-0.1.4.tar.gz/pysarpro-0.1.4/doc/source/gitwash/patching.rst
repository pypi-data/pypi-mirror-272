...
in `pysarpro`_ .. |emdash| excellent!
...
Then, send the generated patch files to the `pysarpro
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `pysarpro developer forum`_.
...
Fork the `pysarpro`_ repository on github |emdash| :ref:`forking`.
Then::
   ...
   git remote add origin git@github.com:your-user-name/pysarpro.git
