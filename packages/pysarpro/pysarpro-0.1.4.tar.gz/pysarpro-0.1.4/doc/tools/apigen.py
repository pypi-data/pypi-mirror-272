...
project, then adapted for use first in NIPY and then in pysarpro. PyMVPA
...
class ApiDocWriter:
    ...
    def _parse_module_with_import(self, uri):
        ...
        for obj_str in obj_strs:
            ...
            elif isinstance(obj, ModuleType) and 'pysarpro' in mod.__name__:
    ...
    def write_index(self, outdir, froot='gen', relative_to=None):
        ...
        with open(path, 'w') as idx:
            ...
            # If it is `pysarpro`, display,
            # if `pysarpro.submodule`, only show `submodule`,
            # if it is `pysarpro.submodule.subsubmodule`, ignore.
