...
class deprecate_parameter:
    ...
    Examples
    --------
    >>> from pysarpro._shared.utils import deprecate_parameter, DEPRECATED
    >>> @deprecate_parameter(
...
class deprecate_func(_DecoratorBaseClass):
    ...
    hint : str, optional
        ...
        e.g., "Use `pysarpro.submodule.alternative_func` instead."
...
def _validate_interpolation_order(image_dtype, order):
    ...
    order : int, optional
        ...
        the range 0-5. See `pysarpro.transform.warp` for detail.
