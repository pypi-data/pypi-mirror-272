...
# - https://github.com/Pol-InSAR/pysarpro/issues/3043
...
def _convert(image, dtype, force_copy=False, uniform=False):
    ...
    .. versionchanged:: 0.15
        ...
        https://github.com/Pol-InSAR/pysarpro/issues/2602
        https://github.com/Pol-InSAR/pysarpro/issues/543#issuecomment-208202228
        https://github.com/Pol-InSAR/pysarpro/pull/3575
...
def convert(image, dtype, force_copy=False, uniform=False):
    warn(
        ...
        "dramatically in pysarpro 1.0. This function will be removed "
        "in pysarpro 1.0.",
        FutureWarning,
        stacklevel=2,
    )
