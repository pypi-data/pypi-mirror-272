...
You are running pysarpro on an unsupported version of Python.

Unfortunately, pysarpro 0.15 and above no longer work with your installed
version of Python ({}).  You therefore have two options: either upgrade to
Python {}, or install an older version of pysarpro.

For Python 2.7 or Python 3.4, use

 $ pip install 'pysarpro<0.15'
