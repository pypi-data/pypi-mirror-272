...
#. Clone your fork to the local computer with ``git clone
   git@github.com:your-user-name/pysarpro.git``
#. Investigate.  Change directory to your new repo: ``cd pysarpro``. Then
   ...
   Now you want to connect to the upstream `pysarpro github`_ repository, so
