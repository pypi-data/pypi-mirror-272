...
htmlhelp_basename = 'HydrOfficeSoundSpeedDoc'
...
man_pages = [
    ('index', 'hydrofficesoundspeed', u'Sound Speed Manager Documentation',
     [u'CCOM/JHC,UNH & CSDL,NOAA'], 1)
]
...
texinfo_documents = [
  ('index', 'HydrOfficeSoundSpeed', u'Sound Speed Manager Documentation',
   u'CCOM/JHC,UNH & CSDL,NOAA',
   'HydrOfficeSoundSpeed', 'Library and tools to manage sound speed profiles.',
   'Miscellaneous'),
]
