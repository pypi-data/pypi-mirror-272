...
class CreateLogInput(BaseModel):
    ...
    CreateLogInput
    """ # noqa: E501
    datapoint_run_id: Optional[StrictStr] = Field(default=None, alias="datapointRunId")
    log: LogInput
    trace: Optional[TraceInput] = None
    __properties: ClassVar[List[str]] = ["datapointRunId", "log", "trace"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "log": LogInput.from_dict(obj["log"]) if obj.get("log") is not None else None,
            "trace": TraceInput.from_dict(obj["trace"]) if obj.get("trace") is not None else None
        })
        return _obj
