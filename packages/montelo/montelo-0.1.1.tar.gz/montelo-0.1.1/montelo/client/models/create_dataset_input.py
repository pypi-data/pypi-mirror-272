...
class CreateDatasetInput(BaseModel):
    ...
    is_fine_tuning: Optional[StrictBool] = Field(default=None, alias="isFineTuning")
    __properties: ClassVar[List[str]] = ["name", "description", "inputSchema", "outputSchema", "isFineTuning"]
