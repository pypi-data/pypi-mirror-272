"""The networking part of the python-linknlink library."""
import datetime as dt
import time


class Datetime:
    """Helps to pack and unpack datetime objects for the LinknLink protocol."""

    @staticmethod
    def pack(datetime: dt.datetime) -> bytes:
        """Pack the timestamp to be sent over the LinknLink protocol."""
        data = bytearray(12)
    ...
    def unpack(data: bytes) -> dt.datetime:
        """Unpack a timestamp received over the LinknLink protocol."""
