...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, rate_limit=None, max_retries=None, connect_timeout=None, proxy_url=None, headers=None, sock_read_timeout=None, tls_validation=None, client_cert=None, pulp_labels=None, total_timeout=None, ca_cert=None, sock_connect_timeout=None, download_concurrency=None, url=None, hidden_fields=None, pulp_created=None, name=None, pulp_href=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
