...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, client_key=None, rate_limit=None, max_retries=None, password=None, connect_timeout=None, proxy_url=None, proxy_password=None, headers=None, proxy_username=None, username=None, sock_read_timeout=None, tls_validation=None, client_cert=None, pulp_labels=None, total_timeout=None, ca_cert=None, sock_connect_timeout=None, download_concurrency=None, url=None, name=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
