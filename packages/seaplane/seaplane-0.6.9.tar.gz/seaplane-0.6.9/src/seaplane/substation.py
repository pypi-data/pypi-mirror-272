...
class Substation:
    ...
    models: Dict[str, Any] = {
        ...
        # Seaplane internal embeddings
        "sp-embeddings": {
            "model_name": ["sentence-transformers/all-mpnet-base-v2", "sp-embeddings"],
        ...
        # Seaplane internal embeddings (CPU-only)
        "sp-embeddings-cpu": {
            "model_name": ["sentence-transformers/all-mpnet-base-v2-cpu", "sp-embeddings-cpu"],
