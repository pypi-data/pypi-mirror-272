...
class idax(Exchange, ImplicitAPI):
    ...
    def parse_trade(self, trade: object, market: Market = None) -> Trade:
        ...
        side = 'buy' if (tradeSide == 'BUY') else 'sell'
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        market = self.market(symbol)
        marketId = market['id']
        clientMarketId = self.safe_string(params, 'clientOrderId')
        request = {
            'symbol': marketId,
            'volume': amount,
            'side': side.upper(),
        ...
        if clientMarketId is not None:
            request['clientOrderId'] = clientMarketId
        response = await self.sapiPrivatePostOrder(self.extend(request, params))
