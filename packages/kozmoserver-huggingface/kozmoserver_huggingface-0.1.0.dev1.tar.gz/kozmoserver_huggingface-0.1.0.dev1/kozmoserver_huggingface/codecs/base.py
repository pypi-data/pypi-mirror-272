...
from kozmoserver.codecs.utils import (
    has_decoded,
    _save_decoded,
    get_decoded_or_raw,
)
from kozmoserver.codecs import StringCodec
from kozmoserver.codecs.base import (
    RequestCodec,
...
class MultiInputRequestCodec(RequestCodec):
    """
    Huggingface codecs is prefered, then kozmoserver's
    """
