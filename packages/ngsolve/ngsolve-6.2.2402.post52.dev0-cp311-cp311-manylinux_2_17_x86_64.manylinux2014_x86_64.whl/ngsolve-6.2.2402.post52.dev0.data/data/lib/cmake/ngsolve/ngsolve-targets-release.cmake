...
set_target_properties(ngstd PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngstd.so"
  IMPORTED_SONAME_RELEASE "libngstd.so"
  )

list(APPEND _cmake_import_check_targets ngstd )
list(APPEND _cmake_import_check_files_for_ngstd "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngstd.so" )
...
set_target_properties(ngbla PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngbla.so"
  IMPORTED_SONAME_RELEASE "libngbla.so"
  )

list(APPEND _cmake_import_check_targets ngbla )
list(APPEND _cmake_import_check_files_for_ngbla "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngbla.so" )
...
set_target_properties(ngla PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngla.so"
  IMPORTED_SONAME_RELEASE "libngla.so"
  )

list(APPEND _cmake_import_check_targets ngla )
list(APPEND _cmake_import_check_files_for_ngla "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngla.so" )
...
set_target_properties(ngfem PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngfem.so"
...
set_target_properties(ngcomp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngcomp.so"
  IMPORTED_SONAME_RELEASE "libngcomp.so"
  )

list(APPEND _cmake_import_check_targets ngcomp )
list(APPEND _cmake_import_check_files_for_ngcomp "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngcomp.so" )
...
set_target_properties(ngsolve PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngsolve.so"
  IMPORTED_SONAME_RELEASE "libngsolve.so"
  )

list(APPEND _cmake_import_check_targets ngsolve )
list(APPEND _cmake_import_check_files_for_ngsolve "${_IMPORT_PREFIX}/lib/python3.11/site-packages/netgen_mesher.libs/libngsolve.so" )
