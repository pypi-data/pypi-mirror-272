...
class Mesh:
    ...
    def __init__(self, ngmesh: netgen.libngpy._meshing.Mesh) -> None:
        ...
        """
    @typing.overload
    def __init__(self, filename: str, comm: netgen.libngpy._meshing.MPI_Comm = ...) -> None:
        """
