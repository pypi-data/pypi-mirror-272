...
#ifndef YY_LIBFPLIST_XML_SCANNER_LIBFPLIST_XML_PARSER_H_INCLUDED
# define YY_LIBFPLIST_XML_SCANNER_LIBFPLIST_XML_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
#if YYDEBUG
extern int libfplist_xml_scanner_debug;
#endif
...
extern YYSTYPE libfplist_xml_scanner_lval;


int libfplist_xml_scanner_parse (void *parser_state);


#endif /* !YY_LIBFPLIST_XML_SCANNER_LIBFPLIST_XML_PARSER_H_INCLUDED  */
/* Symbol kind.  */
...
yyreduce:
  ...
  case 15: /* xml_tag_close: XML_TAG_CLOSE  */
		...
		if( ( ( (libfplist_xml_parser_state_t *) parser_state )->current_tag->name_size != ( (yyvsp[0].string_value).length + 1 ) )
