...
#     run_command(["python", "Synthesis_dataset/figure1.py", "--dataset", dataset, "--path", "Synthesis_dataset"])

# # Experiment for Figure 2
# run_command(["python", "Synthesis_dataset/figure2.py", "--path", "Synthesis_dataset"])
