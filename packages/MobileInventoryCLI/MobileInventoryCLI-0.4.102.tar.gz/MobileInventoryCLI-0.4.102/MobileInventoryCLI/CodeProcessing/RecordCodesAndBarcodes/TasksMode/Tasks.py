...
""")
    ...
    def __init__(self,engine,parent):
        ...
        self.options["tag_reverse_inventory_1"]={
                    ...
                    'exec':lambda self=self: tagList(engine=self.engine,state=True,tag="ReverseInventory"),
                    }
        count+=1
        ...
        self.options["tag_have/has_1"]={
                    ...
                    'exec':lambda self=self: tagList(engine=self.engine,state=True,tag="have/has"),
                    }
        count+=1
