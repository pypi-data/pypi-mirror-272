...
# _SRC_DIGIFLOW_RES = os.path.dirname(os.path.abspath(__file__))

# schema validtion XSDs
# METS_1_12 = os.path.join(_SRC_DIGIFLOW_RES,
#                          'resources', 'xsd', 'mets_1-12.xsd')
# MODS_3_7 = os.path.join(_SRC_DIGIFLOW_RES,
#                         'resources', 'xsd', 'mods_3-7.xsd')
# MIX_2_0 = os.path.join(_SRC_DIGIFLOW_RES,
#                        'resources', 'xsd', 'mix_2-0.xsd')
# ALTO_3_1 = os.path.join(_SRC_DIGIFLOW_RES,
#                         'resources', 'xsd', 'alto_3-1.xsd')
# ALTO_4_2 = os.path.join(_SRC_DIGIFLOW_RES,
