...
name = 'm9s_nereid_test'
download_url = 'https://gitlab.com/m9s/nereid_test.git'
requires = []
...
setup(name=name,
    version=version,
    description='Tryton Nereid Test Module',
    ...
    project_urls={
        ...
        "Source Code": 'https://gitlab.com/m9s/nereid_test.git',
        },
    keywords='',
    package_dir={'trytond.modules.nereid_test': '.'},
    packages=(
        ['trytond.modules.nereid_test']
        + ['trytond.modules.nereid_test.%s' % p
