...
class Search:
    ...
    def __init__(
        ...
        name: str = "",
        company_shared_permission: Optional[SearchSharePermission] = None,
    ):
    ...
    def from_saved_search_response(
        ...
        if company_permission == SearchSharePermission.UNDEFINED:
    ...
    def share_with_company(self):
        ...
        request = ShareSavedSearchRequest(
            company=UserQueryShareCompanyContext(permission=SearchSharePermission.READ),
            users=[],
        )
        self._api.share_search(self.id, request)
        self._company_shared_permission = SearchSharePermission.READ
    ...
    def unshare_with_company(self):
        ...
        request = ShareSavedSearchRequest(
            company=UserQueryShareCompanyContext(
                permission=SearchSharePermission.UNDEFINED
            ),
            users=[],
        )
        self._api.share_search(self.id, request)
    ...
    @property
    def company_shared_permission(self) -> Optional[SearchSharePermission]:
        """
