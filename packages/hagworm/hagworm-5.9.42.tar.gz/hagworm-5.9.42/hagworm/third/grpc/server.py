...
class StreamHandler:
    ...
    def __init__(self, request: typing.AsyncIterator, context: grpc.aio.ServicerContext):
        ...
        self._context.add_done_callback(lambda _: Utils.create_task(self.on_disconnect()))
    ...
    def metadata(self) -> typing.Dict[str, str]:
        return dict(self._context.invocation_metadata())
    ...
    async def send(self, message: typing.Any):
        ...
        if not self._context.done():
            ...
            Utils.log.warning(f'grpc stream send canceled: {message}')
