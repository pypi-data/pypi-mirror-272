...
def detect_id_card(client, image_data, id_texts, image_format, part=None, country=None):
    ...
    if id_texts:
        ...
        # save_directory = '/Users/fahadpatel/Downloads'
        # part_img_path = os.path.join(save_directory, "front_id_card_img.jpg")
        # id_card.save(part_img_path)
...
def iraq_back_id_extraction(client, image_data, back_id_text, back_data, image_format):
    ...
    if mrz_str:
        ...
        print('this is mrz_list',mrz_list)
        try: 
            mrz1=mrz_list[0]
        except:
            mrz1=''
...
### The below funcion is too generic, it goes from the assumption that mrz extraction is wrong
