...
#                         video_quality['error'] = 'no_face_detected_in_video'
    ...
    def frame_count_and_save(self, video_bytes):
        frames = []
    ...
    def check_for_liveness(self, similarity, video_bytes, face_match_threshold=0.60):
        ...
        liveness_result_list = []
        frames = self.frame_count_and_save(video_bytes)
        ...
        for frame in frames_to_process:
            ...
            if largest_face:
                ...
                if previous_landmarks and previous_face:
                    ...
                    print(f"eyebrow_movement: {eyebrow_movement}")
                    print(f"nose_movement: {nose_movement}")
                    print(f"lip_movement: {lip_movement}")
                    print(f"face_movement: {face_movement}")
        ...
        print(f"\n\n\nLIVE RESULT LIST: {liveness_result_list}")
