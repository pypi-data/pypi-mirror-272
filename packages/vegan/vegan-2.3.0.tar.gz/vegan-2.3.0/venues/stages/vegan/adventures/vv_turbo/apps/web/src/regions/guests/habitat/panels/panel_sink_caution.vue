...
export default {
	...
	data () {
		return {
			wall: `url("\/bits\/andreas160578--stone-slab-1331965_1920.jpg")`,
			//  
			planet: `url("\/bits\/galaxy-3608029_1920.jpg")`,
			
			climate: `url("\/bits\/euro_papa--vegan-8527482_1920.png")`,
			...
			//beans: `url("\/bits\/arielnunezg\/string-bean-3861864_1920.jpg")`
			title: "Climate",
