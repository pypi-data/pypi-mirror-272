...
const olive_salad_button = {
	...
	box_shadow: '#ddd2a6 0px 0px 3px -1px inset',
	text: 'black'
}

const cashew_salad_button = {
	border: '4px solid rgba(34, 34, 34, 0)',
	background: 'linear-gradient(-10deg, rgb(130, 127, 98), black)',
...
const router_link_button_box_shadow = 'rgba(198, 187, 39, 0.48) 0px 0px 9px -1px'
...
export const palettes = Object.freeze ({
	"olive salad": Object.freeze ({
		change_duration: "2.5s",
		change_duration_ms: 2500,
		
		1: "#222",
		2: "#FFF",
		"2.1": olive_salad_button.text,
		...
		7: "#656565",
		'7.1': router_link_button_box_shadow,
		'7.2': olive_salad_button.box_shadow,
		'7.3': '#888',
	...
	"cashew salad": Object.freeze ({
		change_duration: "2.5s",
		change_duration_ms: 2500,
		
		1: "rgb(238, 237, 225)",
		2: "#222",
		"2.1": cashew_salad_button.text,
		...
		7: "#BBB",
		'7.1': router_link_button_box_shadow,
		'7.2': cashew_salad_button.bow_shadow,
		'7.3': '#222',
