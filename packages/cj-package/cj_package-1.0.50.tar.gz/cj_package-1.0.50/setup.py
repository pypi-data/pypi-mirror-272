...
with open(here /"src" / "cj_package" / "__version__.py", "r", encoding="utf-8") as f:
...
if sys.argv[-1] == "publish":
    os.system("rm -rf build cj_package.egg-info dist")
    os.system("python setup.py sdist bdist_wheel")
    os.system("twine upload --skip-existing --repository-url https://upload.pypi.org/legacy/  dist/*")
    os.system("pip uninstall cj_package -y && pip install -U cj_package -i https://pypi.org/simple")
    sys.exit()
...
setuptools.setup(
    ...
    packages=["cj_package"],  # 指定包名，确保只包含你需要的包
