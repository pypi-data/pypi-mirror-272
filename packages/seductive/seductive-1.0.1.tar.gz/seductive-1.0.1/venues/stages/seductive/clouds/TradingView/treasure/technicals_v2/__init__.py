...
'''
	...
	import seductive.clouds.TradingView.treasure.technicals_v2 as TV_treasure_tech_v2
...
def retrieve_change ():
	import numpy
	from datetime import datetime, timedelta
	import seductive.clouds.Yahoo.retrieve_change as Yahoo_retrieve_change
