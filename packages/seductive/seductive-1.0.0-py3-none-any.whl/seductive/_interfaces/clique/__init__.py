...
from seductive.stats.clique import stats_group
from seductive.scans.clique import scans_group
from seductive.__data_nodes.moon.clique import moon_group
...
def clique ():
	...
	import click
	import rich
	import seductive.clouds.TradingView.treasure.technicals as TV_treasure_tech
	@click.command ("ETFs")
	def example_command ():	
		...
		#
		#	seductive/structures/ride/season_1/TV_technicals_shares/ETF/rise.proc.py
		#
