...
class SimplePosition(BaseModel):
    """
    Position of the Employee  # noqa: E501
    """
    title: Optional[StrictStr] = Field(None, description="The name of the Position")
    hours_per_full_work_day: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="hoursPerFullWorkDay", description="Hours per full work day")
    position_type: Optional[Int32IdNameClass] = Field(None, alias="positionType")
    ...
    __properties = ["title", "hoursPerFullWorkDay", "positionType", "needsReplacement", "id", "externalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimplePosition:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimplePosition:
        """Create an instance of SimplePosition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimplePosition.parse_obj(obj)

        _obj = SimplePosition.parse_obj({
            "title": obj.get("title"),
            "hours_per_full_work_day": obj.get("hoursPerFullWorkDay"),
            "position_type": Int32IdNameClass.from_dict(obj.get("positionType")) if obj.get("positionType") is not None else None,
