...
class BadRequestResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BadRequestResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BadRequestResult:
        """Create an instance of BadRequestResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BadRequestResult.parse_obj(obj)

        _obj = BadRequestResult.parse_obj({
