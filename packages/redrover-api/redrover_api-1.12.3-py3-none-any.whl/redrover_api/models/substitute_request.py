...
class SubstituteRequest(BaseModel):
    """
    SubstituteRequest  # noqa: E501
    """
    replace_existing_related_orgs: Optional[StrictBool] = Field(None, alias="replaceExistingRelatedOrgs", description="If related Organizations are to be replaced. (Default is true)")
    related_orgs: Optional[conlist(SubstituteRelatedOrgRequest)] = Field(None, alias="relatedOrgs", description="Related Organizations")
    replace_existing_attributes: Optional[StrictBool] = Field(None, alias="replaceExistingAttributes", description="If related Attributes are to be replaced. (Default is true)")
    attributes: Optional[conlist(SubstituteAttributeRequest)] = Field(None, description="Related Attributes")
    pay_code: Optional[Int32LocatorRequest] = Field(None, alias="payCode")
    related_org_ids: Optional[conlist(StrictInt)] = Field(None, alias="relatedOrgIds", description="Related Organization Ids")
    ...
    __properties = ["replaceExistingRelatedOrgs", "relatedOrgs", "replaceExistingAttributes", "attributes", "payCode", "relatedOrgIds", "id", "secondaryIdentifier", "externalId", "firstName", "middleName", "lastName", "email", "notificationEmail", "dateOfBirth", "address1", "address2", "city", "postalCode", "badgeNumber", "state", "country", "phoneNumber", "active", "permissionSet", "removeFutureAssignmentsOnInactivate", "inviteImmediately"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubstituteRequest:
    ...
    def to_dict(self):
        ...
        if self.related_orgs is None and "related_orgs" in self.__fields_set__:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubstituteRequest:
        """Create an instance of SubstituteRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubstituteRequest.parse_obj(obj)

        _obj = SubstituteRequest.parse_obj({
            "replace_existing_related_orgs": obj.get("replaceExistingRelatedOrgs"),
            "related_orgs": [SubstituteRelatedOrgRequest.from_dict(_item) for _item in obj.get("relatedOrgs")] if obj.get("relatedOrgs") is not None else None,
            "replace_existing_attributes": obj.get("replaceExistingAttributes"),
