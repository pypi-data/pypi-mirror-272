...
class NotFoundResult(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NotFoundResult:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NotFoundResult:
        """Create an instance of NotFoundResult from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NotFoundResult.parse_obj(obj)

        _obj = NotFoundResult.parse_obj({
