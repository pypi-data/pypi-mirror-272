...
class OrgUserEmployeeResponse(BaseModel):
    ...
    __properties = ["id", "externalId", "firstName", "lastName", "secondaryIdentifier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrgUserEmployeeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrgUserEmployeeResponse:
        """Create an instance of OrgUserEmployeeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrgUserEmployeeResponse.parse_obj(obj)

        _obj = OrgUserEmployeeResponse.parse_obj({
            "id": obj.get("id"),
