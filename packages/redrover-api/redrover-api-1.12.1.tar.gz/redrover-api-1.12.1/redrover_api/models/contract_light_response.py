...
class ContractLightResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContractLightResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ContractLightResponse:
        """Create an instance of ContractLightResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContractLightResponse.parse_obj(obj)

        _obj = ContractLightResponse.parse_obj({
            "name": obj.get("name"),
            "id": obj.get("id"),
