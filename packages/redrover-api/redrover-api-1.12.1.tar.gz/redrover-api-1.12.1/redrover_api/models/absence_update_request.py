...
class AbsenceUpdateRequest(BaseModel):
    ...
    __properties = ["externalId", "employee", "notesToApprover", "adminOnlyNotes", "details", "startDate", "endDate", "vacancies"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AbsenceUpdateRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AbsenceUpdateRequest:
        """Create an instance of AbsenceUpdateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AbsenceUpdateRequest.parse_obj(obj)

        _obj = AbsenceUpdateRequest.parse_obj({
