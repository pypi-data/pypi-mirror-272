...
class SimplePositionResponse(BaseModel):
    ...
    Position  # noqa: E501
    """
    title: Optional[StrictStr] = Field(None, description="Name of the Position")
    ...
    __properties = ["title", "positionType", "name", "id", "externalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimplePositionResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimplePositionResponse:
        """Create an instance of SimplePositionResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimplePositionResponse.parse_obj(obj)

        _obj = SimplePositionResponse.parse_obj({
            "title": obj.get("title"),
