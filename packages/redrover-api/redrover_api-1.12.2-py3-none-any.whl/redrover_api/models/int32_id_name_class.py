...
class Int32IdNameClass(BaseModel):
    """
    Contains the Id, ExternalId, and Name  # noqa: E501
    """
    name: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    external_id: Optional[StrictStr] = Field(None, alias="externalId")
    __properties = ["name", "id", "externalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Int32IdNameClass:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Int32IdNameClass:
        """Create an instance of Int32IdNameClass from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Int32IdNameClass.parse_obj(obj)

        _obj = Int32IdNameClass.parse_obj({
            "name": obj.get("name"),
            "id": obj.get("id"),
