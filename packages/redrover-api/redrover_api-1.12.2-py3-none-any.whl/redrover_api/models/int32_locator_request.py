...
class Int32LocatorRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Int32LocatorRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Int32LocatorRequest:
        """Create an instance of Int32LocatorRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Int32LocatorRequest.parse_obj(obj)

        _obj = Int32LocatorRequest.parse_obj({
            "id": obj.get("id"),
