...
class EmployeeResponse(BaseModel):
    ...
    Employee  # noqa: E501
    """
    positions: Optional[conlist(PositionResponse)] = Field(None, description="The Positions that belong to the employee")
    ...
    __properties = ["positions", "id", "orgId", "createdUtc", "changedUtc", "externalId", "firstName", "middleName", "lastName", "email", "notificationEmail", "loginEmail", "dateOfBirth", "address1", "address2", "city", "state", "postalCode", "country", "phoneNumber", "active", "permissionSetId", "isDeleted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmployeeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmployeeResponse:
        """Create an instance of EmployeeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmployeeResponse.parse_obj(obj)

        _obj = EmployeeResponse.parse_obj({
