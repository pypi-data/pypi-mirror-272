...
class PositionScheduleRequest(BaseModel):
    ...
    """
    items: conlist(PositionScheduleItemRequest) = Field(..., description="Position Schedule Items")
    days_of_the_week: conlist(DayOfWeek) = Field(..., alias="daysOfTheWeek", description="Days of the week")
    __properties = ["items", "daysOfTheWeek"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PositionScheduleRequest:
