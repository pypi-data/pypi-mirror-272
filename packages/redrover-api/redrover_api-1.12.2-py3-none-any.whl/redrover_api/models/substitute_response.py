...
class SubstituteResponse(BaseModel):
    """
    SubstituteResponse  # noqa: E501
    """
    attributes: Optional[conlist(SubstituteAttributeResponse)] = Field(None, description="Attributes of the substitute")
    ...
    __properties = ["attributes", "relatedOrgIds", "payCode", "id", "orgId", "createdUtc", "changedUtc", "externalId", "firstName", "middleName", "lastName", "email", "notificationEmail", "loginEmail", "dateOfBirth", "address1", "address2", "city", "state", "postalCode", "country", "phoneNumber", "active", "permissionSetId", "isDeleted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubstituteResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubstituteResponse:
        """Create an instance of SubstituteResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubstituteResponse.parse_obj(obj)

        _obj = SubstituteResponse.parse_obj({
