...
class SubstituteAttributeResponse(BaseModel):
    """
    SubstituteAttributeResponse  # noqa: E501
    """
    attribute: Optional[Int32LocatorResponse] = None
    expires: Optional[datetime] = Field(None, description="When the attribute expire")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubstituteAttributeResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubstituteAttributeResponse:
        """Create an instance of SubstituteAttributeResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubstituteAttributeResponse.parse_obj(obj)

        _obj = SubstituteAttributeResponse.parse_obj({
