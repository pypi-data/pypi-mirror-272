...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GETBLOBREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _GETBLOBSREQUEST.fields_by_name['repository']._options = None
  _GETBLOBSREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _LISTBLOBSREQUEST.fields_by_name['repository']._options = None
  _LISTBLOBSREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _LISTALLBLOBSREQUEST.fields_by_name['repository']._options = None
  _LISTALLBLOBSREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _GETLFSPOINTERSREQUEST.fields_by_name['repository']._options = None
  _GETLFSPOINTERSREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _LISTLFSPOINTERSREQUEST.fields_by_name['repository']._options = None
  _LISTLFSPOINTERSREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _LISTALLLFSPOINTERSREQUEST.fields_by_name['repository']._options = None
  _LISTALLLFSPOINTERSREQUEST.fields_by_name['repository']._serialized_options = b'\230\306,\001'
  _BLOBSERVICE.methods_by_name['GetBlob']._options = None
  _BLOBSERVICE.methods_by_name['GetBlob']._serialized_options = b'\372\227(\002\010\002'
  _BLOBSERVICE.methods_by_name['GetBlobs']._options = None
  _BLOBSERVICE.methods_by_name['GetBlobs']._serialized_options = b'\372\227(\002\010\002'
  _BLOBSERVICE.methods_by_name['ListBlobs']._options = None
  _BLOBSERVICE.methods_by_name['ListBlobs']._serialized_options = b'\372\227(\002\010\002'
  _BLOBSERVICE.methods_by_name['ListAllBlobs']._options = None
  _BLOBSERVICE.methods_by_name['ListAllBlobs']._serialized_options = b'\372\227(\002\010\002'
  _BLOBSERVICE.methods_by_name['GetLFSPointers']._options = None
  _BLOBSERVICE.methods_by_name['GetLFSPointers']._serialized_options = b'\372\227(\002\010\002'
  _BLOBSERVICE.methods_by_name['ListLFSPointers']._options = None
  _BLOBSERVICE.methods_by_name['ListLFSPointers']._serialized_options = b'\372\227(\002\010\002'
  _BLOBSERVICE.methods_by_name['ListAllLFSPointers']._options = None
