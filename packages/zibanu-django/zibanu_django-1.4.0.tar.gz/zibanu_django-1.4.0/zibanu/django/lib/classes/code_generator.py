...
class CodeGenerator:
    ...
    def get_alpha_numeric_code(self, length: int = None) -> str:
        ...
        self.__code = "".join(secrets.choice(string.digits + self.__code) for i in range(self.__code_length))
        return self.code
    ...
    def get_secure_code(self, length: int = None) -> str:
        ...
        self.__code = self.get_alpha_numeric_code(self.__code_length * 2)
        # Force include punctuation
        self.__code = "".join(
            secrets.choice(string.punctuation + string.ascii_letters + self.__code) for i in range(self.__code_length))
        return self.code
