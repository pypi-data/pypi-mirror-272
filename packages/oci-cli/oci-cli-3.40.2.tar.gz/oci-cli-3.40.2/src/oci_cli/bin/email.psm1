...
function GetOciSubcommands_email() {
    $ociSubcommands = @{
        'email' = 'configuration dkim domain sender suppression work-request work-request-error work-request-log'
...
function GetOciCommandsToLongParams_email() {
    $ociCommandsToLongParams = @{
        ...
        'email dkim create' = 'defined-tags description email-domain-id freeform-tags from-json help max-wait-seconds name wait-for-state wait-interval-seconds'
        ...
        'email domain create' = 'compartment-id defined-tags description freeform-tags from-json help max-wait-seconds name wait-for-state wait-interval-seconds'
        ...
        'email domain update' = 'defined-tags description email-domain-id force freeform-tags from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
