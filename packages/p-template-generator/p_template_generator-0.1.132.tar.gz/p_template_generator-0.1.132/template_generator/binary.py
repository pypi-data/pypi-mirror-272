...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_win_2024051302.zip", "307feea39b8d9691311725b14a61fffd", "skymedia.zip.py") == True
        ...
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_darwin_2024051302.zip", "66bdf735439130f97bde3e097b5ff83a", "skymedia.zip.py")
