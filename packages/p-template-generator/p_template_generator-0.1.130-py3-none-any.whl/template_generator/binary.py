...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_win_20240509.zip", "fa1f085ff8d39bf830769ce745ca4443", "skymedia.zip.py") == True
        ...
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_darwin_202405102205.zip", "d11c1d51840759b6f65808e42ce5e054", "skymedia.zip.py")
