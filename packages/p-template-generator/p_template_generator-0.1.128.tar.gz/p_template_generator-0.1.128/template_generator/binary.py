...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_win_202405051918.zip", "2708413943a5a752f61e140ea4fab8ec", "skymedia.zip.py") == True
        ...
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_darwin_202405051921.zip", "9776171c1dc124f575b5b388ca5f1b3d", "skymedia.zip.py")
