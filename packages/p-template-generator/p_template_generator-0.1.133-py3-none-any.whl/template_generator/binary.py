...
def updateBin(rootDir):
    ...
    if sys.platform == "win32":
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_win_2024051303.zip", "8e5b509c37032cfca153207c5bd8fcbc", "skymedia.zip.py") == True
        ...
        getOssResource(rootDir, "https://m.mecordai.com/res/skymedia_darwin_2024051303.zip", "cebe89aae88e9a9ffebaddf503848107", "skymedia.zip.py")
