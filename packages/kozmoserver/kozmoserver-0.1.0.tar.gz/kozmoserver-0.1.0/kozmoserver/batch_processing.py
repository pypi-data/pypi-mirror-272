...
from kozmoserver.batching.requests import BatchedRequests
from kozmoserver.types import InferenceRequest, InferenceResponse, Parameters
from kozmoserver.codecs import NumpyCodec
from kozmoserver.logging import get_logger


from kozmoserver.utils import generate_uuid
from kozmoserver.batching.requests import _merge_parameters
...
# Monkey patching is required for error responses coming from KozmoServer.
# KozmoServer will contain `detail` field instead of `error` one like Triton.
...
async def process_batch(
    ...
    Currently, this is meant to be an entrypoint for the `kozmoserver infer ...` CLI.
