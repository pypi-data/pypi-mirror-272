...
from ..errors import KozmoServerError


class EnvironmentNotFound(KozmoServerError):
...
class WorkerStop(KozmoServerError):
...
class WorkerError(KozmoServerError):
    """
    ...
    returned. This is to avoid issues with custom exceptions, like:
        ...
        https://github.com/kozmoai/kozmoserver/issues/881
    """
    ...
    def __init__(self, exc: BaseException):
        ...
        if isinstance(exc, KozmoServerError):
