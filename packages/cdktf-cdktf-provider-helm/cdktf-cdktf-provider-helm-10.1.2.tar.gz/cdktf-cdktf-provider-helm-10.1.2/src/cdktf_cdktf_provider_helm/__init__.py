'''
# CDKTF prebuilt bindings for hashicorp/helm provider version 2.13.2

This repo builds and publishes the [Terraform helm provider](https://registry.terraform.io/providers/hashicorp/helm/2.13.2/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
* [Terraform helm provider](https://registry.terraform.io/providers/hashicorp/helm/2.13.2)
