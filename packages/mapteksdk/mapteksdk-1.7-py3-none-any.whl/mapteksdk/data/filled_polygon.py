...
class Loop:
  ...
  def __init__(
    ...
    self.__owner = owner
    self.__point_indices: typing.Optional[MutableIndexSequence] = point_indices
    ...
    """
    self.__edge_indices: typing.Optional[MutableIndexSequence] = edge_indices
  ...
  @property
  def point_attributes(self) -> typing.MutableMapping[AttributeKey, np.ndarray]:
  ...
  @property
  def edge_attributes(self) -> typing.MutableMapping[AttributeKey, np.ndarray]:
  ...
  def remove_points(self, point_indices: int | typing.Sequence[int]):
    ...
    indices_to_delete = point_indices if isinstance(
      point_indices, typing.Sequence) else [point_indices]
...
class FilledPolygon(Topology):
  ...
  def __init__(
    ...
    if object_id is None:
      object_id = ObjectID(Modelling().NewEdgeLoopArea())
    ...
    self.__loops: typing.Optional[typing.MutableSequence[Loop]] = None
  ...
  @property
  def id(self) -> ObjectID[FilledPolygon]:
    return super().id

  @classmethod
  def static_type(cls):
    return Modelling().EdgeLoopAreaType()
  ...
  def _remove_points(self, point_indices: typing.Sequence[int]):
    ...
    result = Modelling().RemovePoints(
      self._lock.lock, array, index_count)
    self._reconcile_changes()
    return result

  @property
  def _loops(self) -> typing.MutableSequence[Loop]:
  ...
  @property
  def loops(self) -> typing.Sequence[Loop]:
  ...
  def __generate_loops(self) -> typing.MutableSequence[Loop]:
