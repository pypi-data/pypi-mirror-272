...
class UndoStack(typing.Sequence):
  """A stack of operations which can be undone in the application.

  Parameters
  ----------
  _can_send
    If the undo stack can be sent to the application.
    This is True by default.
  """
  def __init__(self, _can_send: bool=True) -> None:
    ...
    self._can_send = _can_send
    self._closed_error_message: typing.Optional[str]=None
