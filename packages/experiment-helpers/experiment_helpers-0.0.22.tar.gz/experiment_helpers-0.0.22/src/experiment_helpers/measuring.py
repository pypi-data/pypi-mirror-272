...
def get_vit_embeddings(vit_processor: ViTImageProcessor, vit_model: BetterViTModel, image_list:list,return_numpy:bool=True):
    ...
    print('vit_inputs[pixel_values].size()',vit_inputs['pixel_values'].size())
    ...
    print('vit_outputs.last_hidden_state.size()',vit_outputs.last_hidden_state.size())
    ...
    print('len(vit_outputs.past_key_values)',len(vit_outputs.past_key_values))
    try:
        print('vit_outputs.past_key_values[0].size()',vit_outputs.past_key_values[0].size())
    except:
        pass
    try:
        print('len vit_outputs.past_key_values[0]',len(vit_outputs.past_key_values[0]))
    except:
        pass
    try:
        print('vit_outputs.past_key_values[0][0].size()',vit_outputs.past_key_values[0][0].size())
    except:
        pass
