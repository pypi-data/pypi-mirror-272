...
def fin_read_day_list(instrument_id: str, period: str = 'day', start_date: int = 0, end_date: int = 99999999, base_path: str = ''):
    '''
    获取day数据
    :param instrument_id:合约编码
    :param period:周期
...
def fin_read_ohlc_list(instrument_id: str, period: str, start_date: int, end_date: int, base_path: str = ''):
    '''
    获取ohlc数据
    :param instrument_id:合约编码
    :param period:周期
...
def fin_save_tick_list(instrument_id, df, **kwargs):
    ...
    Returns:
        _type_: [bool,str]
    """
    return FinClient.instance().market_handle().fin_save_tick_list(instrument_id, df, "tick", **kwargs)


def fin_read_tick_list(instrument_id: str, start_date: int = 0, end_date: int = 99999999, period: str = 'tick', base_path: str = ''):
    '''
    获取basetick数据
    :param instrument_id:合约编码
