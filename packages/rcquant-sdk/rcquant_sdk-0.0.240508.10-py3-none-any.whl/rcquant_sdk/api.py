...
def fin_read_day_list(instrument_id: str, start_date: int = 0, end_date: int = 99999999, period: str = 'day', base_path: str = ''):
    '''
    获取day数据
    :param instrument_id:合约编码
    :param start_date 开始日期
...
def fin_read_ohlc_list(instrument_id: str, start_date: int = 0, end_date: int = 99999999, period: str = '1T', base_path: str = ''):
    '''
    获取ohlc数据
    :param instrument_id:合约编码
    :param start_date 开始日期
