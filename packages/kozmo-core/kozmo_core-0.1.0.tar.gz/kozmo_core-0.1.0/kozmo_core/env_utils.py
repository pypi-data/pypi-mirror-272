...
ENV_KOZMO_DEPLOYMENT_NAME = "KOZMO_DEPLOYMENT_ID"
...
def get_deployment_name(default_val: str = NONIMPLEMENTED_MSG) -> str:
    """
    Get deployment name from `ENV_KOZMO_DEPLOYMENT_NAME` environment variable.
    If not set return `default_val`
    ...
    """
    return os.environ.get(ENV_KOZMO_DEPLOYMENT_NAME, default_val)
