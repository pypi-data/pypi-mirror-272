...
try:
    #  Fix for https://github.com/kozmoai/kozmo-core/issues/1076
    #
    ...
    notice = textwrap.dedent(
        ...
        install `tensorflow` or install `kozmo_core` as

            $ pip install kozmo_core[tensorflow]

        or

            $ pip install kozmo_core[all]
        """
    )
    logger.info(notice)
