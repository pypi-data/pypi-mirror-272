...
from kozmo_core.microservice_tester import generate_batch, unfold_contract
from kozmo_core.kozmo_client import KozmoClient


def get_kozmo_client(args) -> KozmoClient:
    """
    Get the appropriate Kozmo Client based on args
...
def run_send_feedback(args):
    """
    Do a semd-feedback call to the Kozmo API
...
def run_predict(args):
    """
    Make a prediction call to the Kozmo API
