...
from kozmo_core.user_model import KozmoResponse, client_custom_metrics
...
class UserObject:
    def predict(self, X, features_names):
        ...
        return KozmoResponse(data=X, metrics=RUNTIME_METRICS, tags=RUNTIME_TAGS)

    def aggregate(self, X, features_names):
        logging.info("Aggregate called")
        return KozmoResponse(data=X[0], metrics=RUNTIME_METRICS, tags=RUNTIME_TAGS)
    ...
    def route(self, X, feature_names):
        ...
        return KozmoResponse(data=22, metrics=RUNTIME_METRICS, tags=RUNTIME_TAGS)
...
def test_generate_tags_key():
    ...
    insertion_order_tag = KozmoMetrics._generate_tags_key(insertion_order)
    sorted_order_tag = KozmoMetrics._generate_tags_key(sorted_order)
...
def test_kozmo_runtime_data_predict(cls, client_gets_metrics):
    user_object = cls()
...
@pytest.mark.parametrize("cls", [UserObject])
def test_kozmo_runtime_data_send_feedback(cls):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
    ...
    data = kozmo_metrics.data[os.getpid()]
    verify_kozmo_metrics(data, 1, [0.0202], FEEDBACK_METRIC_METHOD_TAG)

    expected_base_tags = {"method": FEEDBACK_METRIC_METHOD_TAG}
    base_tags_key = KozmoMetrics._generate_tags_key(expected_base_tags)

    assert data["COUNTER", "kozmo_api_model_feedback_reward", base_tags_key] == {
        "value": 42.0,
    ...
    data = kozmo_metrics.data[os.getpid()]
    verify_kozmo_metrics(data, 2, [0.0202, 0.0202], FEEDBACK_METRIC_METHOD_TAG)
...
@pytest.mark.parametrize("cls", [UserObject])
def test_kozmo_runtime_data_aggregate(cls, client_gets_metrics):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
...
@pytest.mark.parametrize("cls", [UserObject])
def test_kozmo_runtime_data_transform_input(cls, client_gets_metrics):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
...
@pytest.mark.parametrize("cls", [UserObject])
def test_kozmo_runtime_data_transform_output(cls, client_gets_metrics):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
...
@pytest.mark.parametrize("cls", [UserObject])
def test_kozmo_runtime_data_route(cls, client_gets_metrics):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
...
@pytest.mark.parametrize("cls", [UserObject])
def test_proto_kozmo_runtime_data_predict(cls, client_gets_metrics):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
...
@pytest.mark.parametrize("cls", [UserObject])
def test_proto_kozmo_runtime_data_aggregate(cls, client_gets_metrics):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
...
@pytest.mark.parametrize("cls", [UserObject])
def test_proto_kozmo_runtime_data_transform_input(cls, client_gets_metrics):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
...
@pytest.mark.parametrize("cls", [UserObject])
def test_proto_kozmo_runtime_data_transform_output(cls, client_gets_metrics):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
...
@pytest.mark.parametrize("cls", [UserObject])
def test_proto_kozmo_runtime_data_route(cls, client_gets_metrics):
    user_object = cls()
    kozmo_metrics = KozmoMetrics()
