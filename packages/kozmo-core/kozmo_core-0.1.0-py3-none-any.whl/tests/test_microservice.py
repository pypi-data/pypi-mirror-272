...
from kozmo_core import __version__, microservice
...
@mock.patch("kozmo_core.microservice.os.path.isfile", return_value=True)
def test_load_annotations(mock_isfile):
    ...
    for data, expected_annotation in read_data:
        with mock.patch("kozmo_core.microservice.open", return_value=StringIO(data)):
