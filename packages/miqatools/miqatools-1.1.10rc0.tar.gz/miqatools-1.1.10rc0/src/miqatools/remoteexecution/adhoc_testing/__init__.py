...
from src.miqatools.remoteexecution.adhoc_execution import create_and_upload_to_new_version_for_ds
from src.miqatools.datamanagement.datasethelpers import create_dataset_and_add_truths, get_ds_ids_by_name
...
def check_results_for_dataset_with_truths(miqa_server, org_config_id, workflow_id, dataset_name, version_name, directory_containing_outputs, api_key, recall_threshold=0.9, precision_threshold=0.9, raise_on_fail=False, filepattern_end=None, filepattern_start=None, exclude_filepattern_end=None, max_filesize=None, max_connections=None, filepatterns=None, quiet=True, per_request_timeout=None, parallel_file_upload=True, detailed_file_logs=False):
    ...
    exec_id = create_and_upload_to_new_version_for_ds(miqa_server, version_name, dataset_name, pipeline_id, workflow_id,
                                                      org_config_id if org_config_id else org_id, api_key,
...
directory_containing_outputs = "/Users/boysenberry/Desktop/test-data/demo_vcf_S21_2/"
truth_file_path = r"/Users/gwennberry/Downloads/dummy_truth.tsv"
# res = create_dataset_with_truths_and_check_results("awstest.magnalabs.co", 1, 330, "new_test_may9-8", truth_file_path, "May9version", directory_containing_outputs, "II8zzDgY92mJoEDCViX_oYiSIwGcHgxBAqCTLQnzQGxd4xCZKXZdhg")
res = check_results_for_dataset_with_truths("awstest.magnalabs.co", 1, 330, "new_test_may9-8", "May9version", directory_containing_outputs, "II8zzDgY92mJoEDCViX_oYiSIwGcHgxBAqCTLQnzQGxd4xCZKXZdhg")
print(res)
