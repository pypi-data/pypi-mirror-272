...
MACHINE_ORGANIZATION_NAME = 'inventing-machine'  # or other organization
PRIVATE_REPO_WITH_TEXT = 'inventing_machine'
...
INVENTING_MACHINE = yaml.load(MACHINE_YAML, Loader=yaml.FullLoader)
