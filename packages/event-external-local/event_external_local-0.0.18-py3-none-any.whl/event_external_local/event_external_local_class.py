...
class EventExternalsLocal(GenericCRUD):
    ...
    def insert(self, event_external_dict: dict = None, is_test_date: bool = False) -> int:
        ...
        logger.start("start insert event_external", object={'event_external_json': event_external_dict})
    ...
    def update_by_event_external_id(self, event_external_id: int, event_external_json: dict) -> None:
        ...
        super().update_by_id(id_column_value=event_external_id, data_json=event_external_json)
        logger.end("end update_by_event_external_id event_external")
