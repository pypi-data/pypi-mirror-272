...
import sage_tokenizer.embeddings as emb
import sage_tokenizer.utils as utils
from sage_tokenizer.model import SaGeTokenizer
from sage_tokenizer.Word2VecParams import Word2VecParams
...
class SaGeVocabBuilder:
    ...
    def build_vocab(self, experiment_name: str, corpus_filepath: str, vocabulary_filepath: str,
        ...
        utils.set_random_seed(experiment_name, self.random_seed)
        ...
        embeddings = emb.get_embeddings(vocab_schedule[0], embeddings_folder, partial_corpus, sage_model,
        ...
        while i < len(vocab_schedule) - 1:
            ...
            if vocab_schedule[i] in embedding_sizes:
                embeddings = emb.get_embeddings(current_step_vocab_size, embeddings_folder, partial_corpus, sage_model,
                                                self.workers_number, self.word2vec_params)
            ...
            total_tokens, total_triples, token_to_losses, ablated_sizes = utils.run_sage_parallel(embeddings,
                                                                                                  partial_corpus,
                                                                                                  sage_model,
                                                                                                  self.workers_number)
