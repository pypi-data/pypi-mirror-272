...
def add_title_subtitle(fig: Figure, title: str, subtitle: str, wrapping_factor: float = 0.8, subtitle_bottom_margin: float = 20, title_bottom_margin: float = None):
    ...
    title_xytext = (0, subtitle_height + 15) if title_bottom_margin is None else (0, title_bottom_margin)
