                        ...
                        if ne(data_label_filtered_list):
                            if ne(sticky_items):
                                for index, item in enumerate(sticky_items):
                                    data_label_filtered_list.insert(index, data_label_list[item])
    ...
    class DATA(
        ...
        class FORMAT:
            ...
            def console_message(text: str) -> str:
                return text.replace("<b>", Style.BRIGHT).replace("</b>", Style.RESET_ALL).replace("<i>", "").replace("</i>", "").replace("<li>", "").replace("</li>", "")
                
            @staticmethod
            def whatsapp_message(value: str) -> str:
                b: str = CONST.MESSAGE.WHATSAPP.STYLE.BOLD
                i: str =  CONST.MESSAGE.WHATSAPP.STYLE.ITALIC
                return value.replace("<b>", b).replace("</b>", b).replace("<i>", i).replace("</i>", i).replace("<li>", "").replace("</li>", "")
            ...
            class WAPPI:
                class QUEUE:
                    ...
                    def add_message(
                        ...
                        message.message = PIH.DATA.FORMAT.whatsapp_message(message.message)
                        return DataTool.rpc_decode(
                            PIH.SERVICE.call_command(
