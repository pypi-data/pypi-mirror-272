...
`,h=r.iK.div`
  ...
  padding-top: 16px;
`;function p(e){let{description:t,onConfirm:i,onHide:r,open:p,title:u}=e;const[m,f]=(0,n.useState)(!0),[g,b]=(0,n.useState)(""),v=()=>{b(""),i()};return(0,c.tZ)(o.default,{disablePrimaryButton:m,onHide:()=>{b(""),r()},onHandledPrimaryAction:v,primaryButtonName:(0,l.t)("delete"),primaryButtonType:"danger",show:p,title:u},(0,c.tZ)(h,null,t),(0,c.tZ)(d,null,(0,c.tZ)(s.lX,{htmlFor:"delete"},(0,l.t)('Type "%s" to confirm',(0,l.t)("DELETE"))),(0,c.tZ)(a.II,{type:"text",id:"delete",autoComplete:"off",value:g,onChange:e=>{var t;const i=null!=(t=e.target.value)?t:"";f(i.toUpperCase()!==(0,l.t)("DELETE")),b(i)},onPressEnter:()=>{m||v()}})))}},36674:(e,t,i)=>{i.d(t,{Z:()=>d});var r=i(67294),l=i(51995),n=i(11965),a=i(61988),o=i(58593),s=i(13322);const c=l.iK.a`
...
//# sourceMappingURL=4717.cdebc9201dca90c7d328.entry.js.map