"""This code only tests whether the corresponding optimizer could run or not.
  ...
  For the correctness validation of programming, refer to the following link:
    https://github.com/Evolutionary-Intelligence/pypop/blob/main/pypop7/optimizers/es/_repeat_vkdcma.py
"""
import unittest
import time
...
from pypop7.optimizers.es.vkdcma import VKDCMA as Solver


class TestVKDCMA(unittest.TestCase):
