"""PyPop7 is a Pure-PYthon library of POPulation-based (e.g., evolutionary/swarm) OPtimization for single-objective,
    real-parameter, black-box problems. Its main goal is to provide a **unified** interface and **elegant**
    implementations for Black-Box Optimization (BBO), particularly population-based optimizers, in order to
    facilitate research repeatability, BBO benchmarking, and also (possible) real-world applications.
