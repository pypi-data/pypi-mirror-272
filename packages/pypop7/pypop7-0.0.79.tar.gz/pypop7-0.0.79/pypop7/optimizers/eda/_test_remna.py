"""This code only tests whether the corresponding optimizer could run or not.
  ...
  For the correctness validation of programming, refer to the following link:
    https://github.com/Evolutionary-Intelligence/pypop/blob/main/pypop7/optimizers/eda/_repeat_emnawa.py
"""
import unittest
import time
...
from pypop7.optimizers.eda.remna import REMNA as Solver


class TestREMNA(unittest.TestCase):
