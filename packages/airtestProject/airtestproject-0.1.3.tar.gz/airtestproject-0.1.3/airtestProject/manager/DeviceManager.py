...
class DeviceManager:
    ...
    def auto_setup(self, file_path=None, device_ids=None, logdir=False):
        """Airtest 设备连接
        :param file_path: 脚本文件目录
        :param logdir: 日志保存路径
        ...
        if logdir is True:
            self.logdir = os.path.join(get_folder_path_up(self.file_path, "log"), r"{}-{}.log".format(self.file_name,
                                                                                                      datetime.datetime
                                                                                                      .now()
                                                                                                      .strftime(
                                                                                                          '%Y-%m-%d_'
                                                                                                          '%H-%M-%S')))
        self.report_path = os.path.join(get_folder_path_up(self.file_path, "reports"), r"reports.{}-{}"
