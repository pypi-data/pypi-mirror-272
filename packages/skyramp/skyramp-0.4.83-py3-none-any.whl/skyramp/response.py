...
class _ResponseValue:
    ...
    def __init__(self,
        ...
        Args:
            ...
            content_type: Content Type of payload (e.g., application/json, application/xml)
        """
        self.name = name
        ...
        if blob_override is not None:
            self.blobOverride = blob_override
    ...
    def to_json(self):
        ...
        if hasattr(self, 'blobOverride') and self.blobOverride is not None:
            response["blobOverride"] = self.blobOverride
