from va.utils.misc import floatohex, scale_values, float_to_hex
...
def local_resolution_json(map, inmodels, radius):
    ...
    for model in models:
        ...
        data_result['color'] = [float_to_hex(i) for i in scale_values(allvalues, 1, 0)]
...
def local_resolution_views(input_json, map_name, data_type, chimerax_bin_dir):
    """
    ...
    viewer = ChimeraxViews(input_json, chimerax_bin_dir)
    root_data = viewer.get_root_data(data_type)
    viewer.get_views(root_data, map_name, data_type)