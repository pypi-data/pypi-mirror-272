...
def chain(
    cmd_1: Cmd[ResultE[_T]], cmd_2: Callable[[_T], Cmd[_S]]
) -> Cmd[ResultE[_S]]:
    """
    ...
    return cmd_1.bind(
        ...
        .alt(lambda e: Cmd.from_cmd(lambda: _factory.failure(e)))
        .to_union()
    )


def chain_results(
    cmd_1: Cmd[ResultE[None]], cmd_2: Cmd[ResultE[_S]]
) -> Cmd[ResultE[_S]]:
