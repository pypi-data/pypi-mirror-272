...
# _component_func = components.declare_component(
#     "mycomponent",
#     path=r"D:\Streamlit Custom Components\streamlit-custom-sidebar-v2\template\streamlit_custom_sidebar\Streamlit_template"
# )

def myComponent(key="testing", default="home"):

    component_value = _component_func( key=key, default=default)
...
class CustomSidebarDefault:
                        ...
                        if (sidebar.length < 1){{
                            ...
                            if ("{self.loadPageName}" === "None"){{
                                ...
                                if (pageName_ === ""){{
                                    ...
                                    {self.storageChoice}.setItem("clickedPage", JSON.stringify({{"clickedPage":pageName_to_save}}));
                                ...
                                {self.storageChoice}.setItem("clickedPage", JSON.stringify({{"clickedPage":"{self.loadPageName}"}}));
                            ...
                            if ("{self.closeSidebarBtnColor}" !== "auto"){{
                                ...
                                {self.data}.forEach((el) => {{
                                    ...
                                    if ("{self.loadPageName}" === "None"){{
                                        ...
                                        if (el.page_name === currentPageLocalS){{
    ...
    def active_navigation_alternative(self):
                    ...
                    <script>
                        ...
                        navigationTabs.forEach((c) => {{
                            c.addEventListener("click", (e) => {{
                                ...
                                var clickedNav = c.querySelectorAll('span')[0].getAttribute('data-testid')
                                console.log(clickedNav)

                                clickedNav.addEventListener("change", function() {
                                    sendDataToPython({
                                    value: clickedNav.value,
                                    dataType: "json",
                                    });
                                })
    ...
    def load_custom_sidebar(self):
        ...
        self.sidebarCreate()
        # self.active_navigation_alternative() 
        # self.loadCurrentPagePostClick()
