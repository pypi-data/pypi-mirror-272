...
class HoverExpandSidebarTemplate:
    ...
    def sidebarCreate(self):
        ...
        #                     sidebarCloseBtnContainer.style = "visibility:hidden; padding: 4px; border-radius: 4px; width: fit-content; position: absolute; top: 10px; right: 10px;";
        #                     const sidebarCloseBtn = document.createElement("div");
        #                     sidebarCloseBtn.className = "close-sidebar-btn"
        #                     sidebarCloseBtn.style = "font-size: 24px;";
        ...
        #                     sidebarCloseBtnIcon.innerText = 'close';
        #                     sidebarCloseBtnIcon.style.color = "white";
        ...
        #                     newSidebar[0].appendChild(sidebarCloseBtnContainer); 
    ...
    def responsive_sidebar_changes(self):

        js_el_ = f'''

                    smallScreenMatch = window.top.matchMedia("(max-width: 1023px)");
                    console.log(smallScreenMatch.matches);
