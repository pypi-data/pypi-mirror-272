                            ...
                            {self.base_data}.length > 0 && {self.base_data}.forEach((el) => {{ 
                                ...
                                if ("{self.loadPageName}" === "None"){{
                                    ...
                                    if (el.page_name === pageName_){{
                                        ...
                                        baseContainer.style = 'background-color:{self.activeBackgroundColor} !important; border-radius: 4px; cursor: pointer; display: flex; align-items: center; padding: 12px; width: 100%; height: 49px;';                                  
                                    }} 
                                    ...
                                    if (el.page_name === "{self.loadPageName}"){{
                                        baseContainer.id = "active-element";   
                                        baseContainer.style = 'overflow:hidden; background-color:{self.activeBackgroundColor} !important; border-radius: 4px; cursor: pointer; display: flex; align-items: center; padding: 12px; width: 100%; height: 49px;';                                                                                                 
