        ...
        js_el = f'''
                    ...
                    <script>
                        ...
                        if (sidebar.length < 1){{
                            ...
                            logoText.style = "font-size: {self.logoTextSize}; color:{self.logoTextColor}; margin-left:{self.logoTextDistance};";           
