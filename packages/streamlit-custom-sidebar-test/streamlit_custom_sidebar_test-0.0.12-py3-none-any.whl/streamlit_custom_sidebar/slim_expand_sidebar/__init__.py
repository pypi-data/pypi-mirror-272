...
class HoverExpandSidebarTemplate:
    ...
    def __init__(self, backgroundColor="black", activeBackgroundColor="white", navigationHoverBackgroundColor="rgba(255,255,255,0.35)", labelIconSizeNav="17px", labelIconSizeBase="22px", distanceIconLabel="12px", labelIconColorNotActive="#fff", labelIconColorActive="black", loadPageName=None, logoImg='https://lh3.googleusercontent.com/3bXLbllNTRoiTCBdkybd1YzqVWWDRrRwJNkVRZ3mcf7rlydWfR13qJlCSxJRO8kPe304nw1jQ_B0niDo56gPgoGx6x_ZOjtVOK6UGIr3kshpmTq46pvFObfJ2K0wzoqk36MWWSnh0y9PzgE7PVSRz6Y', logoImgWidth="49px", logoTextColor="white", logoImgHeight="49px", logoTextSize="30px", data=None, base_data=None, webMedium="local", iframeContainer=None) -> None: 
        ...
        js_el = f'''
                    ...
                    <script>
                        ...
                        if (sidebar.length < 1){{
                            ...
                            createEL.style = "position:relative; padding: 1rem .8rem; width: 70px; height: 97.5vh; margin: 10px; border-radius: 0.85rem; box-shadow: rgba(50, 50, 93, 0.25) 0px 2px 5px -1px, rgba(0, 0, 0, 0.3) 0px 1px 3px -1px; background-color:{self.backgroundColor}; z-index:999991; transition: 0.5s ease; cursor:pointer;";
                            ...
                            div.innerText = '{self.logoText}';  
                            logoText.style = "font-size: {self.logoTextSize}; color:{self.logoTextColor};";           
