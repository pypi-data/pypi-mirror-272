...
class ZIP:
    @staticmethod
    def Create(inputPath: str, outputPath: str = None, compressionLevel: int = None, ignoreErrors=False):
...
class SevenZip:
    @staticmethod
    def Create(inputPath: str, outputPath: str = None, useCompression=True, password: str = None, ignoreErrors=False):
        """Compresses file or folder to zip archive
