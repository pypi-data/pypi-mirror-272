...
def main():
    ...
    try:
        ...
        print("Some errors occurred when copying system config, but that's ok")

    try:
        shutil.copytree(src_user, temp_user)
    except Exception as e:
        print("Some errors occurred when copying user config, but that's ok")
    ...
    try:
        ...
        print("Error while removing temp dir")
