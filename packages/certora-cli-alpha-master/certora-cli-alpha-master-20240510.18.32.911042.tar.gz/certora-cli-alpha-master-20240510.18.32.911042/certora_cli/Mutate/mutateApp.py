    ...
    def validate_mutants_in_source_tree(self) -> None:
        ...
        for mutant in self.manual_mutants:
            ...
            if not (cwd_in_orig / file_to_mutate).exists():
                raise Util.CertoraUserInputError(f"The mutated file, {file_to_mutate}, does not affect verification "
                                                 "results. Please remove or replace the mutation")
