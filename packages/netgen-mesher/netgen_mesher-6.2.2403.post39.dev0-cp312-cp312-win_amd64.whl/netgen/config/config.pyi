...
NETGEN_VERSION: str = '6.2.2403-39-g7d408f1e'
NETGEN_VERSION_GIT: str = 'v6.2.2403-39-g7d408f1e'
NETGEN_VERSION_HASH: str = 'g7d408f1e'
NETGEN_VERSION_MAJOR: str = '6'
NETGEN_VERSION_MINOR: str = '2'
NETGEN_VERSION_PATCH: str = '2403'
NETGEN_VERSION_PYTHON: str = '6.2.2403.post39.dev'
NETGEN_VERSION_TWEAK: str = '39'
...
ngcore_compile_definitions: str = 'NETGEN_PYTHON;NG_PYTHON;PYBIND11_SIMPLE_GIL_MANAGEMENT;_WIN32_WINNT=0x1000;WNT;WNT_WINDOW;NOMINMAX;MSVC_EXPRESS;_CRT_SECURE_NO_WARNINGS;HAVE_STRUCT_TIMESPEC;WIN32;PARALLEL'
ngcore_compile_options: str = '/arch:AVX2;/bigobj;$<BUILD_INTERFACE:/MP;/W1;/wd4068>'
version: str = 'v6.2.2403-39-g7d408f1e'
