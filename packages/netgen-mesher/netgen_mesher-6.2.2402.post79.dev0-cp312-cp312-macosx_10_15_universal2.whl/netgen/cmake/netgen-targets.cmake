...
foreach(_cmake_expected_target IN ITEMS netgen_metis ngcore nggui ngpy ngguipy togl nglib netgen_cgns)
...
set_target_properties(netgen_metis PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "METIS"
  INTERFACE_INCLUDE_DIRECTORIES "/opt/homebrew/include"
  INTERFACE_LINK_LIBRARIES "/opt/homebrew/lib/libmetis.dylib"
)
...
set_target_properties(ngcore PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "NETGEN_PYTHON;NG_PYTHON;PYBIND11_SIMPLE_GIL_MANAGEMENT;PARALLEL"
...
set_target_properties(nggui PROPERTIES
  INTERFACE_LINK_LIBRARIES "nglib;togl;/usr/local/lib/libmpi.dylib;/Library/Developer/CommandLineTools/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/OpenGL.framework;/Library/Developer/CommandLineTools/SDKs/MacOSX13.1.sdk/System/Library/Frameworks/OpenGL.framework;nglib"
)
