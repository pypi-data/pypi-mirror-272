...
MACHINE_ORGANIZATION_NAME = 'machina-observatrix'  # or other organization
PRIVATE_REPO_WITH_TEXT = 'machina_observatrix'
...
MACHINA_OBSERVATRIX = yaml.load(MACHINE_YAML, Loader=yaml.FullLoader)
