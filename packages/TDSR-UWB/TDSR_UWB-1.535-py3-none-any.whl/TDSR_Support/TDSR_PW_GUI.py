...
## GUI
    def initGUI(self):
        ...
        self.dropMenuPRF.setStyleSheet("QComboBox {color: black; background-color: white; selection-color: white; selection-background-color: DarkBlue;}")
        ...
        self.dropMenuPreamLen.setStyleSheet("QComboBox {color: black; background-color: white; selection-color: white; selection-background-color: DarkBlue;}")
        ...
        self.dropMenuBitRate.setStyleSheet("QComboBox {color: black; background-color: white; selection-color: white; selection-background-color: DarkBlue;}")
        ...
        self.dropMenuPAC.setStyleSheet("QComboBox {color: black; background-color: white; selection-color: white; selection-background-color: DarkBlue;}")
        ...
        self.dropMenuChannel.setStyleSheet("QComboBox {color: black; background-color: white; selection-color: white; selection-background-color: DarkBlue;}")
        ...
        self.dropMenuPreamCode.setStyleSheet("QComboBox {color: black; background-color: white; selection-color: white; selection-background-color: DarkBlue;}")
