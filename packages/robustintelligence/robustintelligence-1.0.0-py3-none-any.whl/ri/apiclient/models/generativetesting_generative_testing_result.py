...
class GenerativetestingGenerativeTestingResult(BaseModel):
    """
    ...
    severity: Optional[RimeSecurityRisk] = None
    owasp_standards: Optional[List[GenerativetestingGenerativeTestingResultStandardInfo]] = Field(default=None, description="Containers describing the various AI risk standards associated with this batch of attack examples.", alias="owaspStandards")
    nist_standards: Optional[List[GenerativetestingGenerativeTestingResultStandardInfo]] = Field(default=None, alias="nistStandards")
    mitre_standards: Optional[List[GenerativetestingGenerativeTestingResultStandardInfo]] = Field(default=None, alias="mitreStandards")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GenerativetestingGenerativeTestingResult from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GenerativetestingGenerativeTestingResult from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "owaspStandards": [GenerativetestingGenerativeTestingResultStandardInfo.from_dict(_item) for _item in obj["owaspStandards"]] if obj.get("owaspStandards") is not None else None,
            "nistStandards": [GenerativetestingGenerativeTestingResultStandardInfo.from_dict(_item) for _item in obj["nistStandards"]] if obj.get("nistStandards") is not None else None,
            "mitreStandards": [GenerativetestingGenerativeTestingResultStandardInfo.from_dict(_item) for _item in obj["mitreStandards"]] if obj.get("mitreStandards") is not None else None,
