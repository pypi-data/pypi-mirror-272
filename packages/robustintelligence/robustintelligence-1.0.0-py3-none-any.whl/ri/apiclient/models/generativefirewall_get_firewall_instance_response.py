...
class GenerativefirewallGetFirewallInstanceResponse(BaseModel):
    """
    GenerativefirewallGetFirewallInstanceResponse
    """ # noqa: E501
    firewall_instance: Optional[GenerativefirewallFirewallInstanceInfo] = Field(default=None, alias="firewallInstance")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "firewallInstance": GenerativefirewallFirewallInstanceInfo.from_dict(obj["firewallInstance"]) if obj.get("firewallInstance") is not None else None
        })
        return _obj
