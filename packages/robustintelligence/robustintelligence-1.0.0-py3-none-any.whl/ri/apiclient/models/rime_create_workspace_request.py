...
class RimeCreateWorkspaceRequest(BaseModel):
    """
    RimeCreateWorkspaceRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the Workspace.")
    agent_ids: Optional[List[RimeUUID]] = Field(default=None, description="List of Agent IDs to be added to the Workspace.", alias="agentIds")
