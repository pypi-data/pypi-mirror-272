...
class RimeGetDatapointsResponse(BaseModel):
    """
    RimeGetDatapointsResponse
    """ # noqa: E501
    datapoints: Optional[List[DatacollectorDatapoint]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datapoints": [DatacollectorDatapoint.from_dict(_item) for _item in obj["datapoints"]] if obj.get("datapoints") is not None else None
        })
        return _obj
