...
class JobDataContinuousIncrementalTest(BaseModel):
    """
    ...
    progress: Optional[RimeContinuousTestJobProgress] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "progress": RimeContinuousTestJobProgress.from_dict(obj["progress"]) if obj.get("progress") is not None else None
        })
        return _obj
