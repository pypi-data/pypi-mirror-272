...
class RimeGetValidateDatasetTaskStatusResponse(BaseModel):
    """
    RimeGetValidateDatasetTaskStatusResponse
    """ # noqa: E501
    resp: Optional[ValidationValidateDatasetResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resp": ValidationValidateDatasetResponse.from_dict(obj["resp"]) if obj.get("resp") is not None else None,
