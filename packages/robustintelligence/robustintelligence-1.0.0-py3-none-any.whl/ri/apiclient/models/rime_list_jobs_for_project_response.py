...
class RimeListJobsForProjectResponse(BaseModel):
    """
    RimeListJobsForProjectResponse
    """ # noqa: E501
    jobs: Optional[List[RimeJobMetadata]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "jobs": [RimeJobMetadata.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
