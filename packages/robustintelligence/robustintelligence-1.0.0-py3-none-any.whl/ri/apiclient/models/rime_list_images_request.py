...
class RimeListImagesRequest(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pipLibraries": [ListImagesRequestPipLibraryFilter.from_dict(_item) for _item in obj["pipLibraries"]] if obj.get("pipLibraries") is not None else None
        })
        return _obj
