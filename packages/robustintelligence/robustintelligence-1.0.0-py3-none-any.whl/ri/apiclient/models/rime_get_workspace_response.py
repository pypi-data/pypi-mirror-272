...
class RimeGetWorkspaceResponse(BaseModel):
    """
    RimeGetWorkspaceResponse
    """ # noqa: E501
    workspace: Optional[RimeWorkspace] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workspace": RimeWorkspace.from_dict(obj["workspace"]) if obj.get("workspace") is not None else None
        })
        return _obj
