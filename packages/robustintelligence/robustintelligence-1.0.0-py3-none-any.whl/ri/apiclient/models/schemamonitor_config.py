...
class SchemamonitorConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    degradation: Optional[MonitorMetricDegradationConfig] = None
    ...
    __properties: ClassVar[List[str]] = ["degradation", "anomaly"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "degradation": MonitorMetricDegradationConfig.from_dict(obj["degradation"]) if obj.get("degradation") is not None else None,
