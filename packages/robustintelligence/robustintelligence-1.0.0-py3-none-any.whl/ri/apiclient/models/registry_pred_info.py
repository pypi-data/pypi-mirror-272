...
class RegistryPredInfo(BaseModel):
    """
    ...
    pred_params: Optional[RegistryPredictionParams] = Field(default=None, alias="predParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "predParams": RegistryPredictionParams.from_dict(obj["predParams"]) if obj.get("predParams") is not None else None
        })
        return _obj
