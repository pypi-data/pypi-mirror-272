...
class RegistryServiceRegisterModelRequest(BaseModel):
    """
    ...
    model_info: Optional[SchemaregistryModelInfo] = Field(default=None, alias="modelInfo")
    ...
    __properties: ClassVar[List[str]] = ["projectId", "name", "metadata", "externalId", "modelInfo", "integrationId", "skipValidation", "agentId", "modelEndpointIntegrationId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegistryServiceRegisterModelRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegistryServiceRegisterModelRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "modelInfo": SchemaregistryModelInfo.from_dict(obj["modelInfo"]) if obj.get("modelInfo") is not None else None,
