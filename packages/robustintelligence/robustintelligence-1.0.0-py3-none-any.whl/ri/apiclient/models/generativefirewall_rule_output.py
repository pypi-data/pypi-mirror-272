...
class GenerativefirewallRuleOutput(BaseModel):
    ...
    regulatory_standards: Optional[List[ApigenerativefirewallStandardInfo]] = Field(default=None, description="Standards encodes which regulatory standards (MITRE, OWASP) are addressed by this firewall rule.", alias="regulatoryStandards")
    __properties: ClassVar[List[str]] = ["ruleName", "action", "riskCategory", "piiDetectionDetails", "languageDetectionDetails", "promptInjectionDetails", "toxicityDetectionDetails", "codeDetectionDetails", "ruleEvalMetadata", "regulatoryStandards"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in regulatory_standards (list)
        _items = []
        if self.regulatory_standards:
            for _item in self.regulatory_standards:
                if _item:
                    _items.append(_item.to_dict())
            _dict['regulatoryStandards'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "regulatoryStandards": [ApigenerativefirewallStandardInfo.from_dict(_item) for _item in obj["regulatoryStandards"]] if obj.get("regulatoryStandards") is not None else None
        })
        return _obj
