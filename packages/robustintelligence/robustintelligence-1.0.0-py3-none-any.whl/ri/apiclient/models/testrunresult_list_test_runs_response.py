...
class TestrunresultListTestRunsResponse(BaseModel):
    ...
    """ # noqa: E501
    test_runs: Optional[List[TestrunresultTestRunDetail]] = Field(default=None, description="The details of the test runs.", alias="testRuns")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testRuns": [TestrunresultTestRunDetail.from_dict(_item) for _item in obj["testRuns"]] if obj.get("testRuns") is not None else None,
