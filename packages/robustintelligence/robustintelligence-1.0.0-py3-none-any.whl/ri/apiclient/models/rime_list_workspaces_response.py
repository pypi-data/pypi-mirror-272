...
class RimeListWorkspacesResponse(BaseModel):
    """
    RimeListWorkspacesResponse
    """ # noqa: E501
    workspaces: Optional[List[RimeWorkspace]] = None
    ...
    __properties: ClassVar[List[str]] = ["workspaces", "nextPageToken", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workspaces": [RimeWorkspace.from_dict(_item) for _item in obj["workspaces"]] if obj.get("workspaces") is not None else None,
