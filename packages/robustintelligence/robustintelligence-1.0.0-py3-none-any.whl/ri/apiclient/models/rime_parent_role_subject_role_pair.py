...
class RimeParentRoleSubjectRolePair(BaseModel):
    """
    ...
    """ # noqa: E501
    subject_role: Optional[RimeActorRole] = Field(default=None, alias="subjectRole")
    parent_role: Optional[RimeActorRole] = Field(default=None, alias="parentRole")
    __properties: ClassVar[List[str]] = ["subjectRole", "parentRole"]
