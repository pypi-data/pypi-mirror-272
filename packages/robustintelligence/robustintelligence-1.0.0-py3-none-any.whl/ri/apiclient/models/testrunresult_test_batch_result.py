...
class TestrunresultTestBatchResult(BaseModel):
    ...
    failing_features: Optional[List[StrictStr]] = Field(default=None, description="The list of failing features.  The metrics computed in the test.", alias="failingFeatures")
