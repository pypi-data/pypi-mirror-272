...
class RimeListMonitorsResponse(BaseModel):
    """
    RimeListMonitorsResponse
    """ # noqa: E501
    monitors: Optional[List[MonitorMonitor]] = Field(default=None, description="The list of monitors.")
    ...
    __properties: ClassVar[List[str]] = ["monitors", "nextPageToken", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "monitors": [MonitorMonitor.from_dict(_item) for _item in obj["monitors"]] if obj.get("monitors") is not None else None,
