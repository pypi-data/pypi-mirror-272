...
class RimeGetValidateModelTaskStatusResponse(BaseModel):
    """
    RimeGetValidateModelTaskStatusResponse
    """ # noqa: E501
    resp: Optional[ValidationValidateModelResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resp": ValidationValidateModelResponse.from_dict(obj["resp"]) if obj.get("resp") is not None else None,
