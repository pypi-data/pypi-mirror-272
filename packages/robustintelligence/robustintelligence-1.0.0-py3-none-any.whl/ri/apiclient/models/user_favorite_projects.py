...
class UserFavoriteProjects(BaseModel):
    """
    Up to 3 favorite project_ids for each workspace.
    """ # noqa: E501
    workspace_id: Optional[RimeUUID] = Field(default=None, alias="workspaceId")
    project_ids: Optional[List[RimeUUID]] = Field(default=None, alias="projectIds")
    __properties: ClassVar[List[str]] = ["workspaceId", "projectIds"]
