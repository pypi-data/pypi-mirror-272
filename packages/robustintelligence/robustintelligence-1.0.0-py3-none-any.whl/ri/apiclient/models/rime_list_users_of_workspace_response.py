...
class RimeListUsersOfWorkspaceResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["workspaceId", "users", "nextPageToken", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [RimeUserDetailWithRole.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
