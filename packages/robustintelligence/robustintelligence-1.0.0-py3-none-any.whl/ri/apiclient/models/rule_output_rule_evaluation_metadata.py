...
class RuleOutputRuleEvaluationMetadata(BaseModel):
    """
    RuleOutputRuleEvaluationMetadata
    """ # noqa: E501
    evaluation_models: Optional[Dict[str, RuleOutputRuleEvaluationMetadataModelInfo]] = Field(default=None, description="Map from the name of the model (`prompt-injection`, `toxicity`) to information about how it was used in evaluation.", alias="evaluationModels")
    __properties: ClassVar[List[str]] = ["evaluationModels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "evaluationModels": dict(
                (_k, RuleOutputRuleEvaluationMetadataModelInfo.from_dict(_v))
