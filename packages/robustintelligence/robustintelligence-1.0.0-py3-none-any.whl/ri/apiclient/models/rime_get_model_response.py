...
class RimeGetModelResponse(BaseModel):
    """
    RimeGetModelResponse
    """ # noqa: E501
    model: Optional[RimeModelWithOwnerDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model": RimeModelWithOwnerDetails.from_dict(obj["model"]) if obj.get("model") is not None else None
        })
        return _obj
