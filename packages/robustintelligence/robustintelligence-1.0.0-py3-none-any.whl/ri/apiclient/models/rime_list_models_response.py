...
class RimeListModelsResponse(BaseModel):
    """
    RimeListModelsResponse
    """ # noqa: E501
    models: Optional[List[RimeModelWithOwnerDetails]] = None
    ...
    __properties: ClassVar[List[str]] = ["models", "nextPageToken", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [RimeModelWithOwnerDetails.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
