...
class StatedbArchivedJobLogs(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "url": RimeSafeURL.from_dict(obj["url"]) if obj.get("url") is not None else None,
