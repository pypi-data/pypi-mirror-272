...
class RimeListPredictionSetsResponse(BaseModel):
    """
    RimeListPredictionSetsResponse
    """ # noqa: E501
    predictions: Optional[List[RegistrypredictionPrediction]] = None
    ...
    __properties: ClassVar[List[str]] = ["predictions", "nextPageToken", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "predictions": [RegistrypredictionPrediction.from_dict(_item) for _item in obj["predictions"]] if obj.get("predictions") is not None else None,
