...
class RimeContinuousTestJobProgress(BaseModel):
    """
    RimeContinuousTestJobProgress
    """ # noqa: E501
    test_runs: Optional[List[RimeContinuousTestRunProgress]] = Field(default=None, alias="testRuns")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "testRuns": [RimeContinuousTestRunProgress.from_dict(_item) for _item in obj["testRuns"]] if obj.get("testRuns") is not None else None
        })
        return _obj
