...
class RimeGetPredictionsResponse(BaseModel):
    """
    RimeGetPredictionsResponse
    """ # noqa: E501
    predictions: Optional[List[SchemadatacollectorPrediction]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "predictions": [SchemadatacollectorPrediction.from_dict(_item) for _item in obj["predictions"]] if obj.get("predictions") is not None else None
        })
        return _obj
