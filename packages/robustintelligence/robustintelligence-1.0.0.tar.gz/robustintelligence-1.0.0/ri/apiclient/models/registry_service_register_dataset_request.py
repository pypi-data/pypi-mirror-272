...
class RegistryServiceRegisterDatasetRequest(BaseModel):
    """
    ...
    data_info: RegistryDataInfo = Field(alias="dataInfo")
    ...
    __properties: ClassVar[List[str]] = ["projectId", "name", "metadata", "integrationId", "dataInfo", "ctInfo", "skipValidation", "agentId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegistryServiceRegisterDatasetRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegistryServiceRegisterDatasetRequest from a dict"""
        if obj is None:
            return None
