...
class RimeListImagesResponse(BaseModel):
    """
    RimeListImagesResponse
    """ # noqa: E501
    images: Optional[List[RimeManagedImage]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "images": [RimeManagedImage.from_dict(_item) for _item in obj["images"]] if obj.get("images") is not None else None,
