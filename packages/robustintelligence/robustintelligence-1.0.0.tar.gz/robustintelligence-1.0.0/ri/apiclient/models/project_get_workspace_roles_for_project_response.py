...
class ProjectGetWorkspaceRolesForProjectResponse(BaseModel):
    """
    ...
    role_pairs: Optional[List[RimeParentRoleSubjectRolePair]] = Field(default=None, description="The elements of role_pairs maps each Workspace role to a Project role.", alias="rolePairs")
