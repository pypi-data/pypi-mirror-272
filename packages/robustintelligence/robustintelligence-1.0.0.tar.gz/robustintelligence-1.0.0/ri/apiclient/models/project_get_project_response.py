...
class ProjectGetProjectResponse(BaseModel):
    """
    GetProjectResponse returns a project with its owner details.
    """ # noqa: E501
    project: Optional[ProjectProjectWithDetails] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "project": ProjectProjectWithDetails.from_dict(obj["project"]) if obj.get("project") is not None else None
        })
        return _obj
