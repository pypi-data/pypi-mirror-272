...
class RimeTestRunProgress(BaseModel):
    """
    ...
    test_batches: Optional[List[TestRunProgressTestBatchProgress]] = Field(default=None, alias="testBatches")
    __properties: ClassVar[List[str]] = ["testRunId", "status", "testBatches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "testBatches": [TestRunProgressTestBatchProgress.from_dict(_item) for _item in obj["testBatches"]] if obj.get("testBatches") is not None else None
        })
        return _obj
