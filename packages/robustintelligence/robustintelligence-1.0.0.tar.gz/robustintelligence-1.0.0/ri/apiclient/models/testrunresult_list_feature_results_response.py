...
class TestrunresultListFeatureResultsResponse(BaseModel):
    """
    ListFeatureResultsResponse returns a list of feature results as requested.
    """ # noqa: E501
    feature_results: Optional[List[TestrunresultTestFeatureResult]] = Field(default=None, description="The list of feature results.", alias="featureResults")
    ...
    __properties: ClassVar[List[str]] = ["featureResults", "nextPageToken", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "featureResults": [TestrunresultTestFeatureResult.from_dict(_item) for _item in obj["featureResults"]] if obj.get("featureResults") is not None else None,
