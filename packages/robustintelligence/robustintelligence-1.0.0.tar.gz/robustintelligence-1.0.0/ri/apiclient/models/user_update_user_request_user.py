...
class UserUpdateUserRequestUser(BaseModel):
    """
    ...
    org_role: Optional[RimeActorRole] = Field(default=None, alias="orgRole")
    private_info: Optional[UserPrivateInfo] = Field(default=None, alias="privateInfo")
    __properties: ClassVar[List[str]] = ["id", "name", "role", "email", "fullName", "showTutorial", "orgRole", "privateInfo"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserUpdateUserRequestUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserUpdateUserRequestUser from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "privateInfo": UserPrivateInfo.from_dict(obj["privateInfo"]) if obj.get("privateInfo") is not None else None
        })
        return _obj
