...
class RimeUpdateFirewallResponse(BaseModel):
    """
    RimeUpdateFirewallResponse
    """ # noqa: E501
    firewall: Optional[FirewallFirewall] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "firewall": FirewallFirewall.from_dict(obj["firewall"]) if obj.get("firewall") is not None else None
        })
        return _obj
