...
class RimeSyncImageTagResponse(BaseModel):
    """
    RimeSyncImageTagResponse
    """ # noqa: E501
    image: Optional[RimeManagedImage] = None
    job: Optional[RimeJobMetadata] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "image": RimeManagedImage.from_dict(obj["image"]) if obj.get("image") is not None else None,
            "job": RimeJobMetadata.from_dict(obj["job"]) if obj.get("job") is not None else None
        })
        return _obj
