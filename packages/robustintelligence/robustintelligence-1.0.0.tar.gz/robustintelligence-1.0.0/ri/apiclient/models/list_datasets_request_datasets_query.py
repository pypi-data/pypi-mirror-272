...
class ListDatasetsRequestDatasetsQuery(BaseModel):
    """
    ...
    scheduled_ct_intervals: Optional[RimeTimeInterval] = Field(default=None, alias="scheduledCtIntervals")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scheduledCtIntervals": RimeTimeInterval.from_dict(obj["scheduledCtIntervals"]) if obj.get("scheduledCtIntervals") is not None else None
        })
        return _obj
