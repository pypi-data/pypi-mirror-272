...
class RimeAPITokenInfo(BaseModel):
    """
    API token object.
    """ # noqa: E501
    ...
    token_type: Optional[RimeTokenType] = Field(default=None, alias="tokenType")
    __properties: ClassVar[List[str]] = ["id", "name", "suffix", "creationTime", "expirationTime", "workspaceId", "userId", "tokenType"]
