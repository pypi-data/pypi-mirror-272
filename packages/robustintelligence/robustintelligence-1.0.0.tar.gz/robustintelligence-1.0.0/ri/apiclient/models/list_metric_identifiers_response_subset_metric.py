...
class ListMetricIdentifiersResponseSubsetMetric(BaseModel):
    """
    ListMetricIdentifiersResponseSubsetMetric
    """ # noqa: E501
    metric_id: Optional[ArtifactIdentifierSubsetTestMetricIdentifier] = Field(default=None, alias="metricId")
    excluded_transforms: Optional[MonitorExcludedTransforms] = Field(default=None, alias="excludedTransforms")
    __properties: ClassVar[List[str]] = ["metricId", "excludedTransforms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metricId": ArtifactIdentifierSubsetTestMetricIdentifier.from_dict(obj["metricId"]) if obj.get("metricId") is not None else None,
