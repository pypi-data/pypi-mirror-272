...
class RimeGetPredictionSetResponse(BaseModel):
    """
    RimeGetPredictionSetResponse
    """ # noqa: E501
    prediction: Optional[RegistrypredictionPrediction] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "prediction": RegistrypredictionPrediction.from_dict(obj["prediction"]) if obj.get("prediction") is not None else None
        })
        return _obj
