...
class RimeConfigureIntegrationResponse(BaseModel):
    """
    RimeConfigureIntegrationResponse
    """ # noqa: E501
    integration_info: Optional[RimeIntegrationInfo] = Field(default=None, alias="integrationInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrationInfo": RimeIntegrationInfo.from_dict(obj["integrationInfo"]) if obj.get("integrationInfo") is not None else None
        })
        return _obj
