...
class RimeGetValidatePredictionsTaskStatusResponse(BaseModel):
    """
    RimeGetValidatePredictionsTaskStatusResponse
    """ # noqa: E501
    resp: Optional[ValidationValidatePredictionsResponse] = None
    job_metadata: Optional[RimeJobMetadata] = Field(default=None, alias="jobMetadata")
    __properties: ClassVar[List[str]] = ["resp", "jobMetadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resp": ValidationValidatePredictionsResponse.from_dict(obj["resp"]) if obj.get("resp") is not None else None,
            "jobMetadata": RimeJobMetadata.from_dict(obj["jobMetadata"]) if obj.get("jobMetadata") is not None else None
        })
        return _obj
