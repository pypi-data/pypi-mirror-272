...
class JobDataStressTest(BaseModel):
    """
    ...
    progress: Optional[RimeStressTestJobProgress] = None
    __properties: ClassVar[List[str]] = ["projectId", "testRunId", "progress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "progress": RimeStressTestJobProgress.from_dict(obj["progress"]) if obj.get("progress") is not None else None
        })
        return _obj
