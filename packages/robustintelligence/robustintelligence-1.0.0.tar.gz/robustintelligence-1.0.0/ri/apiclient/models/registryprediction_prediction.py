...
class RegistrypredictionPrediction(BaseModel):
    """
    ...
    project_ids: Optional[List[RimeUUID]] = Field(default=None, description="For now, a pred will only have one project_id associated with it. We make this an array to allow pred's to be shared in the future.", alias="projectIds")
    ...
    __properties: ClassVar[List[str]] = ["datasetId", "modelId", "projectIds", "creatorId", "creationTime", "userMetadata", "integrationId", "predInfo", "validityStatus", "markedForDeleteAt", "validityStatusMessage"]
