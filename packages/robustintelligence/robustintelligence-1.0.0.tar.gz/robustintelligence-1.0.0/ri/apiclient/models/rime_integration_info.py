...
class RimeIntegrationInfo(BaseModel):
    """
    Represents an Integration and its configuration status.
    """ # noqa: E501
    integration: Optional[RischemaintegrationIntegration] = None
    configured: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["integration", "configured"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integration": RischemaintegrationIntegration.from_dict(obj["integration"]) if obj.get("integration") is not None else None,
