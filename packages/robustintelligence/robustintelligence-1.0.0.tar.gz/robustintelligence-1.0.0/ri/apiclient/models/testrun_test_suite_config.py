...
class TestrunTestSuiteConfig(BaseModel):
    """
    ...
    """ # noqa: E501
    global_test_sensitivity: Optional[TestrunTestSensitivity] = Field(default=None, alias="globalTestSensitivity")
    ...
    __properties: ClassVar[List[str]] = ["globalTestSensitivity", "individualTestsConfig", "customTests", "globalExcludeColumns"]
