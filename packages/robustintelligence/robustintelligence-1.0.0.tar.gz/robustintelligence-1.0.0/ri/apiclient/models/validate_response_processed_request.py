...
class ValidateResponseProcessedRequest(BaseModel):
    """
    Note: these fields may contain sensitive input.  There is a deploy-time parameter to turn on/off exposing these over API.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["requestId", "userInputText", "inputTokenCount", "contexts", "contextsTokenCount", "outputText", "outputTokenCount"]
