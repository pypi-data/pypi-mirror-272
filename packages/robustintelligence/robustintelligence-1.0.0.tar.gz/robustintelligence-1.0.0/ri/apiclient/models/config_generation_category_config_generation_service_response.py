...
class ConfigGenerationCategoryConfigGenerationServiceResponse(BaseModel):
    """
    ConfigGenerationCategoryConfigGenerationServiceResponse
    """ # noqa: E501
    stress_test_categories: Optional[List[TestrunTestCategoryType]] = Field(default=None, alias="stressTestCategories")
    continuous_test_categories: Optional[List[TestrunTestCategoryType]] = Field(default=None, alias="continuousTestCategories")
    __properties: ClassVar[List[str]] = ["stressTestCategories", "continuousTestCategories"]
