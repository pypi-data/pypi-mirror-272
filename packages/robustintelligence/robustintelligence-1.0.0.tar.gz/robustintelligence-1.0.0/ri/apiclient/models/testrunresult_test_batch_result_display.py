...
class TestrunresultTestBatchResultDisplay(BaseModel):
    """
    ...
    table_columns_to_show: Optional[List[RimeTableColumn]] = Field(default=None, alias="tableColumnsToShow")
    long_description_tabs: Optional[List[RimeLongDescriptionTab]] = Field(default=None, description="More detailed information about the test batch.", alias="longDescriptionTabs")
    ...
    __properties: ClassVar[List[str]] = ["summaryDetails", "tableColumnsToShow", "longDescriptionTabs", "descriptionHtml"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tableColumnsToShow": [RimeTableColumn.from_dict(_item) for _item in obj["tableColumnsToShow"]] if obj.get("tableColumnsToShow") is not None else None,
