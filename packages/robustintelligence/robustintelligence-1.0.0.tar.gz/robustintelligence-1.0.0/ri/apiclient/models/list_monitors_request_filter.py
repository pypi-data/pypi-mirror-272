...
class ListMonitorsRequestFilter(BaseModel):
    """
    ListMonitorsRequestFilter
    """ # noqa: E501
    included_monitor_types: Optional[List[MonitorMonitorType]] = Field(default=None, description="Specifies a list of monitor types. Filters results to match the specified monitor types.", alias="includedMonitorTypes")
    included_risk_category_types: Optional[List[RiskscoreRiskCategoryType]] = Field(default=None, description="Specifies a list of risk category types. Filters results to match the specified risk category types.", alias="includedRiskCategoryTypes")
