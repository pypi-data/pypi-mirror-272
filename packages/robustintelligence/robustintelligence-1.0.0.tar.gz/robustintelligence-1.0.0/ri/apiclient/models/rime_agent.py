...
class RimeAgent(BaseModel):
    ...
    status: Optional[RimeAgentStatus] = None
    ...
    desired_state: Optional[RimeAgentDesiredState] = Field(default=None, alias="desiredState")
    type: Optional[RimeAgentType] = None
    __properties: ClassVar[List[str]] = ["agentId", "name", "creationTime", "status", "internal", "lastHeartbeatTime", "version", "desiredState", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "desiredState": RimeAgentDesiredState.from_dict(obj["desiredState"]) if obj.get("desiredState") is not None else None,
            "type": obj.get("type")
        })
        return _obj
