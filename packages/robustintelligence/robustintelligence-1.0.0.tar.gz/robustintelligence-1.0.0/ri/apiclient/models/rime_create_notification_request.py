...
class RimeCreateNotificationRequest(BaseModel):
    """
    ...
    webhooks: Optional[List[NotificationWebhookConfig]] = Field(default=None, description="List of webhooks that notifications should be sent to - this can be empty.")
    __properties: ClassVar[List[str]] = ["objectType", "objectId", "emails", "config", "webhooks"]
