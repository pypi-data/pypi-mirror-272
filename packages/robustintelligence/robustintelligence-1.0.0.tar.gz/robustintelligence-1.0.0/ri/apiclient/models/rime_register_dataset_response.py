...
class RimeRegisterDatasetResponse(BaseModel):
    """
    RimeRegisterDatasetResponse
    """ # noqa: E501
    dataset_id: Optional[StrictStr] = Field(default=None, description="dataset_id is a string as it contains semantic meaning and does not adhere to UUID standard.", alias="datasetId")
    registry_validation_job_id: Optional[RimeUUID] = Field(default=None, alias="registryValidationJobId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "registryValidationJobId": RimeUUID.from_dict(obj["registryValidationJobId"]) if obj.get("registryValidationJobId") is not None else None
        })
        return _obj
