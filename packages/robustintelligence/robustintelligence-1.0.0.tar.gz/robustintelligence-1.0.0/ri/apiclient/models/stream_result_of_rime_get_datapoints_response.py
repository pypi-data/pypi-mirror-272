...
class StreamResultOfRimeGetDatapointsResponse(BaseModel):
    """
    StreamResultOfRimeGetDatapointsResponse
    """ # noqa: E501
    result: Optional[RimeGetDatapointsResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": RimeGetDatapointsResponse.from_dict(obj["result"]) if obj.get("result") is not None else None,
