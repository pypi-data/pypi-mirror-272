...
class ProjectUpdateWorkspaceRolesForProjectResponse(BaseModel):
    """
    ...
    role_pairs: Optional[List[RimeParentRoleSubjectRolePair]] = Field(default=None, alias="rolePairs")
