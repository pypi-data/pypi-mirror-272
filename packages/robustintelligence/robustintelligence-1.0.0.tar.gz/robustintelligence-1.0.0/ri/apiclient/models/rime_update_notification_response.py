...
class RimeUpdateNotificationResponse(BaseModel):
    """
    UpdateNotificationResponse is returned after a successful update.
    """ # noqa: E501
    notification: Optional[NotificationNotification] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notification": NotificationNotification.from_dict(obj["notification"]) if obj.get("notification") is not None else None
        })
        return _obj
