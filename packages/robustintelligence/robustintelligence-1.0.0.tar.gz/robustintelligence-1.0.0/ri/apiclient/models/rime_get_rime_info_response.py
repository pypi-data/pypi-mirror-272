...
class RimeGetRIMEInfoResponse(BaseModel):
    """
    ...
    ri_plan: Optional[RimeRIPlan] = Field(default=None, alias="riPlan")
    ...
    __properties: ClassVar[List[str]] = ["clusterInfoVersion", "customerName", "expirationTime", "gracePeriodEndTime", "riPlan", "buildVersion"]
