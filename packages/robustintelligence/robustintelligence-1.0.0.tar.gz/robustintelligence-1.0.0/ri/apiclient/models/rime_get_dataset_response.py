...
class RimeGetDatasetResponse(BaseModel):
    """
    RimeGetDatasetResponse
    """ # noqa: E501
    dataset: Optional[DatasetDataset] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataset": DatasetDataset.from_dict(obj["dataset"]) if obj.get("dataset") is not None else None
        })
        return _obj
