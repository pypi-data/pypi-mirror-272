...
class StreamResultOfRimeGetPredictionsResponse(BaseModel):
    """
    StreamResultOfRimeGetPredictionsResponse
    """ # noqa: E501
    result: Optional[RimeGetPredictionsResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": RimeGetPredictionsResponse.from_dict(obj["result"]) if obj.get("result") is not None else None,
