...
class TestrunDataProfiling(BaseModel):
    """
    ...
    column_type_info: Optional[DataProfilingColumnTypeInfo] = Field(default=None, alias="columnTypeInfo")
    feature_relationship_info: Optional[DataProfilingFeatureRelationshipInfo] = Field(default=None, alias="featureRelationshipInfo")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "columnTypeInfo": DataProfilingColumnTypeInfo.from_dict(obj["columnTypeInfo"]) if obj.get("columnTypeInfo") is not None else None,
            "featureRelationshipInfo": DataProfilingFeatureRelationshipInfo.from_dict(obj["featureRelationshipInfo"]) if obj.get("featureRelationshipInfo") is not None else None
        })
        return _obj
