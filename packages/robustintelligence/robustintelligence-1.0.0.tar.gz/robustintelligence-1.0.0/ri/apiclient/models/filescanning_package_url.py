...
class FilescanningPackageURL(BaseModel):
    """
    ...
    """ # noqa: E501
    type: Optional[SchemafilescanningPackageType] = None
    ...
    __properties: ClassVar[List[str]] = ["type", "namespace", "name", "version", "qualifiers", "subpath"]
