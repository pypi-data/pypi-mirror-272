...
class RimeListUsersResponse(BaseModel):
    """
    RimeListUsersResponse
    """ # noqa: E501
    users: Optional[List[UserUserDetail]] = None
    ...
    __properties: ClassVar[List[str]] = ["users", "nextPageToken", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [UserUserDetail.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
