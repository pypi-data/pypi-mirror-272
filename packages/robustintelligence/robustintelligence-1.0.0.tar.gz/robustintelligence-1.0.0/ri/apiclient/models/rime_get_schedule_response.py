...
class RimeGetScheduleResponse(BaseModel):
    """
    RimeGetScheduleResponse
    """ # noqa: E501
    schedule: Optional[ScheduleSchedule] = None
    next_run_time: Optional[datetime] = Field(default=None, alias="nextRunTime")
    __properties: ClassVar[List[str]] = ["schedule", "nextRunTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "schedule": ScheduleSchedule.from_dict(obj["schedule"]) if obj.get("schedule") is not None else None,
