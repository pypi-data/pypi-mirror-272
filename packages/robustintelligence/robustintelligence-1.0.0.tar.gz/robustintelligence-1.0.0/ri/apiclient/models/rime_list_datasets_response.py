...
class RimeListDatasetsResponse(BaseModel):
    """
    RimeListDatasetsResponse
    """ # noqa: E501
    datasets: Optional[List[DatasetDataset]] = None
    ...
    __properties: ClassVar[List[str]] = ["datasets", "nextPageToken", "hasMore"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datasets": [DatasetDataset.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None,
