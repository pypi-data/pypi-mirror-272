...
class RimeCreateCustomMonitorResponse(BaseModel):
    """
    CreateCustomMonitorResponse returns the created custom monitor.
    """ # noqa: E501
    monitor: Optional[MonitorMonitor] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "monitor": MonitorMonitor.from_dict(obj["monitor"]) if obj.get("monitor") is not None else None
        })
        return _obj
