...
class DetectionSecurityEventDetails(BaseModel):
    """
    DetectionSecurityEventDetails
    """ # noqa: E501
    type: Optional[SecurityEventDetailsSecurityEventType] = None
    ...
    datapoints: Optional[List[SecurityEventDetailsFlaggedDatapoint]] = Field(default=None, description="Include descriptions of all the flagged datapoints for the attack.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "datapoints": [SecurityEventDetailsFlaggedDatapoint.from_dict(_item) for _item in obj["datapoints"]] if obj.get("datapoints") is not None else None
        })
        return _obj
