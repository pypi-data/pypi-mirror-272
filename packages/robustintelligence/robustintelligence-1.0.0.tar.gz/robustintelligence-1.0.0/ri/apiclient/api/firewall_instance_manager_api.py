...
class FirewallInstanceManagerApi:
    ...
    def create_instance(
        ...
        body = ApigenerativefirewallCreateFirewallInstanceRequest(
          config=config,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApigenerativefirewallCreateFirewallInstanceResponse",
        }
    ...
    def list_instances(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApigenerativefirewallListFirewallInstancesResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
        )
