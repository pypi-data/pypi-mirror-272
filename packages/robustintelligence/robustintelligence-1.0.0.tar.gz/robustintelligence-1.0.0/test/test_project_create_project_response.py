...
class TestProjectCreateProjectResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectCreateProjectResponse:
        """Test ProjectCreateProjectResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectCreateProjectResponse`
        """
        model = ProjectCreateProjectResponse()
        if include_optional:
    ...
    def testProjectCreateProjectResponse(self):
        """Test ProjectCreateProjectResponse"""
