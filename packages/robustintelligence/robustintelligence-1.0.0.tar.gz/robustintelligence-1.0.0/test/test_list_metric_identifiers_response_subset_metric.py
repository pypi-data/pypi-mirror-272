...
class TestListMetricIdentifiersResponseSubsetMetric(unittest.TestCase):
    """ListMetricIdentifiersResponseSubsetMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMetricIdentifiersResponseSubsetMetric:
        """Test ListMetricIdentifiersResponseSubsetMetric
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMetricIdentifiersResponseSubsetMetric`
        """
        model = ListMetricIdentifiersResponseSubsetMetric()
        if include_optional:
            return ListMetricIdentifiersResponseSubsetMetric(
...
We can specify TestCaseMetricIdentifier as:
{
   ...
   metric = 'names',
    ...
    def testListMetricIdentifiersResponseSubsetMetric(self):
        """Test ListMetricIdentifiersResponseSubsetMetric"""
