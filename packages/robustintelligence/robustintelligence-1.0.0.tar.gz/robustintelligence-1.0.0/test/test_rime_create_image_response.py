...
class TestRimeCreateImageResponse(unittest.TestCase):
    """RimeCreateImageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeCreateImageResponse:
        """Test RimeCreateImageResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeCreateImageResponse`
        """
        model = RimeCreateImageResponse()
        if include_optional:
    ...
    def testRimeCreateImageResponse(self):
        """Test RimeCreateImageResponse"""
