...
class TestTestrunresultListFeatureResultsResponse(unittest.TestCase):
    """TestrunresultListFeatureResultsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestrunresultListFeatureResultsResponse:
        """Test TestrunresultListFeatureResultsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestrunresultListFeatureResultsResponse`
        """
        model = TestrunresultListFeatureResultsResponse()
        if include_optional:
            return TestrunresultListFeatureResultsResponse(
                feature_results = [
                    ri.apiclient.models.testrunresult_test_feature_result.testrunresultTestFeatureResult(
                        url_safe_feature_id = '',
                        feature_name = '',
    ...
    def testTestrunresultListFeatureResultsResponse(self):
        """Test TestrunresultListFeatureResultsResponse"""
