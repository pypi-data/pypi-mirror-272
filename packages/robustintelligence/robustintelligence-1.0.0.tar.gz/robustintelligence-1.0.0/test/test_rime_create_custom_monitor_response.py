...
class TestRimeCreateCustomMonitorResponse(unittest.TestCase):
    """RimeCreateCustomMonitorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeCreateCustomMonitorResponse:
        """Test RimeCreateCustomMonitorResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeCreateCustomMonitorResponse`
        """
        model = RimeCreateCustomMonitorResponse()
        if include_optional:
...
Transformations take in a time series and output a time series(
    ...
    def testRimeCreateCustomMonitorResponse(self):
        """Test RimeCreateCustomMonitorResponse"""
