...
class TestListMetricIdentifiersResponseSubsetMetrics(unittest.TestCase):
    """ListMetricIdentifiersResponseSubsetMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMetricIdentifiersResponseSubsetMetrics:
        """Test ListMetricIdentifiersResponseSubsetMetrics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMetricIdentifiersResponseSubsetMetrics`
        """
        model = ListMetricIdentifiersResponseSubsetMetrics()
        if include_optional:
            return ListMetricIdentifiersResponseSubsetMetrics(
                metric_ids = [
...
We can specify TestCaseMetricIdentifier as:
{
   ...
   metric = 'names',
    ...
    def testListMetricIdentifiersResponseSubsetMetrics(self):
        """Test ListMetricIdentifiersResponseSubsetMetrics"""
