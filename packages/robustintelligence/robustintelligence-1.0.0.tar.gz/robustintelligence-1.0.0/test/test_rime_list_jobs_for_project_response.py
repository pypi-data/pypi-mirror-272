...
class TestRimeListJobsForProjectResponse(unittest.TestCase):
    """RimeListJobsForProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeListJobsForProjectResponse:
        """Test RimeListJobsForProjectResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeListJobsForProjectResponse`
        """
        model = RimeListJobsForProjectResponse()
        if include_optional:
            return RimeListJobsForProjectResponse(
                jobs = [
                    ri.apiclient.models.rime_job_metadata.rimeJobMetadata(
                        job_id = '',
    ...
    def testRimeListJobsForProjectResponse(self):
        """Test RimeListJobsForProjectResponse"""
