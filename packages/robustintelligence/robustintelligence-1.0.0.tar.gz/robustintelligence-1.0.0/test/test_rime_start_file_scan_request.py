...
class TestRimeStartFileScanRequest(unittest.TestCase):
    """RimeStartFileScanRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeStartFileScanRequest:
        """Test RimeStartFileScanRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeStartFileScanRequest`
        """
        model = RimeStartFileScanRequest()
        if include_optional:
            return RimeStartFileScanRequest(
    ...
    def testRimeStartFileScanRequest(self):
        """Test RimeStartFileScanRequest"""
