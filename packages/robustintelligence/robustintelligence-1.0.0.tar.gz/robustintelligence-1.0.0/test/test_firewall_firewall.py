...
class TestFirewallFirewall(unittest.TestCase):
    """FirewallFirewall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FirewallFirewall:
        """Test FirewallFirewall
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FirewallFirewall`
        """
        model = FirewallFirewall()
        if include_optional:
            return FirewallFirewall(
