...
class TestRimeCreateScheduleRequest(unittest.TestCase):
    """RimeCreateScheduleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeCreateScheduleRequest:
        """Test RimeCreateScheduleRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeCreateScheduleRequest`
        """
        model = RimeCreateScheduleRequest()
        if include_optional:
            return RimeCreateScheduleRequest(
    ...
    def testRimeCreateScheduleRequest(self):
        """Test RimeCreateScheduleRequest"""
