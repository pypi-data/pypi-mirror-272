...
class TestMonitorServiceCreateCustomMonitorRequest(unittest.TestCase):
    """MonitorServiceCreateCustomMonitorRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorServiceCreateCustomMonitorRequest:
        """Test MonitorServiceCreateCustomMonitorRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorServiceCreateCustomMonitorRequest`
        """
        model = MonitorServiceCreateCustomMonitorRequest()
        if include_optional:
            return MonitorServiceCreateCustomMonitorRequest(
...
Transformations take in a time series and output a time series(
    ...
    def testMonitorServiceCreateCustomMonitorRequest(self):
        """Test MonitorServiceCreateCustomMonitorRequest"""
