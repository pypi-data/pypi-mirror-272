...
class TestTestrunresultTestCase(unittest.TestCase):
    """TestrunresultTestCase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestrunresultTestCase:
        """Test TestrunresultTestCase
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestrunresultTestCase`
        """
        model = TestrunresultTestCase()
        if include_optional:
            return TestrunresultTestCase(
                test_run_id = '',
                features = [
                    ''
                    ],
    ...
    def testTestrunresultTestCase(self):
        """Test TestrunresultTestCase"""
