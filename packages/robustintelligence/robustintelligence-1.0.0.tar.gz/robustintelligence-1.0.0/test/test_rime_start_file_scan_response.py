...
class TestRimeStartFileScanResponse(unittest.TestCase):
    """RimeStartFileScanResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeStartFileScanResponse:
        """Test RimeStartFileScanResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeStartFileScanResponse`
        """
        model = RimeStartFileScanResponse()
        if include_optional:
    ...
    def testRimeStartFileScanResponse(self):
        """Test RimeStartFileScanResponse"""
