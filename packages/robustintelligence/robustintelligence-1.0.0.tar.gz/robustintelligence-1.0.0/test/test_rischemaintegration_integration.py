...
class TestRischemaintegrationIntegration(unittest.TestCase):
    """RischemaintegrationIntegration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RischemaintegrationIntegration:
        """Test RischemaintegrationIntegration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RischemaintegrationIntegration`
        """
        model = RischemaintegrationIntegration()
        if include_optional:
            return RischemaintegrationIntegration(
...
https://docs.robustintelligence.com/en/latest/administration/workspace_configuration/integrations/configuring_integrations.html(
    ...
    def testRischemaintegrationIntegration(self):
        """Test RischemaintegrationIntegration"""
