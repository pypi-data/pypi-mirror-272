...
class TestCreateFirewallRequestScheduledCTParameters(unittest.TestCase):
    """CreateFirewallRequestScheduledCTParameters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFirewallRequestScheduledCTParameters:
        """Test CreateFirewallRequestScheduledCTParameters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFirewallRequestScheduledCTParameters`
        """
        model = CreateFirewallRequestScheduledCTParameters()
        if include_optional:
            return CreateFirewallRequestScheduledCTParameters(
    ...
    def testCreateFirewallRequestScheduledCTParameters(self):
        """Test CreateFirewallRequestScheduledCTParameters"""
