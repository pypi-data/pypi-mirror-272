...
class TestRimeListGAITestJobResponse(unittest.TestCase):
    """RimeListGAITestJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeListGAITestJobResponse:
        """Test RimeListGAITestJobResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeListGAITestJobResponse`
        """
        model = RimeListGAITestJobResponse()
        if include_optional:
    ...
    def testRimeListGAITestJobResponse(self):
        """Test RimeListGAITestJobResponse"""
