...
class TestRegistryPredInfo(unittest.TestCase):
    """RegistryPredInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegistryPredInfo:
        """Test RegistryPredInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegistryPredInfo`
        """
        model = RegistryPredInfo()
        if include_optional:
            return RegistryPredInfo(
