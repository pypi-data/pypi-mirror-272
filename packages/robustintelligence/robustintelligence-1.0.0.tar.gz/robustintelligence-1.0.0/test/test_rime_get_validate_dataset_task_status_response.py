...
class TestRimeGetValidateDatasetTaskStatusResponse(unittest.TestCase):
    """RimeGetValidateDatasetTaskStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeGetValidateDatasetTaskStatusResponse:
        """Test RimeGetValidateDatasetTaskStatusResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeGetValidateDatasetTaskStatusResponse`
        """
        model = RimeGetValidateDatasetTaskStatusResponse()
        if include_optional:
            return RimeGetValidateDatasetTaskStatusResponse(
                resp = ri.apiclient.models.validation_validate_dataset_response.validationValidateDatasetResponse(
                    is_valid = True,
                    error_message = '',
    ...
    def testRimeGetValidateDatasetTaskStatusResponse(self):
        """Test RimeGetValidateDatasetTaskStatusResponse"""
