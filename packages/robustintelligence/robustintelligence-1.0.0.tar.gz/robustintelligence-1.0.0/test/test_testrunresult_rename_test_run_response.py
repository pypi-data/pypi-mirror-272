...
class TestTestrunresultRenameTestRunResponse(unittest.TestCase):
    """TestrunresultRenameTestRunResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestrunresultRenameTestRunResponse:
        """Test TestrunresultRenameTestRunResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestrunresultRenameTestRunResponse`
        """
        model = TestrunresultRenameTestRunResponse()
        if include_optional:
            return TestrunresultRenameTestRunResponse(
                test_run = ri.apiclient.models.testrunresult_test_run_detail.testrunresultTestRunDetail(
                    test_run_id = '',
                    name = '',
    ...
    def testTestrunresultRenameTestRunResponse(self):
        """Test TestrunresultRenameTestRunResponse"""
