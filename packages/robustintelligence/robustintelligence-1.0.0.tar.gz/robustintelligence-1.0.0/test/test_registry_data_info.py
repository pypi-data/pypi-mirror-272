...
class TestRegistryDataInfo(unittest.TestCase):
    """RegistryDataInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegistryDataInfo:
        """Test RegistryDataInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegistryDataInfo`
        """
        model = RegistryDataInfo()
        if include_optional:
