...
class TestRimeUpdateIntegrationResponse(unittest.TestCase):
    """RimeUpdateIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeUpdateIntegrationResponse:
        """Test RimeUpdateIntegrationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeUpdateIntegrationResponse`
        """
        model = RimeUpdateIntegrationResponse()
        if include_optional:
...
https://docs.robustintelligence.com/en/latest/administration/workspace_configuration/integrations/configuring_integrations.html(
    ...
    def testRimeUpdateIntegrationResponse(self):
        """Test RimeUpdateIntegrationResponse"""
