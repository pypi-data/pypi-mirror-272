...
class TestTestrunresultGetBatchResultResponse(unittest.TestCase):
    """TestrunresultGetBatchResultResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestrunresultGetBatchResultResponse:
        """Test TestrunresultGetBatchResultResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestrunresultGetBatchResultResponse`
        """
        model = TestrunresultGetBatchResultResponse()
        if include_optional:
            return TestrunresultGetBatchResultResponse(
                test_batch = ri.apiclient.models.testrunresult_test_batch_result.testrunresultTestBatchResult(
                    test_run_id = '',
                    test_type = '',
                    test_name = '',
                    description = '',
    ...
    def testTestrunresultGetBatchResultResponse(self):
        """Test TestrunresultGetBatchResultResponse"""
