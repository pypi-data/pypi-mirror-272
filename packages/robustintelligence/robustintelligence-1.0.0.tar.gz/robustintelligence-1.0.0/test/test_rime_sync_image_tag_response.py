...
class TestRimeSyncImageTagResponse(unittest.TestCase):
    """RimeSyncImageTagResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeSyncImageTagResponse:
        """Test RimeSyncImageTagResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeSyncImageTagResponse`
        """
        model = RimeSyncImageTagResponse()
        if include_optional:
            return RimeSyncImageTagResponse(
    ...
    def testRimeSyncImageTagResponse(self):
        """Test RimeSyncImageTagResponse"""
