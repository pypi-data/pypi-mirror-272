...
class TestMonitorMonitor(unittest.TestCase):
    """MonitorMonitor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorMonitor:
        """Test MonitorMonitor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorMonitor`
        """
        model = MonitorMonitor()
        if include_optional:
