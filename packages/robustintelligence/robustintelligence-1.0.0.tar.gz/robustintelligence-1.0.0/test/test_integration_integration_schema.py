...
class TestIntegrationIntegrationSchema(unittest.TestCase):
    """IntegrationIntegrationSchema unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntegrationIntegrationSchema:
        """Test IntegrationIntegrationSchema
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntegrationIntegrationSchema`
        """
        model = IntegrationIntegrationSchema()
        if include_optional:
            return IntegrationIntegrationSchema(
                variables = [
...
https://docs.robustintelligence.com/en/latest/administration/workspace_configuration/integrations/configuring_integrations.html(
    ...
    def testIntegrationIntegrationSchema(self):
        """Test IntegrationIntegrationSchema"""
