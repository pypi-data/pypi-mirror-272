...
class TestRimeGetDatasetResponse(unittest.TestCase):
    """RimeGetDatasetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeGetDatasetResponse:
        """Test RimeGetDatasetResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeGetDatasetResponse`
        """
        model = RimeGetDatasetResponse()
        if include_optional:
            return RimeGetDatasetResponse(
                dataset = ri.apiclient.models.dataset_dataset.datasetDataset(
                    name = '',
                    dataset_id = '',
                    project_ids = [
    ...
    def testRimeGetDatasetResponse(self):
        """Test RimeGetDatasetResponse"""
