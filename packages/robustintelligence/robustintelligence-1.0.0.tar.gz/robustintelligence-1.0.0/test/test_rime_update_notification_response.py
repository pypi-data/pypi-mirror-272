...
class TestRimeUpdateNotificationResponse(unittest.TestCase):
    """RimeUpdateNotificationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeUpdateNotificationResponse:
        """Test RimeUpdateNotificationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeUpdateNotificationResponse`
        """
        model = RimeUpdateNotificationResponse()
        if include_optional:
            return RimeUpdateNotificationResponse(
                notification = ri.apiclient.models.notification_notification.notificationNotification(
    ...
    def testRimeUpdateNotificationResponse(self):
        """Test RimeUpdateNotificationResponse"""
