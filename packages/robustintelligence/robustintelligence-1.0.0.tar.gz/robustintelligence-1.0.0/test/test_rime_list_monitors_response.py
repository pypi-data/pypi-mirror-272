...
class TestRimeListMonitorsResponse(unittest.TestCase):
    """RimeListMonitorsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeListMonitorsResponse:
        """Test RimeListMonitorsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeListMonitorsResponse`
        """
        model = RimeListMonitorsResponse()
        if include_optional:
            return RimeListMonitorsResponse(
                monitors = [
                    ri.apiclient.models.monitor_monitor.monitorMonitor(
...
Transformations take in a time series and output a time series(
    ...
    def testRimeListMonitorsResponse(self):
        """Test RimeListMonitorsResponse"""
