...
class TestModelTestingStartStressTestRequest(unittest.TestCase):
    """ModelTestingStartStressTestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelTestingStartStressTestRequest:
        """Test ModelTestingStartStressTestRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelTestingStartStressTestRequest`
        """
        model = ModelTestingStartStressTestRequest()
        if include_optional:
            return ModelTestingStartStressTestRequest(
    ...
    def testModelTestingStartStressTestRequest(self):
        """Test ModelTestingStartStressTestRequest"""
