...
class TestRimeGetScheduleResponse(unittest.TestCase):
    """RimeGetScheduleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeGetScheduleResponse:
        """Test RimeGetScheduleResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeGetScheduleResponse`
        """
        model = RimeGetScheduleResponse()
        if include_optional:
    ...
    def testRimeGetScheduleResponse(self):
        """Test RimeGetScheduleResponse"""
