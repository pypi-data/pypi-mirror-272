...
class TestTestrunTestRunConfig(unittest.TestCase):
    """TestrunTestRunConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TestrunTestRunConfig:
        """Test TestrunTestRunConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TestrunTestRunConfig`
        """
        model = TestrunTestRunConfig()
        if include_optional:
            return TestrunTestRunConfig(
                run_name = '',
    ...
    def testTestrunTestRunConfig(self):
        """Test TestrunTestRunConfig"""
