...
class TestRimeConfigureIntegrationResponse(unittest.TestCase):
    """RimeConfigureIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeConfigureIntegrationResponse:
        """Test RimeConfigureIntegrationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeConfigureIntegrationResponse`
        """
        model = RimeConfigureIntegrationResponse()
        if include_optional:
...
https://docs.robustintelligence.com/en/latest/administration/workspace_configuration/integrations/configuring_integrations.html(
    ...
    def testRimeConfigureIntegrationResponse(self):
        """Test RimeConfigureIntegrationResponse"""
