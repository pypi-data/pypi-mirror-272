...
class TestMonitorArtifactIdentifier(unittest.TestCase):
    """MonitorArtifactIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitorArtifactIdentifier:
        """Test MonitorArtifactIdentifier
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitorArtifactIdentifier`
        """
        model = MonitorArtifactIdentifier()
        if include_optional:
            return MonitorArtifactIdentifier(
...
We can specify TestCaseMetricIdentifier as:
{
   ...
   metric = 'names',
    ...
    def testMonitorArtifactIdentifier(self):
        """Test MonitorArtifactIdentifier"""
