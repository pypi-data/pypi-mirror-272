...
class TestProjectListProjectsResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectListProjectsResponse:
        """Test ProjectListProjectsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectListProjectsResponse`
        """
        model = ProjectListProjectsResponse()
        if include_optional:
            return ProjectListProjectsResponse(
                projects = [
                    ri.apiclient.models.project_project_with_details.projectProjectWithDetails(
