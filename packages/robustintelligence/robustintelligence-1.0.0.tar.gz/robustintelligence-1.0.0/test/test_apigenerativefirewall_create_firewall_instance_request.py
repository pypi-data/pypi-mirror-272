...
class TestApigenerativefirewallCreateFirewallInstanceRequest(unittest.TestCase):
    """ApigenerativefirewallCreateFirewallInstanceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApigenerativefirewallCreateFirewallInstanceRequest:
        """Test ApigenerativefirewallCreateFirewallInstanceRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApigenerativefirewallCreateFirewallInstanceRequest`
        """
        model = ApigenerativefirewallCreateFirewallInstanceRequest()
        if include_optional:
            return ApigenerativefirewallCreateFirewallInstanceRequest(
    ...
    def testApigenerativefirewallCreateFirewallInstanceRequest(self):
        """Test ApigenerativefirewallCreateFirewallInstanceRequest"""
