...
class TestScheduleServiceUpdateScheduleRequest(unittest.TestCase):
    """ScheduleServiceUpdateScheduleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleServiceUpdateScheduleRequest:
        """Test ScheduleServiceUpdateScheduleRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleServiceUpdateScheduleRequest`
        """
        model = ScheduleServiceUpdateScheduleRequest()
        if include_optional:
            return ScheduleServiceUpdateScheduleRequest(
                schedule_id = None,
    ...
    def testScheduleServiceUpdateScheduleRequest(self):
        """Test ScheduleServiceUpdateScheduleRequest"""
