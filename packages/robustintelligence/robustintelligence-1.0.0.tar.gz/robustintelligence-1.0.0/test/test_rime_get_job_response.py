...
class TestRimeGetJobResponse(unittest.TestCase):
    """RimeGetJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeGetJobResponse:
        """Test RimeGetJobResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeGetJobResponse`
        """
        model = RimeGetJobResponse()
        if include_optional:
    ...
    def testRimeGetJobResponse(self):
        """Test RimeGetJobResponse"""
