...
class TestRimeStartStressTestResponse(unittest.TestCase):
    """RimeStartStressTestResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeStartStressTestResponse:
        """Test RimeStartStressTestResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeStartStressTestResponse`
        """
        model = RimeStartStressTestResponse()
        if include_optional:
    ...
    def testRimeStartStressTestResponse(self):
        """Test RimeStartStressTestResponse"""
