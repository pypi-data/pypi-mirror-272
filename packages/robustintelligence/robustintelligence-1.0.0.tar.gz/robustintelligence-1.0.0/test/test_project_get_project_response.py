...
class TestProjectGetProjectResponse(unittest.TestCase):
    """ProjectGetProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectGetProjectResponse:
        """Test ProjectGetProjectResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectGetProjectResponse`
        """
        model = ProjectGetProjectResponse()
        if include_optional:
            return ProjectGetProjectResponse(
                project = ri.apiclient.models.project_project_with_details.projectProjectWithDetails(
...
to provide identity of the owner of the Project(
    ...
    def testProjectGetProjectResponse(self):
        """Test ProjectGetProjectResponse"""
