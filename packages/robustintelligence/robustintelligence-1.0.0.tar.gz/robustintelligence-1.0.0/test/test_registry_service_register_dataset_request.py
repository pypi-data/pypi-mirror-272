...
class TestRegistryServiceRegisterDatasetRequest(unittest.TestCase):
    """RegistryServiceRegisterDatasetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegistryServiceRegisterDatasetRequest:
        """Test RegistryServiceRegisterDatasetRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegistryServiceRegisterDatasetRequest`
        """
        model = RegistryServiceRegisterDatasetRequest()
        if include_optional:
            return RegistryServiceRegisterDatasetRequest(
    ...
    def testRegistryServiceRegisterDatasetRequest(self):
        """Test RegistryServiceRegisterDatasetRequest"""
