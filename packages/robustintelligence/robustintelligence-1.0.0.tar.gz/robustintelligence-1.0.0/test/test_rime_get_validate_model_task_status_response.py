...
class TestRimeGetValidateModelTaskStatusResponse(unittest.TestCase):
    """RimeGetValidateModelTaskStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeGetValidateModelTaskStatusResponse:
        """Test RimeGetValidateModelTaskStatusResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeGetValidateModelTaskStatusResponse`
        """
        model = RimeGetValidateModelTaskStatusResponse()
        if include_optional:
            return RimeGetValidateModelTaskStatusResponse(
                resp = ri.apiclient.models.validation_validate_model_response.validationValidateModelResponse(
                    is_valid = True,
                    error_message = '',
    ...
    def testRimeGetValidateModelTaskStatusResponse(self):
        """Test RimeGetValidateModelTaskStatusResponse"""
