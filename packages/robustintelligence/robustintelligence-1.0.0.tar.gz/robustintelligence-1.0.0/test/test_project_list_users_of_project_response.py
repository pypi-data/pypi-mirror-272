...
class TestProjectListUsersOfProjectResponse(unittest.TestCase):
    """ProjectListUsersOfProjectResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProjectListUsersOfProjectResponse:
        """Test ProjectListUsersOfProjectResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectListUsersOfProjectResponse`
        """
        model = ProjectListUsersOfProjectResponse()
        if include_optional:
    ...
    def testProjectListUsersOfProjectResponse(self):
        """Test ProjectListUsersOfProjectResponse"""
