...
class TestRimeUpdateFirewallResponse(unittest.TestCase):
    """RimeUpdateFirewallResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeUpdateFirewallResponse:
        """Test RimeUpdateFirewallResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeUpdateFirewallResponse`
        """
        model = RimeUpdateFirewallResponse()
        if include_optional:
    ...
    def testRimeUpdateFirewallResponse(self):
        """Test RimeUpdateFirewallResponse"""
