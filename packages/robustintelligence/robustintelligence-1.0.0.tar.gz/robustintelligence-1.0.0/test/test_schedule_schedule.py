...
class TestScheduleSchedule(unittest.TestCase):
    """ScheduleSchedule unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScheduleSchedule:
        """Test ScheduleSchedule
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScheduleSchedule`
        """
        model = ScheduleSchedule()
        if include_optional:
