...
class TestRimeIntegrationInfo(unittest.TestCase):
    """RimeIntegrationInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeIntegrationInfo:
        """Test RimeIntegrationInfo
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeIntegrationInfo`
        """
        model = RimeIntegrationInfo()
        if include_optional:
            return RimeIntegrationInfo(
...
https://docs.robustintelligence.com/en/latest/administration/workspace_configuration/integrations/configuring_integrations.html(
    ...
    def testRimeIntegrationInfo(self):
        """Test RimeIntegrationInfo"""
