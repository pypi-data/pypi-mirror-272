...
class TestRegistryServiceRegisterPredictionSetRequest(unittest.TestCase):
    """RegistryServiceRegisterPredictionSetRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegistryServiceRegisterPredictionSetRequest:
        """Test RegistryServiceRegisterPredictionSetRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegistryServiceRegisterPredictionSetRequest`
        """
        model = RegistryServiceRegisterPredictionSetRequest()
        if include_optional:
            return RegistryServiceRegisterPredictionSetRequest(
    ...
    def testRegistryServiceRegisterPredictionSetRequest(self):
        """Test RegistryServiceRegisterPredictionSetRequest"""
