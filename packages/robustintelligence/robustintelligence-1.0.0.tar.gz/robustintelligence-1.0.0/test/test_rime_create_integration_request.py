...
class TestRimeCreateIntegrationRequest(unittest.TestCase):
    """RimeCreateIntegrationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeCreateIntegrationRequest:
        """Test RimeCreateIntegrationRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeCreateIntegrationRequest`
        """
        model = RimeCreateIntegrationRequest()
        if include_optional:
            return RimeCreateIntegrationRequest(
...
https://docs.robustintelligence.com/en/latest/administration/workspace_configuration/integrations/configuring_integrations.html(
    ...
    def testRimeCreateIntegrationRequest(self):
        """Test RimeCreateIntegrationRequest"""
