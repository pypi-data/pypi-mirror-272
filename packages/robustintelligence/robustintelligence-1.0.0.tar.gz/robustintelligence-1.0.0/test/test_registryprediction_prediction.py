...
class TestRegistrypredictionPrediction(unittest.TestCase):
    """RegistrypredictionPrediction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegistrypredictionPrediction:
        """Test RegistrypredictionPrediction
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegistrypredictionPrediction`
        """
        model = RegistrypredictionPrediction()
        if include_optional:
            return RegistrypredictionPrediction(
                dataset_id = '',
    ...
    def testRegistrypredictionPrediction(self):
        """Test RegistrypredictionPrediction"""
