...
class TestRimeCreateIntegrationResponse(unittest.TestCase):
    """RimeCreateIntegrationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeCreateIntegrationResponse:
        """Test RimeCreateIntegrationResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeCreateIntegrationResponse`
        """
        model = RimeCreateIntegrationResponse()
        if include_optional:
...
https://docs.robustintelligence.com/en/latest/administration/workspace_configuration/integrations/configuring_integrations.html(
    ...
    def testRimeCreateIntegrationResponse(self):
        """Test RimeCreateIntegrationResponse"""
