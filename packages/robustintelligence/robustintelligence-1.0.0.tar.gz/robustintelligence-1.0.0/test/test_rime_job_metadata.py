...
class TestRimeJobMetadata(unittest.TestCase):
    """RimeJobMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeJobMetadata:
        """Test RimeJobMetadata
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeJobMetadata`
        """
        model = RimeJobMetadata()
        if include_optional:
            return RimeJobMetadata(
                job_id = '',
