...
class TestRimeListMetricIdentifiersResponse(unittest.TestCase):
    """RimeListMetricIdentifiersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeListMetricIdentifiersResponse:
        """Test RimeListMetricIdentifiersResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeListMetricIdentifiersResponse`
        """
        model = RimeListMetricIdentifiersResponse()
        if include_optional:
...
We can specify TestCaseMetricIdentifier as:
{
   ...
   metric = 'names',
    ...
    def testRimeListMetricIdentifiersResponse(self):
        """Test RimeListMetricIdentifiersResponse"""
