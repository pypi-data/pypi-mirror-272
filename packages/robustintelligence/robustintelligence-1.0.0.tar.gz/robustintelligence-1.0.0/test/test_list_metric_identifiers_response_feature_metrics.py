...
class TestListMetricIdentifiersResponseFeatureMetrics(unittest.TestCase):
    """ListMetricIdentifiersResponseFeatureMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMetricIdentifiersResponseFeatureMetrics:
        """Test ListMetricIdentifiersResponseFeatureMetrics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMetricIdentifiersResponseFeatureMetrics`
        """
        model = ListMetricIdentifiersResponseFeatureMetrics()
        if include_optional:
            return ListMetricIdentifiersResponseFeatureMetrics(
...
We can specify TestCaseMetricIdentifier as:
{
   ...
   metric = 'names',
    ...
    def testListMetricIdentifiersResponseFeatureMetrics(self):
        """Test ListMetricIdentifiersResponseFeatureMetrics"""
