...
class TestRimeGetModelResponse(unittest.TestCase):
    """RimeGetModelResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RimeGetModelResponse:
        """Test RimeGetModelResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RimeGetModelResponse`
        """
        model = RimeGetModelResponse()
        if include_optional:
            return RimeGetModelResponse(
                model = ri.apiclient.models.rime_model_with_owner_details.rimeModelWithOwnerDetails(
...
to provide identity of the owner of the Project(
    ...
    def testRimeGetModelResponse(self):
        """Test RimeGetModelResponse"""
