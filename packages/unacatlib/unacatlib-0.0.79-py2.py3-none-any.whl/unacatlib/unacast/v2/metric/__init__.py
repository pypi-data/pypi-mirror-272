...
class MetricValue(betterproto.Message):
    """
    @exclude TODO: This seem to only be used by BYO apis. Should die with it.
    """
...
class DataColumn(betterproto.Message):
    ...
    """
    @exclude string display_name = 2; // Maybe needed in the future? Current
    use cases only needs default_column_name and description
    """

    default_column_name: str = betterproto.string_field(4)
    format: str = betterproto.string_field(6)
    """
    @exclude string column_group = 5; // Something to group columns by?
    Feature, RelatedFeature, Dimension, MetricValue, etc? Use first part of id
    as default?
    """
