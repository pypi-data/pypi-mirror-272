...
# enables us to report server times in client timezone 
...
def set_local_timezone(timezone):
    '''
    set the local timezone so that server jobs report time in client timezone
    '''
    global client_time_zone
