...
class ImplStorage(ImplBase):
    ...
    @flag(name="runs", default=1, help="when True, end-of-run markers are also plotted")
    @flag(name="checkpoints", help="when True, checkpoints markers are also plotted")
    @flag(name="catch-up", help="when True, running line includes catch-up segments")
    ...
    def plot_restarts(self, node_list, workspace, runs, checkpoints, catch_up):
        pr = PlotRestarts(self.store, node_list, workspace, runs, checkpoints, catch_up)
        pr.plot_core()
