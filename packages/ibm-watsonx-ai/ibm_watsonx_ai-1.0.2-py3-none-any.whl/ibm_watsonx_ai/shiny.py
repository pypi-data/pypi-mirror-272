...
class Shiny(WMLResource):
    ...
    def get_details(self, shiny_id: str | None = None, **kwargs: Any) -> dict[str, Any]:
        """Get shiny asset details. If no shiny_id is passed, details for all shiny assets will be returned.

        :param shiny_id: Unique id of shiny asset
    ...
    def list(self, limit: int | None = None) -> DataFrame:
        """Lists stored shiny assets in a table format. If limit is set to None
    ...
    def download(
        ...
        **kwargs: Any,
        ...
        :param shiny_id: the Unique Id of the shiny asset to be downloaded
        :type shiny_id: str
    ...
    def list_revisions(
        ...
        :param shiny_id: stored shiny asset ID
        :type shiny_id: str
    ...
    def get_revision_details(
        ...
        """Get metadata of `shiny_id` revision.
