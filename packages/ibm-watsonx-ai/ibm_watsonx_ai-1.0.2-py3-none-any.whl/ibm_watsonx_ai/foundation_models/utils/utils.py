...
def get_model_specs(url: str, model_id: str | None = None) -> dict:
    ...
    *Decrecated:* `get_model_specs()` function is deprecated, please use `client.foundation_models.get_model_specs()` function instead.
    ...
    **Example**
    ...
    warn(
        "`get_model_specs()` function is deprecated, please use `client.foundation_models.get_model_specs()` function instead.",
...
def get_custom_model_specs(
    ...
    *Decrecated:* `get_custom_model_specs()` function is deprecated, please use `client.foundation_models.get_custom_model_specs()` function instead.
    ...
    **Example**
    ...
    """
    warn(
        "`get_custom_model_specs()` function is deprecated, please use `client.foundation_models.get_custom_model_specs()` function instead.",
        category=DeprecationWarning,
    )
    ...
    if asynchronous or get_all:
        resource_generator = NextResourceGenerator(
            client,
            url=url,
...
def get_model_lifecycle(url: str, model_id: str) -> list | None:
    ...
    *Decrecated:* `get_model_lifecycle()` function is deprecated, please use `client.foundation_models.get_model_lifecycle()` function instead.
    ...
    **Example**
    ...
    """
    warn(
        "`get_model_lifecycle()` function is deprecated, please use `client.foundation_models.get_model_lifecycle()` function instead.",
        category=DeprecationWarning,
    )
...
def _check_model_state(url: str, model_id: str) -> None:
...
def get_model_specs_with_prompt_tuning_support(url: str) -> dict:
    ...
    *Decrecated:* `get_model_specs_with_prompt_tuning_support()` function is deprecated, please use `client.foundation_models.get_model_specs_with_prompt_tuning_support()` function instead.
    ...
    **Example**
    ...
    """
    warn(
        "`get_model_specs_with_prompt_tuning_support()` function is deprecated, please use `client.foundation_models.get_model_specs_with_prompt_tuning_support()` function instead.",
        category=DeprecationWarning,
    )
...
def get_embedding_model_specs(url: str) -> dict:
    """
    *Decrecated:* `get_embedding_model_specs()` function is deprecated, please use `client.foundation_models.get_embeddings_model_specs()` function instead.
    """
    warn(
        "`get_embedding_model_specs()` function is deprecated, please use `client.foundation_models.get_embeddings_model_specs()` function instead.",
        category=DeprecationWarning,
    )
