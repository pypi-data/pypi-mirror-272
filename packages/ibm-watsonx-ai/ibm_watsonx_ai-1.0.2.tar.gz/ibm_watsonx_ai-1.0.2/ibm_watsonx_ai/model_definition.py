...
class ModelDefinition(WMLResource):
    ...
    def get_details(
        ...
        """Get metadata of stored model definition. If no `model_definition_id` is passed,
        details for all model definitions will be returned.

        :param model_definition_id: Unique Id of model definition
    ...
    def download(
        ...
        **kwargs: Any,
        ...
        :param model_definition_id: the Unique Id of the model definition asset to be downloaded
        ...
        **Example**
        ...
        if rev_id is not None:
            ModelDefinition._validate_type(rev_id, "rev_id", int, False)
    ...
    def delete(self, model_definition_id: str | None = None, **kwargs: Any) -> str:
        ...
        :param model_definition_id: Unique Id of stored model definition
        :type model_definition_id: str
    ...
    def list(self, limit: int | None = None) -> pandas.DataFrame:
        """Returns stored model definition assets in a table format.
    ...
    def get_revision_details(
        ...
        **kwargs: Any,
        ...
        :param rev_id: revision ID, if this parameter is not provided, returns latest revision if existing else error
        :type rev_id: str, optional
    ...
    def list_revisions(
        ...
        **kwargs: Any,
        ...
        """Return stored model definition assets in a table format.
        If limit is set to None there will be only first 50 records shown.
