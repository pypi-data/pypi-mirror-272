...
class Models(WMLResource):
    ...
    def store(
        ...
        **Examples**
        ...
        Models._validate_type(
            ...
            "model",
            object,
            mandatory=not is_training_prompt_tuning(
    ...
    def update(
        ...
        **kwargs: Any,
        ...
        :param model_id: ID of model which define what should be updated
        :type model_id: str
        ...
        :param update_model: archived model content file or path to directory containing archived model file
            which should be changed for specific model_id
    ...
    def load(self, artifact_id: str | None, **kwargs: Any) -> Any:
        ...
        :param artifact_id: stored model ID
    ...
    def download(
        ...
        **kwargs: Any,
        ...
        :param model_id: stored model ID
        :type model_id: str
    ...
    def get_details(
        ...
        **kwargs: Any,
        ...
        """Get metadata of stored models. If model id is not specified returns all models metadata.

        :param model_id: stored model, definition or pipeline ID
    ...
    def list(
        ...
        """Lists stored models in a table format. If limit is set to None there will be only first 50 records shown.
    ...
    def create_revision(
        ...
        """Create revision for the given model id.
    ...
    def list_revisions(
        ...
        """Print all revision for the given model id in a table format.

        :param model_id: Unique id of stored model
        :type model_id: str
    ...
    def get_revision_details(
        ...
        **Example**
        ...
        self._client._check_if_either_is_set()
        Models._validate_type(model_id, "model_id", str, True)
        Models._validate_type(rev_id, "rev_id", int, True)
