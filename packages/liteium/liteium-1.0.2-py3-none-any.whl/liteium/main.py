...
def find_element(by, value):
    try:
        locator = (by, value)
        return ElementWrapper(driver1.find_element(*locator))
    except Exception as e:
        print("An error occurred while finding element:", e)
