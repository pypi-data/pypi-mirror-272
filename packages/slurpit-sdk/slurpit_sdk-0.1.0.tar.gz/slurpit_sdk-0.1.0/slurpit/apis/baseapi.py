...
class BaseAPI:
    ...
    def get(self, url, **kwargs):
        ...
        try:
            ...
            print("The request timed out")  # Handles cases where the request times out
            return None
        except requests.exceptions.ConnectionError:
            print("Network problem (e.g., DNS failure, refused connection, etc)")  # Handles network related errors
            return None
        except requests.exceptions.HTTPError as e:
            print(f"HTTP Error: {e}")  # Handles HTTP error statuses
            print(f"Error: {e.response.text}")  # Prints the error message from the server
            return None
        except requests.exceptions.RequestException as e:
            print(f"Request Error: {e}")  # Catches any other errors related to the request
            return None
        return response
