...
class VaultAPI(BaseAPI):
    ...
    def get_vaults(self, export_csv: bool = False):
        """
        ...
        Args:
            export_csv (bool): If True, returns the vault data in CSV format as bytes.
                            If False, returns a list of Vault objects.

        Returns:
            list[Vault] | bytes | None: Returns a list of Vault objects if successful,
    ...
    def get_vault(self, vault_id: int):
        ...
        Returns:
            SingleVault | None: Returns a SingleVault object if the fetch is successful; otherwise, returns None.
        """
        ...
        try:
            ...
            print(f"Getting a vault error: {e}")
    ...
    def update_vault(self, vault_id: int, update_data: dict):
        ...
        Returns:
            SingleVault | None: Returns a SingleVault object if the update is successful; otherwise, returns None.
        """
        url = f"{self.base_url}/vault/{vault_id}"
        try:
            ...
            print(f"Updating a vault error: {e}")
    ...
    def create_vault(self, new_vault: dict):
        ...
        Returns:
            SingleVault | None: Returns a SingleVault object if the creation is successful; otherwise, returns None.
        """
        url = f"{self.base_url}/vault"
        try:
            ...
            print(f"Creating a vault error: {e}")
    ...
    def delete_vault(self, vault_id: int):
        ...
        Returns:
            SingleVault | None: Returns a SingleVault object if the deletion is successful; otherwise, returns None.
        """
        url = f"{self.base_url}/vault/{vault_id}"
        try:
            ...
            print(f"Deleting a vault error: {e}")
