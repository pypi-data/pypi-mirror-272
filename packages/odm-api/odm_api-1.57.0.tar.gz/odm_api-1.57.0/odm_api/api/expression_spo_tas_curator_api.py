...
class ExpressionSPoTAsCuratorApi:
    ...
    def get_expression_data_as_curator(
        self,
        response_format: Annotated[Optional[List[StrictStr]], Field(description="Allows to get an extended or updated response body. Available values:  `term_id` - returns extended information including IDs for values and dictionaries;  `multi_values` - returns data with several feature attributes and several sample measurements in the response body in case the original data had them. If not specified, returns only the first feature identifier and the first measurement per sample from the original data.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Normalization Method\"=TPM`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023")] = None,
        ...
        run_filter: Annotated[Optional[StrictStr], Field(description="Genestack accession that corresponds to the gct column used to link expression data from the same run to a sample.")] = None,
        ...
        :param response_format: Allows to get an extended or updated response body. Available values:  `term_id` - returns extended information including IDs for values and dictionaries;  `multi_values` - returns data with several feature attributes and several sample measurements in the response body in case the original data had them. If not specified, returns only the first feature identifier and the first measurement per sample from the original data.
        :type response_format: List[str]
        :param filter: Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Normalization Method\"=TPM`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023
        :type filter: str
