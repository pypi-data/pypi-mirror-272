...
class FlowCytometrySPoTAsUserApi:
    ...
    def get_flow_cytometry_data_as_user(
        self,
        response_format: Annotated[Optional[StrictStr], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by flow cytometry metadata (key-value metadata pair(s)). E.g. `Organ=blood`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023")] = None,
        ...
        run_filter: Annotated[Optional[StrictStr], Field(description="Genestack accession that corresponds to the fcy column used to link flow cytometry data from the same run to a sample")] = None,
        ...
        :param response_format: Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.
        :type response_format: str
        :param filter: Filter by flow cytometry metadata (key-value metadata pair(s)). E.g. `Organ=blood`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023
        :type filter: str
