...
class OmicsQueriesAsCuratorApi:
    ...
    def omics_search_expression_data_as_curator(
        self,
        response_format: Annotated[Optional[List[StrictStr]], Field(description="Allows to get an extended or updated response body. Available values:  `term_id` - returns extended information including IDs for values and dictionaries;  `multi_values` - returns data with several feature attributes and several sample measurements in the response body in case the original data had them. If not specified, returns only the first feature identifier and the first measurement per sample from the original data.")] = None,
        ...
        vx_query: Annotated[Optional[StrictStr], Field(description="Search for objects linked to variant data via data query (key-value pair(s)). E.g.  `VariationId=rs548419688|rs544419019`  `Intervals=12:23432-234324,30:234324-23432` `Gene=ASPM,BRCA1`  `Reference=A|T Alteration=C|G` `Quality=(0.9:1.0)`  `Type=SNP|MNP|INS|DEL|MIXED`  `info_VT=DEL`  `info_EUR_AF=(0.9:1.0)` `Start=12340` `AllelesNumber=1` `AlterationNumber=2`")] = None,
        vx_filter: Annotated[Optional[StrictStr], Field(description="Filter by variant metadata (key-value metadata pair(s)). E.g. `\"Variant Source\"=dbSNP`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023. Use sampleFilter, libraryFilter or preparationFilter for retrieving an individual run")] = None,
        ...
        ex_filter: Annotated[Optional[StrictStr], Field(description="Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Genome Version\"=hg19-BROAD`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023. Use sampleFilter, libraryFilter or preparationFilter for retrieving an individual run")] = None,
        ...
        fx_filter: Annotated[Optional[StrictStr], Field(description="Filter by flow cytometry metadata (key-value metadata pair(s)). E.g. `Organ=blood`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023. Use sampleFilter, libraryFilter or preparationFilter for retrieving an individual run")] = None,
        ...
        :param vx_query: Search for objects linked to variant data via data query (key-value pair(s)). E.g.  `VariationId=rs548419688|rs544419019`  `Intervals=12:23432-234324,30:234324-23432` `Gene=ASPM,BRCA1`  `Reference=A|T Alteration=C|G` `Quality=(0.9:1.0)`  `Type=SNP|MNP|INS|DEL|MIXED`  `info_VT=DEL`  `info_EUR_AF=(0.9:1.0)` `Start=12340` `AllelesNumber=1` `AlterationNumber=2`
        :type vx_query: str
        :param vx_filter: Filter by variant metadata (key-value metadata pair(s)). E.g. `\"Variant Source\"=dbSNP`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023. Use sampleFilter, libraryFilter or preparationFilter for retrieving an individual run
        :type vx_filter: str
        ...
        :type ex_query: str
        :param ex_filter: Filter by expression metadata (key-value metadata pair(s)). E.g. `\"Genome Version\"=hg19-BROAD`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023. Use sampleFilter, libraryFilter or preparationFilter for retrieving an individual run
        :type ex_filter: str
        ...
        :type fx_query: str
        :param fx_filter: Filter by flow cytometry metadata (key-value metadata pair(s)). E.g. `Organ=blood`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023. Use sampleFilter, libraryFilter or preparationFilter for retrieving an individual run
        :type fx_filter: str
