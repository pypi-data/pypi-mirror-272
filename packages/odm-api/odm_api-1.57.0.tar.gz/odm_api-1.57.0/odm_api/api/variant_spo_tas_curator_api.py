...
class VariantSPoTAsCuratorApi:
    ...
    def get_all_variants_as_curator(
        self,
        response_format: Annotated[Optional[StrictStr], Field(description="Supply this parameter with the value `term_id` as part of the query to return extended information including IDs for values and dictionaries.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Filter by variant metadata (key-value metadata pair(s)). E.g. `\"Variant Source\"=dbSNP`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023")] = None,
        ...
        run_filter: Annotated[Optional[StrictStr], Field(description="Genestack accession that corresponds to the vcf column used to link variants from the same run to a sample")] = None,
        info_filter: Annotated[Optional[StrictStr], Field(description="Filter by vcf INFO field key=value(or range) pairs. Multiple filters can be separated with semicolons. E.g. `AF=(0.8:0.95);VT=SNP'")] = None,
        genes: Annotated[Optional[StrictStr], Field(description="Specify a chromosome interval related with the genes list. Use commas to specify multiple genes.")] = None,
        interval: Annotated[Optional[StrictStr], Field(description="Specify a chromosome interval to find genes between these positions. E.g. `2:233364596-233385916`. Use commas to specify multiple intervals.")] = None,
        variation_id: Annotated[Optional[StrictStr], Field(description="One or more specific variation IDs can be specified. E.g. `rs838705` use `|` characters to specify mutliple IDs. ")] = None,
        reference: Annotated[Optional[StrictStr], Field(description="Reference bases, with multiple characters sepearated by `|`. E.g. `CA|G`.")] = None,
        alteration: Annotated[Optional[StrictStr], Field(description="Alternate bases, with multiple characters sepearated by `|`. E.g. `CA|G`.")] = None,
        alleles: Annotated[Optional[StrictStr], Field(description="The response can be filtered by number of affected alleles. All objects which have a number of mutations that is equal or greater than the supplied value will match the search criteria.  For example, if you provide ‘1’, all variant objects which have mutations in 1, 2, or more, alleles will be displayed in the response.")] = None,
        quality: Annotated[Optional[StrictStr], Field(description="The objects can be filtered by quality value. Quality should be entered as an interval in parentheses with the starting and ending values are separated by a colon.  For example, if you enter (100:200), variant objects with quality values greater than 100 and less than 200 will be shown in the response.")] = None,
        ...
        :param filter: Filter by variant metadata (key-value metadata pair(s)). E.g. `\"Variant Source\"=dbSNP`. Retrieving individual runs via \"Run Source ID\"=\"HG00096\"  will be deprecated after June 2023
        :type filter: str
        ...
        :type info_filter: str
        :param genes: Specify a chromosome interval related with the genes list. Use commas to specify multiple genes.
        :type genes: str
        :param interval: Specify a chromosome interval to find genes between these positions. E.g. `2:233364596-233385916`. Use commas to specify multiple intervals.
        :type interval: str
        :param variation_id: One or more specific variation IDs can be specified. E.g. `rs838705` use `|` characters to specify mutliple IDs. 
        :type variation_id: str
        :param reference: Reference bases, with multiple characters sepearated by `|`. E.g. `CA|G`.
        :type reference: str
        :param alteration: Alternate bases, with multiple characters sepearated by `|`. E.g. `CA|G`.
        :type alteration: str
    ...
    def _get_all_variants_as_curator_serialize(
        ...
        if info_filter is not None:
            ...
            _query_params.append(('infoFilter', info_filter))
            
        if genes is not None:
            
            _query_params.append(('genes', genes))
        ...
        if variation_id is not None:
            ...
            _query_params.append(('variationId', variation_id))
        ...
        if alteration is not None:
            ...
            _query_params.append(('alteration', alteration))
            
        if alleles is not None:
            
            _query_params.append(('alleles', alleles))
