...
class ValidationSummaryAsCuratorApi:
    ...
    @validate_call
    def search_expression_data_as_curator(
        self,
        ...
        _param = self._search_expression_data_as_curator_serialize(
            id=id,
    ...
    @validate_call
    def search_expression_data_as_curator_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def search_expression_data_as_curator_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier (accession) of the object.")],
        _request_timeout: Union[
            None,
    ...
    def _search_expression_data_as_curator_serialize(
        self,
        id,
        _request_auth,
        _content_type,
