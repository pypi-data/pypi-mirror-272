...
class TestJsonMetadataAttributes(unittest.TestCase):
    """JsonMetadataAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JsonMetadataAttributes:
        """Test JsonMetadataAttributes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JsonMetadataAttributes`
        """
        model = JsonMetadataAttributes()
        if include_optional:
    ...
    def testJsonMetadataAttributes(self):
        """Test JsonMetadataAttributes"""
