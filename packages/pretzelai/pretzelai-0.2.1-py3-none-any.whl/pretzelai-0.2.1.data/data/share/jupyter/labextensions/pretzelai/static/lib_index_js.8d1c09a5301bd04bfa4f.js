...
const extension = {
    ...
    activate: async (app, palette, notebookTracker, settingRegistry) => {
        ...
        const placeHolderEnabled = 'Ask AI. Use @variableName to refernce defined variables and dataframes';
        let openAiApiKey = '';
        let openAiBaseUrl = '';
        ...
        commands.addCommand(command, {
            ...
            execute: () => {
                ...
                if (activeCell) {
                    ...
                    generatingP.textContent = 'Calling AI Service...';
...
//# sourceMappingURL=lib_index_js.8d1c09a5301bd04bfa4f.js.map