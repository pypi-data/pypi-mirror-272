        ...
        if not 'skip_typecheck' in kwargs or not kwargs['skip_typecheck']:
            ...
            for k, v in self._inputs.items():
                if len(v) > 0 and type(v[0]) != NodeOutput:
                    raise ValueError(f'IntegrationNode: value provided for input name {k} is not a NodeOutput. Make sure you are passing NodeOutput objects into the inputs dict.')
