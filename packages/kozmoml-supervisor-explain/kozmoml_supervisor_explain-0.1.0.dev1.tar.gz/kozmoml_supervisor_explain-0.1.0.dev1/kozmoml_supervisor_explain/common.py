...
from kozmoml.codecs import StringCodec, NumpyCodec
...
from kozmoml.utils import generate_uuid

from kozmoml_supervisor_explain.errors import RemoteInferenceError, InvalidExplanationShape

_DEFAULT_INPUT_NAME = "predict"

EXPLAINER_TYPE_TAG = "explainer_type"

ENV_PREFIX_SUPERVISOR_EXPLAIN_SETTINGS = "KOZMOML_MODEL_SUPERVISOR_EXPLAIN_"
...
def to_v2_inference_request(
    ...
    # KozmoML does not really care about a correct input name!
