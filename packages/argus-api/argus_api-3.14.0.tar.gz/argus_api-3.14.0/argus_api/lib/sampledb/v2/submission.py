...
def submission_advanced_search(
    ...
    :param list meta: Restrict the search to submissions with any of the meta data properties defined
    ...
    # Only send meta if the argument was provided, don't send null values
    if meta is not None:
...
def submission_simple_search(
    ...
    :param list sortBy: Fields to sort the results by. Available values are\: fileName\, mimeType\, expiryTimestamp\, observedTimestamp\, submittedTimestamp\, \-fileName\, \-mimeType\, \-expiryTimestamp\, \-observedTimestamp\, \-submittedTimestamp
    :param list keywords: A set of keywords to search for
