...
def add_analysis(
    ...
    :param list flags: Deprecated. Set executedWithInternetAccess to true instead.
...
def add_verdict(
    ...
    :param int score: The value is a score from \-1\-100 and represents the degree of maliciousness. \-1 means no findings\, 100 means that it definitively is malicious. Please refer to the integration guide for a description of the scoring ranges
