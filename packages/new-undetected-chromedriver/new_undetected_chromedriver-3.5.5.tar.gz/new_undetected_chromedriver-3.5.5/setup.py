...
with codecs.open(
    os.path.join(dirname, "new_undetected_chromedriver", "__init__.py"),
    mode="r",
    encoding="utf-8",
) as fp:
    try:
...
setup(
    name="new-undetected-chromedriver",
    version=version,
    packages=["new_undetected_chromedriver"],
    install_requires=[
        "selenium>=4.9.0",
        "requests",
        "websockets",
    ...
    package_data={"new_undetected_chromedriver": [os.path.join("example", "example.py")]},
