...
MACHINE_ORGANIZATION_NAME = 'memorizing-machine'  # or other organization
PRIVATE_REPO_WITH_TEXT = 'memorizing_machine'
...
MEMORIZING_MACHINE = yaml.load(MACHINE_YAML, Loader=yaml.FullLoader)
