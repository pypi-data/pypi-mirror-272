...
const create_cell_status_actions = (settings) => {
    ...
    _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_0__.NotebookActions.executed.connect((_, args) => {
        ...
        if (cell.model.type == 'code' && cell.inputArea) {
    ...
    _jupyterlab_notebook__WEBPACK_IMPORTED_MODULE_0__.NotebookActions.executionScheduled.connect((_, args) => {
        ...
        if (cell.model.type == 'code' && cell.inputArea) {
            cell.inputArea.promptNode.classList.remove('cell-flash-executed-success');
            cell.inputArea.promptNode.classList.remove('cell-flash-executed-error');
...
//# sourceMappingURL=lib_index_js.1a45d06133058b8af3e4.js.map