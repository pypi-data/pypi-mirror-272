...
from common_utils.common.date_time_util import DateTimeUtil


class IntervalDatesAndArchiveTableNameInterface(ABC):

    @abstractmethod
    def get_interval_dates_and_archive_table_name(self, current_date, table_name_str):
        pass
...
class QuarterlyArchiveTableInterval(IntervalDatesAndArchiveTableNameInterface):
    ...
    def get_interval_dates_and_archive_table_name(self, current_date, table_name_str):
        ...
        archive_table_name = "restapi_{}_q{}_{}".format(table_name_str.lower(), last_to_last_quarter, year)
