...
:py:class:`supervisor.explainers.cfrl_tabular`, for the Pytorch backend.
"""
...
from supervisor.explainers.backends.cfrl_tabular import split_ohe, generate_condition  # noqa: F401

# The following methods are included since `supervisor.explainers.backends.pytorch.cfrl_tabular` is an extension to the
# `supervisor.explainers.backends.pytorch.cfrl_base.py`. In the explainer class `supervisor.explainers.cfrl_tabular` the
...
from supervisor.explainers.backends.pytorch.cfrl_base import get_actor, get_critic, get_optimizer, data_generator, \
