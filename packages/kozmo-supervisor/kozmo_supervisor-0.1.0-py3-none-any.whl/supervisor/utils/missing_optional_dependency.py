...
supervisor that is not usable due to missing optional dependencies this code is used to allow the import but replace it
...
err_msg_template = Template((
    ...
    + "`pip install supervisor[$missing_dependency]` from the command line. For more information, check the installation"
    + "documentation at https://docs.kozmoai.io/projects/supervisor/en/latest/overview/getting_started.html."
))
