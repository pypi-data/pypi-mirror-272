...
def handle_shared_args(parser):
    ...
    parser.add_argument('--no_clusters', action='store_true', help='Assume case samples do not form clusters/subgroups.  "n_small" will be overwritten to the higher value of either 0.75 times the case group size or 12 for filtering purposes.')
